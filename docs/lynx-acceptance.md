...
- **MERGED** as PR #199 — tip `ceb8c30a9da2f97fc9360b189f2fd6ef007397b0` / published APK still `lynx-v2-debug-4d4ff10` at that merge; product tip later `841d2e71644a6513106f5b10091f280c065bac11` / published APK `lynx-v2-debug-841d2e7` (see Next #158 / Next #159).
...
- Tip / APK honesty: write-time base tip `work/lynx-native` @ `ceb8c30a9da2f97fc9360b189f2fd6ef007397b0` (PR #199 / Next #157 MERGED). Published APK at write time: `lynx-v2-debug-4d4ff10` (do **not** invent `lynx-v2-debug-ceb8c30`). **MERGED** as PR #200 — current tip `841d2e71644a6513106f5b10091f280c065bac11` / published APK `lynx-v2-debug-841d2e7` (see Next #159 **MERGED** as PR #201). Product **NOT DONE** / 三关未齐 / not EXHAUSTED. No 真机过 claim.
...
## Notes — Cap contact-* SSE live tail (Next #160 / 2026-09-22)
...
- Tip / APK honesty: base `work/lynx-native` @ `841d2e71644a6513106f5b10091f280c065bac11` (PR #200 / Next #158 MERGED). Published APK `lynx-v2-debug-841d2e7` (prerelease; exists; asset `openchamber-lynx-debug-841d2e7.apk`; published ~2026-09-22T10:55:11Z). Lynx Mobile CI SUCCESS on tip `841d2e7` (run 35718022126). Next #159 **MERGED** as PR #201 (docs honesty). Do **not** invent a newer APK than `lynx-v2-debug-841d2e7`.
- Product **NOT DONE** / 三关未齐 / not EXHAUSTED. No 真机过 claim. 真机残差 unchanged: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-841d2e7`.
- Deferred: host file picker / camera; Cap IntersectionObserver; `@dnd-kit` / MobileWindowMotion / iPad / Cap toast; DOM auto-follow; merge to main.
