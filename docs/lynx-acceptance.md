...
- Tip / APK honesty: write-time base tip `work/lynx-native` @ `ceb8c30a9da2f97fc9360b189f2fd6ef007397b0` (PR #199 / Next #157 MERGED). Published APK at write time: `lynx-v2-debug-4d4ff10` (do **not** invent `lynx-v2-debug-ceb8c30`). **MERGED** as PR #200 — later tip was `841d2e71644a6513106f5b10091f280c065bac11` / published APK `lynx-v2-debug-841d2e7` (Next #159 **MERGED** as PR #201). Current tip `611d5433b2b6529243115b7dfdf111a77110c8f9` / published APK `lynx-v2-debug-611d543` (Next #162 **MERGED** as PR #204; see Next #163). Product **NOT DONE** / 三关未齐 / not EXHAUSTED. No 真机过 claim.
...
- **MERGED** as PR #201 — tip stayed `841d2e71644a6513106f5b10091f280c065bac11` / published APK `lynx-v2-debug-841d2e7` at that merge; product tip later `91c81f4e53167cafdebdd0e3ba23829ccb8101c0` / published APK `lynx-v2-debug-91c81f4` (see Next #160 / Next #161 **MERGED** as PR #203), then `618ae12a5450a633f716cc95fb4e24dbe9b9844b` / published APK `lynx-v2-debug-618ae12` (Next #162 **MERGED** as PR #204), then tip `611d5433b2b6529243115b7dfdf111a77110c8f9` / published APK `lynx-v2-debug-611d543` (Next #163).
...
- **MERGED** as PR #202 — tip after merge `work/lynx-native` @ `91c81f4e53167cafdebdd0e3ba23829ccb8101c0` / published APK `lynx-v2-debug-91c81f4` (see Next #161 **MERGED** as PR #203). Current tip `611d5433b2b6529243115b7dfdf111a77110c8f9` / published APK `lynx-v2-debug-611d543` (Next #162 **MERGED** as PR #204; see Next #163).
- Product **NOT DONE** / 三关未齐 / not EXHAUSTED. No 真机过 claim. 真机残差 unchanged at write on `lynx-v2-debug-841d2e7`; current confirm APK is `lynx-v2-debug-611d543` (Next #163).
...
- **MERGED** as PR #203 — tip advanced to `618ae12a5450a633f716cc95fb4e24dbe9b9844b` / published APK `lynx-v2-debug-618ae12` (see Next #162 **MERGED** as PR #204). Current tip `611d5433b2b6529243115b7dfdf111a77110c8f9` / published APK `lynx-v2-debug-611d543` (Next #163).
...
## Notes — Docs tip APK/SHA honesty post-#162 (Next #163 / 2026-09-22)
