...
Track tip (docs honesty, Next #155): `work/lynx-native` @ `aca0d600069f792d86bd56fe937ef7442870a7f1` (PR #196 / Next #154 MERGED). Published APK: `lynx-v2-debug-aca0d60` (prerelease; exists; asset `openchamber-lynx-debug-aca0d60.apk`; was stale `lynx-v2-debug-8ef7bf6` / tip `8ef7bf6f6493783aef2845c2238fc91c9e438af3`). Tip delta `8ef7bf6`→`aca0d60` is docs-only. Lynx Mobile CI SUCCESS on tip `aca0d60` (run 35676395290). Do not invent a newer APK than published. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-aca0d60`. Host-only unchanged.
