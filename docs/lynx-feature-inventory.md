...
Track tip (docs honesty, Next #158): base `work/lynx-native` @ `ceb8c30a9da2f97fc9360b189f2fd6ef007397b0` (PR #199 / Next #157 MERGED). Published APK: `lynx-v2-debug-4d4ff10` (prerelease; exists; asset `openchamber-lynx-debug-4d4ff10.apk`; tip docs-only hop after `4d4ff10` — do **not** invent `lynx-v2-debug-ceb8c30`). Next #158 Cap Assistant contact transcript is 代码接上 (`LynxContactConversationScreen`), not 三关 landed. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-4d4ff10`. Host-only unchanged.
