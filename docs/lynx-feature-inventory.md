...
Track tip (docs honesty, Next #154): `work/lynx-native` @ `8ef7bf6f6493783aef2845c2238fc91c9e438af3` (PR #195 / Next #153 MERGED). Published APK: `lynx-v2-debug-8ef7bf6` (prerelease; exists; asset `openchamber-lynx-debug-8ef7bf6.apk`; was stale `lynx-v2-debug-c3a062a` / tip `c3a062a134a9796041ea605eb2e1acc66a2b289d`). Tip delta `c3a062a`→`8ef7bf6` is docs-only. Lynx Mobile CI SUCCESS on tip `8ef7bf6` (run 35663903430). Do not invent a newer APK than published. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-8ef7bf6`. Host-only unchanged.
