...
Track tip (docs honesty, Next #145): `work/lynx-native` @ `c3cb78a79bf80d0a90d448bb7133adc5869084d6` (PR #186 / Next #144 MERGED). Published APK: `lynx-v2-debug-c3cb78a` (prerelease; exists; was stale `lynx-v2-debug-8410742` / tip `84107429dc9cd9e98d9de82807aa509d2bf8a496`). Tip delta `8410742`→`c3cb78a` is docs-only. Lynx Mobile CI SUCCESS on tip `c3cb78a` (run 35542179230). Do not invent a newer APK than published. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-c3cb78a`. Host-only unchanged.
