...
Track tip (docs honesty, Next #157): `work/lynx-native` @ `4d4ff1003faa2113760b25927404a09aff6045c5` (PR #198 / Next #156 MERGED). Published APK: `lynx-v2-debug-4d4ff10` (prerelease; exists; asset `openchamber-lynx-debug-4d4ff10.apk`; was stale `lynx-v2-debug-ea6bc02` / tip `ea6bc02b26c8365492be8033c2e8040981d693cb`). Tip delta `ea6bc02`→`4d4ff10` is docs-only. Lynx Mobile CI SUCCESS on tip `4d4ff10` (run 35700374946). Do not invent a newer APK than published. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-4d4ff10`. Host-only unchanged.
