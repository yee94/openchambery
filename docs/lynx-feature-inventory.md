...
Track tip (docs honesty, Next #156): `work/lynx-native` @ `ea6bc02b26c8365492be8033c2e8040981d693cb` (PR #197 / Next #155 MERGED). Published APK: `lynx-v2-debug-ea6bc02` (prerelease; exists; asset `openchamber-lynx-debug-ea6bc02.apk`; was stale `lynx-v2-debug-aca0d60` / tip `aca0d600069f792d86bd56fe937ef7442870a7f1`). Tip delta `aca0d60`→`ea6bc02` is docs-only. Lynx Mobile CI SUCCESS on tip `ea6bc02` (run 35687023213). Do not invent a newer APK than published. Product **NOT DONE** / 三关未齐 / not EXHAUSTED. Next #90 archived-sessions and Next #91 Assistant unread are landed. Next #139 Settings search LynxInput is 代码接上, not 三关 landed. 真机残差: Connect welcome **card chrome** confirm for Yee on published APK `lynx-v2-debug-ea6bc02`. Host-only unchanged.
