...
| MobileSessionStatusBar / sessions sheet | Slim strip 代码接上 in #39; full Cap sessions sheet 代码接上 in #42; worktree create/delete dialogs 代码接上 in #43; remote-branch delete 代码接上 in #44; two-step archive + unarchive undo 代码接上 in #45; ArchivedSessionsDialog 代码接上 in #46; smart-title 代码接上 in #47; tree archive/delete + delete undo 代码接上 in #48; MobileProjectEditSurface 代码接上 in #49; header trailing newChat/worktree/addProject 代码接上 in #50. Remaining: Cap `@dnd-kit` / MobileWindowMotion / iPad sidebar / Cap toast lib (sonner) / bulk multi-select (desktop sidebar folders) |
