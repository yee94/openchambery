...
export const dict: Record<I18nKey, string> = {
  'chat.chatInput.stopUnconfirmed': '尚未確認停止，請重試。',
  'chat.response.rateLimit': '已觸發供應商請求頻率限制',
  'chat.response.auth': '供應商身分驗證失敗，請重新登入後重試。',
  'chat.response.quota': '供應商配額已用盡',
  'chat.response.contentFilter': '供應商已封鎖此回應',
  'chat.response.transport': '連線至供應商失敗',
  'chat.response.internal': '供應商內部錯誤',
  'chat.response.invalidOutput': '供應商傳回了無效回應',
  'chat.response.invalidRequest': '供應商拒絕了此請求',
  'chat.response.unsupportedOperation': '供應商不支援此操作',
  'chat.response.noRoute': '模型或供應商設定無法使用',
  'chat.response.providerUnknown': '供應商錯誤',
  'chat.response.timeout': '供應商請求逾時',
  'chat.response.permissionRejected': '權限請求遭拒',
  'chat.response.toolExecution': '工具執行失敗',
  'chat.response.compactionFailed': '上下文壓縮失敗',
  'chat.response.compactionUnavailable': '目前沒有可壓縮的內容',
  'chat.response.compactionInterrupted': '上下文壓縮已中斷',
  'chat.response.compactionCancelled': '上下文壓縮已取消',
  'chat.response.stopped': '使用者已停止生成',
  'chat.response.interrupted': '本次回應已中斷',
  'chat.response.toolInterrupted': '工具執行已中斷',
  'chat.response.resumeExhausted': '執行反覆中斷，已停止自動恢復',
  'chat.response.retrying': '正在自動重試',
  'chat.response.failed': '執行失敗',
  'chat.response.continuingAfterRestart': '重新啟動後繼續',
  'chat.queuedMessage.inheritsSessionSelection': '執行時繼承工作階段模型、Agent 與 variant',
  'chat.sessionRecovery.awaitingConfirmation': '服務重新啟動，等待確認任務狀態',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': '產生回答失敗，請重試。',
  'chat.btw.description': '根據目前對話回答，主會話歷史保持原樣。',
  'chat.btw.placeholder': '在 Side Chat 提問…',
  'chat.btw.removeQuoteAria': '移除引用',
  'chat.message.conversationQuotesLabel': '對話中的引用',
  'chat.btw.sessionRequired': '請開啟現有會話後再開始 Side Chat。',
  'chat.btw.plainTextRequired': '請使用純文字提問。引用已保留在輸入框中。',
  'chat.btw.pending': '正在準備回答…',
  'chat.btw.cancelled': '回答已取消，可重試提問。',
  'chat.btw.resize': '調整 Side Chat 面板大小',
  ...settingsDict,
  'chat.questionDelegate.countdown': '{seconds} 秒後交由模型決定',
  'chat.questionDelegate.awaiting': '等待確認…',
  'chat.questionDelegate.pausing': '正在暫停倒數…',
  'chat.questionDelegate.paused': '倒數已暫停',
  'chat.questionDelegate.disabled': '自動倒數已關閉',
  'chat.questionDelegate.refreshStatus': '重新整理狀態',
  'chat.questionDelegate.submitting': '正在提交回覆…',
  'chat.questionDelegate.uncertain': '提交結果尚待確認。',
  'chat.questionDelegate.settled': '問題已處理',
  'chat.questionDelegate.success': '已傳送繼續執行回覆，模型將自行決定後續方案。',
  'chat.questionDelegate.stale': '目前顯示上次狀態，最新狀態仍在更新。',
  'chat.questionDelegate.pauseFailed': '暫停失敗，倒數計時可能仍在進行。',
  'chat.questionDelegate.delegateFailed': '託管失敗，請檢查狀態後重試。',
  'chat.questionDelegate.loadFailed': '託管狀態重新整理失敗。',
  'chat.questionDelegate.retry': '重試',
  'chat.questionDelegate.pause': '暫停倒數',
  'chat.questionDelegate.delegate': '立即託管',
  'common.loading': '載入中...',
  ...
  'mobile.instances.status.connected': '已連線',
  'mobile.instances.status.saved': '已保存',
  'mobile.instances.status.connectedDirect': '已連線 · 區域網路',
  'mobile.instances.status.connectedRelay': '已連線 · 中繼',
  'mobile.instances.status.connectedSshRelay': '已連線 · SSH 經中繼',
  'mobile.instances.sshBadge': 'SSH',
  'mobile.instances.sshViaDesktop': '經桌面端中繼至 SSH',
  'mobile.connect.error.sshNotConnected': '該 SSH 實例目前未連線。',
  'mobile.connect.ssh.fallbackDesktop': 'SSH 實例無法使用 — 已改為連線桌面。',
  ...
  'mobile.menu.newSession': '新增聊天',
  'mobile.chat.syncingMessages': '正在同步訊息...',
  ...
  'mobile.sessions.mainWorkspace': '主工作區',
  'mobile.sessions.section.pinned': '置頂/進行中',
  'mobile.sessions.searchAria': '搜尋工作階段',
  'mobile.sessions.section.otherProjects': '切換專案',
  'mobile.sessions.section.projects': '專案',
  'mobile.projects.menu.label': '更多操作',
  'mobile.projects.menu.newChat': '新增對話',
  'mobile.projects.menu.newProject': '新增專案',
  'mobile.projects.menu.scanQr': '掃一掃',
  'mobile.projects.menu.switchInstance': '切換實例',
  ...
  'mobile.sessions.startNewChat': '新增聊天',
  'mobile.sessions.newChat': '新增聊天',
  ...
  'mobile.projects.closeConfirmMessage': '關閉「{title}」？它將從專案列表中移除，工作階段仍保留在磁碟上。',
  ...
  'mobile.sessions.stopGroupAria': '停止 {label} 中所有執行中的會話',
  'mobile.sessions.stopSubsessionsAria': '停止 {title} 的執行中子會話',
  ...
  'mobile.sessions.newSessionAria': '在此專案中開始新聊天',
  ...
  'mobile.files.html.fullscreenAria': '全螢幕預覽',
  'mobile.files.html.exitFullscreenAria': '結束全螢幕',
  'mobile.files.html.viewSourceAria': '檢視原始碼',
  'mobile.files.html.viewPreviewAria': '檢視預覽',
  ...
  'layout.rightSidebar.browser': '瀏覽器',
  'layout.browserProvider.noSurface': '{name} 沒有即時畫面。',
  'layout.browserProvider.status.connecting': '連線中…',
  'layout.browserProvider.status.reconnecting': '連線中斷，正在重新連線…',
  'layout.browserProvider.status.ready': '點按或輸入即可接手',
  'layout.browserProvider.status.readyFocused': '輸入即可控制畫面；點按外部可離開',
  'layout.browserProvider.status.agentWorking': '代理程式正在工作',
  'layout.browserProvider.status.youControl': '由你控制',
  'layout.browserProvider.status.otherControls': '由其他裝置控制',
  'layout.browserProvider.handBack': '交還擴充功能',
  'layout.browserProvider.retry': '再試一次',
  'layout.browserProvider.canvasAria': '{name} 的即時畫面',
  'layout.browserProvider.ended.service-stopped': '擴充功能的服務已停止。',
  'layout.browserProvider.ended.extension-unavailable': '擴充功能無法使用。',
  'layout.browserProvider.ended.host-shutdown': 'OpenChamber 正在關閉。',
  ...
  'sessions.scheduledTasks.dialog.actions.create': '建立',
  'sessions.scheduledTasks.dialog.actions.moreAria': '{taskName} 的更多操作',
  'sessions.scheduledTasks.dialog.actions.delete': '刪除',
  'sessions.scheduledTasks.dialog.actions.pause': '暫停',
  'sessions.scheduledTasks.dialog.actions.resume': '繼續',
  'sessions.scheduledTasks.workspace.filters.all': '全部',
  'sessions.scheduledTasks.workspace.filters.active': '已啟用',
  'sessions.scheduledTasks.workspace.filters.paused': '已暫停',
  'sessions.scheduledTasks.workspace.views.aria': '排程任務檢視',
  'sessions.scheduledTasks.workspace.views.tasks': '任務',
  'sessions.scheduledTasks.workspace.views.history': '歷史記錄',
  'sessions.scheduledTasks.history.loading': '正在載入執行歷史…',
  'sessions.scheduledTasks.history.error.title': '無法載入執行歷史',
  'sessions.scheduledTasks.history.error.description': 'OpenChamber 無法載入已記錄的執行。',
  'sessions.scheduledTasks.history.error.more': '無法載入更多執行。已載入的歷史記錄仍可查看。',
  'sessions.scheduledTasks.history.retry': '重試',
  'sessions.scheduledTasks.history.empty.title': '尚無執行記錄',
  'sessions.scheduledTasks.history.empty.description': '排程執行與手動執行會顯示在這裡。',
  'sessions.scheduledTasks.history.trigger.scheduled': '排程觸發',
  'sessions.scheduledTasks.history.trigger.manual': '手動觸發',
  'sessions.scheduledTasks.history.meta.trigger': '觸發方式',
  'sessions.scheduledTasks.history.meta.started': '開始時間',
  'sessions.scheduledTasks.history.meta.ended': '結束時間',
  'sessions.scheduledTasks.history.meta.duration': '耗時',
  'sessions.scheduledTasks.history.ended.unavailable': '—',
  'sessions.scheduledTasks.history.duration.pending': '執行中',
  ...
  'sessions.scheduledTasks.history.loadingMore': '正在載入更多…',
  'sessions.scheduledTasks.history.loadMore': '載入更多',
  'sessions.scheduledTasks.workspace.search.placeholder': '搜尋任務…',
  'sessions.scheduledTasks.workspace.search.noResults': '沒有符合搜尋條件的任務。',
  'sessions.scheduledTasks.workspace.partialLoadWarning': '部分專案的排程任務載入失敗，已載入的任務仍可使用。',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': '選擇任務',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': '從清單中選擇任務，或建立新任務。',
  'sessions.scheduledTasks.workspace.confirm.discardChanges': '未儲存的變更將被捨棄。是否繼續？',
  'sessions.scheduledTasks.editor.panel.details': '詳細資訊',
  'sessions.scheduledTasks.editor.panel.frequency': '頻率',
  ...
  'sessions.scheduledTasks.editor.goal.budgetLabel': 'Tokens 預算',
  'sessions.scheduledTasks.editor.goal.budgetAria': '以 Tokens 預算限制該目標',
  ...
  'sessions.sidebar.header.actions.sessionDisplayMode': '專案展開／摺疊操作',
  'sessions.sidebar.header.displayMode.label': '展開／摺疊專案',
  ...
  'sessions.sidebar.bulkActions.archiveUndoFailed': '還原 {count} 個會話失敗',
  'sessions.sidebar.undo': '復原',
  ...
  'sessions.sidebar.session.menu.refreshTranscript': '同步訊息',
  'sessions.sidebar.session.menu.refreshTranscriptSuccess': '已同步訊息',
  'sessions.sidebar.session.menu.refreshTranscriptFailed': '無法同步訊息',
  ...
  'sessions.sidebar.session.archive.undoFailed': '復原封存失敗',
  ...
  'gitView.changes.deferredTitle': '{count} 個變更檔案',
  'gitView.changes.deferredStagedCount': '已暫存：{count}',
  'gitView.changes.deferredUnstagedCount': '未暫存：{count}',
  'gitView.changes.deferredHint': '變更集過大，為保持介面流暢，未自動渲染列表。',
  'gitView.changes.deferredLoadAction': '載入變更',
  ...
  'contextPanel.file.notice.turnDiffOutsideWorkspace': '專案外檔案無法顯示本輪變更對照，已改為開啟目前檔案內容。',
  ...
  'sidebarFilesTree.actions.collapseAllTitle': '全部摺疊',
  'sidebarFilesTree.actions.expandAllTitle': '全部展開',
  ...
  'contextUsage.pendingDescription': '上下文已壓縮，下一次模型回應傳回 token 資料後更新用量。',
  ...
  'contextSidebar.empty.openSession': '開啟工作階段以查看用量。',
  ...
  'contextSidebar.stats.sessionTps': '工作階段 TPS',
  ...
  'diffView.actions.openFilePreview': '開啟此檔案',
  ...
  'header.services.openWithCurrent': '切換實例（目前：{current}）',
  'header.services.open': '切換實例',
  'header.services.tooltip.currentInstanceWithShortcuts': '切換實例：{current}（{toggle}；下一分頁 {nextTab}）',
  'header.services.tooltip.servicesWithShortcuts': '切換實例（{toggle}；下一分頁 {nextTab}）',
  'header.services.title': '切換實例',
  'header.services.viewAria': '切換實例',
  'header.services.closeAria': '關閉實例切換',
  ...
  'header.actions.sessionMenu': '工作階段操作',
  'header.actions.sessionMenuAria': '開啟工作階段操作選單',
  'header.actions.sessionMenu.servicesWithInstance': '切換實例（{current}）',
  ...
  'chat.goal.dialog.budgetLabel': 'Tokens 預算',
  ...
  'directoryTree.section.pinned': '釘選',
  'directoryTree.section.pinnedInProgress': '置頂/進行中',
  ...
  'helpDialog.item.previousSession': '上一個工作階段',
  'helpDialog.item.nextSession': '下一個工作階段',
  ...
  'helpDialog.item.toggleRightSidebar': '切換審查面板',
  ...
  'helpDialog.item.closeContextPanelTab': '關閉上下文面板分頁',
  'helpDialog.item.toggleTerminal': '切換終端機',
  'helpDialog.item.newTerminalTab': '新建終端機分頁（終端機聚焦時）',
  'helpDialog.item.openNewTerminal': '開啟並新建終端機',
  'helpDialog.item.previousTerminalTab': '上一個終端機分頁（終端機聚焦時）',
  'helpDialog.item.nextTerminalTab': '下一個終端機分頁（終端機聚焦時）',
  'helpDialog.item.toggleBottomPanel': '切換底部面板',
  'helpDialog.item.toggleTerminalExpanded': '切換終端機展開狀態',
  'helpDialog.item.cycleTheme': '循環切換主題（淺色 → 深色 → 跟隨系統）',
  'helpDialog.item.zoomIn': '放大',
  'helpDialog.item.zoomOut': '縮小',
  'helpDialog.item.zoomReset': '重設縮放',
  'helpDialog.item.switchSession': '切換會話',
  ...
  'helpDialog.section.leaderChords': '前導鍵（Ctrl+X）',
  'helpDialog.item.leaderOpenModel': '開啟模型選擇器',
  'helpDialog.item.leaderOpenAgent': '開啟 Agent 選擇器',
  'helpDialog.item.leaderNewSession': '建立新工作階段',
  'helpDialog.item.leaderCompact': '壓縮目前工作階段',
  'chat.leaderKey.pendingAria': '前導鍵已啟用，請按下後續按鍵。',
  'chat.leaderKey.action.model': '模型',
  'chat.leaderKey.action.agent': 'Agent',
  'chat.leaderKey.action.newSession': '新建',
  'chat.leaderKey.action.compact': '壓縮',
  'helpDialog.keyCombiner.or': '或',
  'helpDialog.proTips.title': '使用提示：',
  'helpDialog.proTips.commandPalette': '使用命令面板（{shortcut}）可快速存取所有操作',
  'helpDialog.proTips.recentSessions': '最近 9 個聊天會顯示在全域搜尋中',
  ...
  'chat.fileAttachment.actions.expandImages': '展開更多圖片',
  'chat.fileAttachment.actions.collapseImages': '收起圖片',
  ...
  'chat.activity.title': '處理詳情',
  'chat.activity.active': '正在處理',
  'chat.activity.compacting': '正在壓縮',
  'chat.activity.compactionCompleted': '已完成壓縮',
  'chat.activity.compactionFailed': '壓縮失敗',
  'chat.activity.expandAria': '展開處理詳情',
  'chat.activity.collapseAria': '收起處理詳情',
  'chat.activity.completed': '已處理 {duration}',
  'chat.activity.completedStatus': '已處理',
  'chat.activity.agentsWorking': '{count} 個 Agent 處理中',
  'chat.activity.agentsInvolved': '{count} 個 Agent 參與',
  'chat.activity.moreHidden': '還有 {count} 項...',
  ...
  'chat.emptyState.establishingConversation': '正在建立對話',
  'chat.draftPresets.explore.label': '探索程式碼庫',
  'chat.draftPresets.catchup.label': '同步目前進度',
  'chat.draftPresets.weigh.label': '權衡方案選擇',
  'chat.draftPresets.craftGoal.label': '建立 Goal',
  'chat.draftPresets.debug.label': '除錯問題',
  'chat.draftPresets.review.label': '審查我的變更',
  'chat.draftStarters.add': '新增快捷入口',
  'chat.draftStarters.searchPlaceholder': '搜尋指令與技能…',
  'chat.draftStarters.empty': '沒有可新增的項目',
  'chat.draftStarters.sectionBuiltIn': '內建',
  'chat.draftStarters.sectionCommands': '指令',
  'chat.draftStarters.sectionSkills': '技能',
  'chat.draftStarters.remove': '移除',
  'chat.draftStarters.expand': '展開更多',
  ...
  'chat.assistantStatus.updatingTodos': '正在更新工作',
  'chat.assistantStatus.readingTodos': '正在讀取工作',
  'chat.assistantStatus.learningSkill': '正在學習技能',
  'chat.assistantStatus.askingQuestion': '正在提問',
  'chat.assistantStatus.executing': '正在執行程式碼',
  'chat.assistantStatus.renamingSession': '正在重新命名工作階段',
  'chat.assistantStatus.movingSession': '正在移動工作階段',
  'chat.assistantStatus.usingBrowser': '正在使用瀏覽器',
  'chat.assistantStatus.usingTool': '正在使用 {tool}',
  'chat.assistantStatus.working': '正在處理',
  'chat.assistantStatus.processing': '正在處理',
  'chat.assistantStatus.preparing': '正在準備',
  'chat.assistantStatus.warmingUp': '正在預熱',
  'chat.assistantStatus.gearsTurning': '正在運轉',
  'chat.assistantStatus.computing': '正在運算',
  'chat.assistantStatus.calculating': '正在計算',
  'chat.assistantStatus.analyzing': '正在分析',
  'chat.assistantStatus.wheelsSpinning': '正在運轉',
  'chat.assistantStatus.calibrating': '正在校準',
  'chat.assistantStatus.synthesizing': '正在綜合分析',
  'chat.assistantStatus.connectingDots': '正在整理關聯',
  'chat.assistantStatus.inspectingLogic': '正在檢查邏輯',
  'chat.assistantStatus.weighingOptions': '正在權衡選項',
  'chat.assistantStatus.thinking': '正在思考',
  'chat.assistantStatus.composing': '正在撰寫',
  'chat.assistantStatus.sendingMessage': '正在傳送訊息',
  'chat.assistantStatus.waitingForPermission': '正在等待授權',
  'chat.assistantStatus.retrying': '正在重試',
  'chat.assistantStatus.retryingIn': '{duration}後重試',
  'chat.assistantStatus.retryingAttempt': '正在重試（第 {attempt} 次）',
  'chat.assistantStatus.retryingInAttempt': '{duration}後重試（第 {attempt} 次）',
  ...
  'chat.revertPopover.files': '將變更的檔案',
  'chat.revert.toast.undo': '已收回至 {preview}',
  'chat.revert.toast.redo': '已重做',
  'chat.revert.toast.restored': '已恢復全部訊息',
  'chat.revert.toast.busy': '工作階段進行中，無法復原',
  'chat.form.title': '表單',
  'chat.form.reply': '提交',
  'chat.form.cancel': '取消',
  'chat.retry.action.quota': '已達用量上限',
  'chat.retry.action.account': '已達帳號限額',
  'chat.retry.action.open': '開啟',
  ...
  'chat.commandAutocomplete.command.reloadDescription': '重新載入 OpenCode 設定、Provider 與外掛，無需重新啟動',
  'chat.commandAutocomplete.command.newDescription': '在目前專案中開啟新工作階段。',
  ...
  'chat.fileMentionAutocomplete.groups.sessions': '已載入會話',
  'chat.fileMentionAutocomplete.groups.directories': '目錄',
  'chat.fileMentionAutocomplete.groups.recentFiles': '最近檔案',
  'chat.fileMentionAutocomplete.groups.files': '檔案',
  'chat.fileMentionAutocomplete.sessionType': 'OpenCode 會話',
  'chat.fileMentionAutocomplete.untitledSession': '未命名會話',
  'chat.fileMentionAutocomplete.empty': '找不到符合項目',
  'chat.queuedMessage.attachments': '+{count} 個檔案',
  'chat.queuedMessage.empty': '（空）',
  'chat.queuedMessage.title': '佇列',
  'chat.queuedMessage.edit': '編輯',
  'chat.queuedMessage.send': '引導',
  'chat.queuedMessage.queuing': '正在入佇…',
  'chat.queuedMessage.queuingAria': '正在將訊息加入佇列',
  'chat.queuedMessage.waitingForCompaction': '等待壓縮完成',
  'chat.queuedMessage.waitingForCompactionAria': '正在等待壓縮完成',
  'chat.queuedMessage.sending': '引導中…',
  'chat.queuedMessage.sendingAria': '正在引導訊息',
  ...
  'chat.textSelection.actions.addToSideChat': '加入 Side Chat',
  'chat.textSelection.title.addToCurrentChat': '加入目前聊天',
  'chat.messageBody.aborted': '生成已停止',
  'chat.messageBody.actions.editing': '正在編輯…',
  'chat.messageBody.actions.editStaged': '編輯待送出',
  'chat.messageBody.actions.cancelEdit': '取消編輯',
  ...
  'chat.messageBody.meta.tpsTooltip': '生成速度（token/秒），不含工具呼叫耗時',
  ...
  'chat.forkTransition.preparing': '正在準備分支',
  'chat.forkTransition.copying': '正在複製對話（長會話可能較慢）',
  'chat.forkTransition.opening': '正在開啟新工作階段',
  'chat.forkTransition.loading': '正在載入最近訊息',
  ...
  'chat.chatInput.actions.queuingMessageAria': '加入佇列中',
  'chat.chatInput.actions.sendingMessageAria': '傳送中',
  ...
  'chat.chatInput.toast.reloadStarted': '正在重新載入設定…',
  'chat.chatInput.toast.reloadSucceeded': '設定已重新載入',
  'chat.chatInput.toast.reloadFailed': '重新載入設定失敗',
  ...
  'chat.chatInput.draftPicker.newProject': '新建專案',
  ...
  'chat.chatInput.branchSwitch.title': '切換到 {branch}？',
  'chat.chatInput.branchSwitch.description': '新對話要以哪種方式開啟這個分支？',
  'chat.chatInput.branchSwitch.createWorktree': '新建工作樹',
  'chat.chatInput.branchSwitch.createWorktreeDescription': '保持目前目錄不變，在獨立工作樹中繼續。',
  'chat.chatInput.branchSwitch.checkoutHere': '檢出到目前目錄',
  'chat.chatInput.branchSwitch.checkoutHereDescription': '把目前目錄切換到這個分支。',
  ...
  'chat.toolOutputDialog.image.resetZoomAria': '重設縮放',
  'chat.image.actions.sheetTitle': '圖片',
  'chat.image.actions.saveImage': '儲存圖片',
  'chat.image.actions.saveToPhotos': '儲存到相簿',
  'chat.image.actions.saving': '正在儲存…',
  'chat.image.actions.saveSuccess': '圖片已儲存',
  'chat.image.actions.saveFailed': '無法儲存圖片',
  ...
  'chat.activity.outputLoading': '正在載入完整輸出…',
  'chat.activity.outputLoadFailed': '無法載入完整輸出。',
  'chat.activity.outputRetry': '重試',
  'chat.fileAttachment.image.loading': '正在載入圖片…',
  'chat.fileAttachment.image.loadFailed': '無法載入圖片。',
  'chat.fileAttachment.image.retry': '重試載入圖片',
  'chat.fileAttachment.image.loadManually': '載入圖片',
  'chat.fileAttachment.image.loadManuallyCount': '載入 {count} 張圖片',
  ...
  'chat.permissionCard.replaceAll': '取代所有相符項目',
  'chat.permissionCard.responseFormat': '回應格式：',
  'chat.permissionCard.allowOnce': '允許一次',
  'chat.permissionCard.alwaysAgree': '始終同意',
  ...
  'chat.modelControls.costInput': '輸入',
  'chat.modelControls.costOutput': '輸出',
  ...
  'chat.modelControls.keyboardHintSwitchAgentLabel': '切換 Agent',
  ...
  'chat.contextGroup.expandAria': '展開已探索的工具',
  'chat.contextGroup.collapseAria': '摺疊已探索的工具',
  'chat.contextGroup.readSingle': '{count} 次讀取',
  'chat.contextGroup.readPlural': '{count} 次讀取',
  'chat.contextGroup.searchSingle': '{count} 次搜尋',
  'chat.contextGroup.searchPlural': '{count} 次搜尋',
  'chat.contextGroup.listSingle': '{count} 次列舉',
  'chat.contextGroup.listPlural': '{count} 次列舉',
  'chat.usedGroup.running': '執行中',
  'chat.usedGroup.used': '執行了',
  'chat.usedGroup.expandAria': '展開已執行的工具',
  'chat.usedGroup.collapseAria': '摺疊已執行的工具',
  'chat.usedGroup.editSingle': '{count} 次編輯',
  'chat.usedGroup.editPlural': '{count} 次編輯',
  'chat.usedGroup.commandSingle': '{count} 次命令',
  'chat.usedGroup.commandPlural': '{count} 次命令',
  'chat.usedGroup.otherSingle': '{count} 次呼叫',
  'chat.usedGroup.otherPlural': '{count} 次呼叫',
  'chat.skillGroup.expandAria': '展開已載入的技能',
  'chat.skillGroup.collapseAria': '摺疊已載入的技能',
  'chat.skillGroup.summaryOverflow': '{names} 等{count}個',
  'chat.tools.display.read': '讀取檔案',
  'chat.tools.display.write': '寫入檔案',
  'chat.tools.display.edit': '編輯檔案',
  'chat.tools.display.apply_patch': '套用補丁',
  'chat.tools.display.bash': '執行',
  'chat.tools.display.grep': '搜尋檔案',
  'chat.tools.display.glob': '尋找內容',
  'chat.tools.display.list': '列出目錄',
  'chat.tools.display.task': 'Agent 任務',
  'chat.tools.display.webfetch': '取得網頁',
  'chat.tools.display.websearch': '網頁搜尋',
  'chat.tools.display.codesearch': '程式碼搜尋',
  'chat.tools.display.todowrite': '更新待辦',
  'chat.tools.display.todoread': '讀取待辦',
  'chat.tools.display.skill': '載入技能',
  'chat.tools.display.question': '提問',
  'chat.tools.display.lsp': 'LSP',
  'chat.tools.display.structuredoutput': '結構化輸出',
  'chat.tools.display.execute': '執行程式碼',
  'chat.tools.display.session_rename': '重新命名工作階段',
  'chat.tools.display.session_move': '移動工作階段',
  'chat.tools.display.browser': '瀏覽器',
  ...
  'chat.messageBody.subagent.completedDescription': '背景子代理已完成',
  ...
  'chat.sessionBackground.moveRunning': '移至背景',
  'chat.sessionBackground.moving': '轉移中…',
  'chat.sessionBackground.moveFailed': '無法將工作移至背景',
  'chat.sessionBackground.tasksRunning': '{count} 個背景任務執行中',
  ...
  'commandPalette.title': '全域搜尋',
  'commandPalette.error.sessions': '聊天搜尋無法載入。仍會顯示可用結果。',
  ...
  'commandPalette.item.newTerminalTab': '新建終端機分頁',
  ...
  'desktopHostSwitcher.sshError.openRemoteSettings': '開啟遠端實例設定',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.title': '遠端主機沒有 Node.js 22+',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance': '請在遠端安裝 Node.js 22 或 24 LTS（nvm、fnm 或系統套件）。登入環境只有 Node 18/20 不夠，除非常見路徑裡還有 22+ 執行檔。',
  'desktopHostSwitcher.sshError.packageManagerMissing.title': '遠端主機沒有 npm 或 bun',
  'desktopHostSwitcher.sshError.packageManagerMissing.guidance': '請在遠端安裝 npm（隨 Node.js 提供）或 bun，然後重試。安裝 Host CLI 需要其中之一。',
  'desktopHostSwitcher.sshError.nativeBinding.title': '遠端資料庫模組編譯失敗',
  'desktopHostSwitcher.sshError.nativeBinding.guidance': '請在遠端安裝 Node.js 22 或 24 LTS。Node 23 這類奇數版本通常沒有預編譯套件，需要 python3、gcc 和 make。裝好 LTS 後重新連線。',
  'desktopHostSwitcher.sshError.openchamberCliMissing.title': '遠端找不到 OpenChamber 命令',
  'desktopHostSwitcher.sshError.openchamberCliMissing.guidance': '安裝已結束，但 openchamber --version 沒有回報可用版本。請確認 ~/.bun/bin 或 npm 全域 bin 在 PATH 裡，然後重試。也可以先 SSH 上去執行 openchamber --version。',
  'desktopHostSwitcher.sshError.openchamberRegistry.title': '無法從遠端下載 OpenChamber',
  'desktopHostSwitcher.sshError.openchamberRegistry.guidance': '遠端無法連到 npm 來源或目前的鏡像。請檢查網路、代理和 npm registry，然後重試。也可以用 Node 22/24 和 npm 自行安裝 @openchambery/web。',
  'desktopHostSwitcher.sshError.openchamberInstall.title': '無法在遠端安裝 OpenChamber',
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'bun 或 npm 安裝 @openchambery/web 失敗。請查看此主機 SSH 日誌中的套件管理器輸出，然後重試。也可以用 Node 22/24 自行安裝 @openchambery/web。',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.title': '遠端 OpenChamber CLI 版本過舊',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance': '遠端 CLI 不認識目前桌面端傳送的參數（例如 --relay-host）。請把遠端的 @openchambery/web 升級到支援 SSH relay host 的版本，然後重試。',
  'desktopHostSwitcher.sshError.opencodeInstall.title': '無法在遠端安裝 OpenCode CLI',
  'desktopHostSwitcher.sshError.opencodeInstall.guidance': '請檢查遠端網路和套件管理器，然後重試。也可以在遠端手動安裝 OpenCode CLI。',
  'desktopHostSwitcher.sshError.serverStart.title': '遠端 OpenChamber 服務沒有啟動',
  'desktopHostSwitcher.sshError.serverStart.guidance': 'SSH 已連通，但 Host 行程沒有變為可存取。確認遠端是 Node 22/24，且所選連接埠空閒，然後重試。',
  'desktopHostSwitcher.sshError.sshAuth.title': 'SSH 驗證失敗',
  'desktopHostSwitcher.sshError.sshAuth.guidance': '請在「設定 → 遠端實例」中檢查金鑰、密碼和目標位址。SSH 登入成功後才能完成初始化。',
  'desktopHostSwitcher.sshError.sshUnreachable.title': '無法連線到 SSH 主機',
  'desktopHostSwitcher.sshError.sshUnreachable.guidance': '請檢查主機名稱、連接埠和網路（如需 VPN 或跳板主機請先連上），然後重試。',
  'desktopHostSwitcher.sshError.timeout.title': 'SSH 連線逾時',
  'desktopHostSwitcher.sshError.timeout.guidance': '遠端沒有在時限內完成初始化。請檢查網路，並確認遠端已安裝 Node 22/24，然後重試。',
  'desktopHostSwitcher.sshError.unknown.title': '遠端實例啟動失敗',
  'desktopHostSwitcher.sshError.unknown.guidance': '遠端初始化失敗。請看下方具體錯誤，或到「設定 → 遠端實例」查看該主機的 SSH 日誌。',
  ...
  'updateDialog.status.otaBundleReused': '已使用之前下載的更新包，無需重新下載。',
  ...
  'updateDialog.actions.applyOtaNow': '一鍵更新',
  'updateDialog.actions.later': '稍後',
  ...
  'mobileUpdate.ota.toast.available.title': '發現新版本',
  'mobileUpdate.ota.toast.available.description': '版本 {version} 已可安裝。',
  ...
  'common.relative.justNow': '剛剛',
  'common.relative.minutesAgoShort': '{count} 分鐘前',
  'common.relative.hoursAgoShort': '{count} 小時前',
  'common.relative.daysAgoShort': '{count} 天前',
  'common.relative.weeksAgoShort': '{count} 週前',
  'common.relative.yearsAgoShort': '{count} 年前',
  'common.relative.minutesAgoCompact': '{count} 分鐘前',
  'common.relative.hoursAgoCompact': '{count} 小時前',
  'common.relative.daysAgoCompact': '{count} 天前',
  'common.relative.weeksAgoCompact': '{count} 週前',
  'common.relative.monthsAgoCompact': '{count} 個月前',
  ...
  'header.workStatusPanel.toggleAria': '切換工作狀態',
  ...
  'chat.workStatus.section.telemetry': '本輪統計',
  'chat.workStatus.section.subagents': '子智能體',
  'chat.workStatus.section.mcp': 'MCP',
  'chat.workStatus.section.contextSources': '上下文來源',
  'chat.workStatus.context.label': '上下文',
  'chat.workStatus.cost.breakdown': '工作階段 {session} · 子代理 {subagents}',
  'chat.workStatus.git.changedFileSingle': '{count} 個檔案已變更',
  'chat.workStatus.git.changedFilePlural': '{count} 個檔案已變更',
  'chat.workStatus.pr.untitled': '未命名的拉取請求',
  ...
  'chat.workStatus.attention.cherryPick': '正在揀選',
  ...
  'chat.workStatus.sections.open': '選擇分區',
  'chat.workStatus.sections.allHidden': '所有分區都已隱藏',
  'chat.workStatus.sections.showAll': '全部顯示',
  'chat.workStatus.sections.dialogTitle': '工作狀態分區',
  'chat.workStatus.sections.dialogDescription': '選擇卡片顯示哪些分區。拖曳可調整順序。',
  'chat.workStatus.breakdown.skills': '技能',
  'chat.workStatus.breakdown.mcp': 'MCP 伺服器',
  'chat.workStatus.telemetry.tokens': 'Token',
  'chat.workStatus.telemetry.duration': '耗時',
  'chat.workStatus.telemetry.cost': '花費',
  'chat.workStatus.usage.refresh': '重新整理額度',
  'chat.workStatus.compact.onBranch': '在 {branch}',
  'chat.workStatus.compact.changes': '變更',
  'opencodeUpgrade.screen.title': '需要 OpenCode 2.0.15',
  'opencodeUpgrade.screen.outdatedTitle': '更新 OpenCode',
  'opencodeUpgrade.screen.local': '目前安裝的是 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode v2。',
  'opencodeUpgrade.screen.outdatedLocal': '目前安裝的是 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode {minimum} 或更新版本。',
  'opencodeUpgrade.screen.external': '已連線的伺服器正在執行 OpenCode {version}。請在該伺服器安裝 OpenCode v2，然後重新檢查。',
  'opencodeUpgrade.screen.outdatedExternal': '已連線的伺服器正在執行 OpenCode {version}。請更新到 OpenCode {minimum} 或更新版本，然後重新檢查。',
  'opencodeUpgrade.screen.bundled': '隨 OpenChamber 附帶的 OpenCode {version} 低於 {minimum}。可以安裝一份受管理的複本，而不改動附帶的二進位檔。',
  'opencodeUpgrade.screen.installDescription': 'OpenChamber 會把 OpenCode {minimum} 或更新版本安裝到受管理的快取並重新啟動。不會覆寫你現有的 OpenCode 檔案。',
  'opencodeUpgrade.screen.install': '安裝 OpenCode {minimum}',
  'opencodeUpgrade.screen.update': '更新到 OpenCode {minimum}',
  'opencodeUpgrade.screen.installing': '正在安裝 OpenCode…',
  'opencodeUpgrade.screen.updating': '正在更新 OpenCode…',
  'opencodeUpgrade.screen.reconnect': '重新檢查',
  'opencodeUpgrade.screen.reconnecting': '正在檢查…',
  'opencodeUpgrade.screen.failedTitle': 'OpenCode 並未升級',
  'opencodeUpgrade.screen.failedGeneric': '安裝沒有完成。OpenCode 仍是先前的版本。',
  'opencodeUpgrade.screen.guide': '安裝指南',
  'opencodeUpgrade.screen.manualGuidance': '此執行環境無法自動安裝。請自行更新 OpenCode，然後重新檢查。',
};
