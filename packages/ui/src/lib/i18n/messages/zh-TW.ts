...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.draftPresets.plan.label': '開始功能規劃',
  ...
  'chat.assistantStatus.switchingToPlanning': '正在切換至規劃',
  'chat.assistantStatus.switchingToBuilding': '正在切換至建置',
  ...
  'chat.tools.display.plan_enter': '計劃模式',
  'chat.tools.display.plan_exit': '建置模式',
