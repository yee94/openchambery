...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.questionDelegate.awaiting': '等待主機確認…',
  ...
  'chat.questionDelegate.stale': '目前顯示上次狀態，主機同步尚待完成。',
  'chat.questionDelegate.pauseFailed': '暫停失敗，主機倒數可能仍在執行。',
  ...
  'chat.emptyState.draftTitle': '我們在做什麼？',
  'chat.emptyState.draftTitleWithProject': '我們在 {project} 中做什麼？',
