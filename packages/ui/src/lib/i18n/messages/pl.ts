...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.response.contentFilter': 'Dostawca zablokował odpowiedź',
  'chat.response.transport': 'Nie udało się połączyć z dostawcą',
  'chat.response.internal': 'Wewnętrzny błąd dostawcy',
  'chat.response.invalidOutput': 'Nieprawidłowa odpowiedź dostawcy',
  'chat.response.invalidRequest': 'Dostawca odrzucił żądanie',
  'chat.response.unsupportedOperation': 'Dostawca nie obsługuje tej operacji',
  'chat.response.noRoute': 'Model lub konfiguracja dostawcy są niedostępne',
  'chat.response.providerUnknown': 'Błąd dostawcy',
  'chat.response.timeout': 'Przekroczono czas oczekiwania na dostawcę',
  'chat.response.permissionRejected': 'Odmówiono uprawnień',
  'chat.response.toolExecution': 'Wykonanie narzędzia nie powiodło się',
  'chat.response.compactionFailed': 'Kompaktowanie kontekstu nie powiodło się',
  'chat.response.compactionUnavailable': 'Nie ma jeszcze treści do skompaktowania',
  'chat.response.compactionInterrupted': 'Kompaktowanie kontekstu przerwane',
  'chat.response.compactionCancelled': 'Kompaktowanie kontekstu anulowane',
  'chat.response.stopped': 'Zatrzymano przez użytkownika',
  'chat.response.interrupted': 'Odpowiedź przerwana',
  'chat.response.toolInterrupted': 'Wykonanie narzędzia przerwane',
  'chat.response.resumeExhausted': 'Zatrzymano automatyczne odzyskiwanie po wielokrotnych przerwaniach',
  'chat.response.retrying': 'Automatyczne ponawianie',
  'chat.response.failed': 'Wykonanie nie powiodło się',
  'chat.response.continuingAfterRestart': 'Kontynuacja po ponownym uruchomieniu',
  'chat.queuedMessage.inheritsSessionSelection': 'Podczas wykonania dziedziczy model, agenta i wariant sesji.',
  'chat.sessionRecovery.awaitingConfirmation': 'Usługa została uruchomiona ponownie. Oczekiwanie na potwierdzenie stanu zadania.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': 'Generowanie odpowiedzi nie powiodło się. Spróbuj ponownie.',
  'chat.btw.description': 'Zapytaj o rozmowę, zachowując jej historię bez zmian.',
  'chat.btw.placeholder': 'Zapytaj w Side Chat…',
  'chat.btw.removeQuoteAria': 'Usuń cytat',
  'chat.message.conversationQuotesLabel': 'Cytat z rozmowy',
  'chat.btw.sessionRequired': 'Otwórz istniejącą rozmowę, aby rozpocząć Side Chat.',
  'chat.btw.plainTextRequired': 'Użyj zwykłego tekstu. Odwołania pozostają w polu wpisywania.',
  'chat.btw.pending': 'Przygotowywanie odpowiedzi…',
  'chat.btw.cancelled': 'Odpowiedź anulowana. Spróbuj ponownie, aby powtórzyć pytanie.',
  'chat.btw.resize': 'Zmień rozmiar panelu Side Chat',
  ...settingsDict,
  'chat.questionDelegate.countdown': 'Model zdecyduje za {seconds} s',
  'chat.questionDelegate.awaiting': 'Oczekiwanie na potwierdzenie…',
  ...
  'chat.questionDelegate.stale': 'Wyświetlany jest ostatni znany stan; aktualizacja trwa.',
  'chat.questionDelegate.pauseFailed': 'Wstrzymanie nie powiodło się. Odliczanie może nadal trwać.',
  ...
  'mobile.connect.link.divider': 'Lub użyj linku parowania',
  'mobile.connect.address.divider': 'Lub wprowadź adres serwera',
  'mobile.connect.link.label': 'Link parowania',
  'mobile.connect.link.placeholder': 'Wklej link openchamber://connect',
  'mobile.connect.link.invalid': 'Ten link parowania jest nieprawidłowy lub wygasł.',
  ...
  'mobile.instances.sshViaDesktop': 'Przez pulpit do SSH',
  'mobile.connect.error.sshNotConnected': 'Ta instancja SSH nie jest teraz połączona.',
  'mobile.connect.ssh.fallbackDesktop': 'Instancja SSH niedostępna — połączono z pulpitem.',
  ...
  'mobile.select.sheetAria': 'Wybierz opcję',
  ...
  'mobile.menu.newSession': 'Nowy czat',
  'mobile.chat.syncingMessages': 'Synchronizowanie wiadomości...',
  ...
  'mobile.sessions.mainWorkspace': 'Główny obszar roboczy',
  'mobile.sessions.section.pinned': 'Przypięte / W toku',
  'mobile.sessions.searchAria': 'Szukaj sesji',
  'mobile.sessions.section.otherProjects': 'Zmień projekt',
  'mobile.sessions.section.projects': 'Projekty',
  'mobile.projects.menu.label': 'Więcej akcji',
  'mobile.projects.menu.newChat': 'Nowa rozmowa',
  'mobile.projects.menu.newProject': 'Nowy projekt',
  'mobile.projects.menu.scanQr': 'Skanuj kod QR',
  'mobile.projects.menu.switchInstance': 'Przełącz instancję',
  ...
  'mobile.sessions.startNewChat': 'Nowy czat',
  ...
  'mobile.projects.closeConfirmMessage': 'Zamknąć „{title}”? Zniknie z listy projektów. Sesje pozostaną na dysku.',
  ...
  'mobile.sessions.stopSessionAria': 'Zatrzymaj {title}',
  'mobile.sessions.stopGroupAria': 'Zatrzymaj wszystkie uruchomione sesje w {label}',
  'mobile.sessions.stopSubsessionsAria': 'Zatrzymaj uruchomione podsesje {title}',
  ...
  'mobile.sessions.newSessionAria': 'Rozpocznij nowy czat w tym projekcie',
  ...
  'mobile.files.html.fullscreenAria': 'Otwórz podgląd pełnoekranowy',
  'mobile.files.html.exitFullscreenAria': 'Zamknij pełny ekran',
  'mobile.files.html.viewSourceAria': 'Pokaż kod źródłowy',
  'mobile.files.html.viewPreviewAria': 'Pokaż podgląd',
  ...
  'layout.rightSidebar.browser': 'Przeglądarka',
  'layout.browserProvider.noSurface': '{name} nie ma podglądu na żywo.',
  'layout.browserProvider.status.connecting': 'Łączenie…',
  'layout.browserProvider.status.reconnecting': 'Utracono połączenie. Ponowne łączenie…',
  'layout.browserProvider.status.ready': 'Kliknij lub wpisz, aby przejąć kontrolę',
  'layout.browserProvider.status.readyFocused': 'Pisz, aby sterować widokiem; kliknij poza nim, aby wyjść',
  'layout.browserProvider.status.agentWorking': 'Agent pracuje',
  'layout.browserProvider.status.youControl': 'Masz kontrolę',
  'layout.browserProvider.status.otherControls': 'Kontrolę ma inne urządzenie',
  'layout.browserProvider.handBack': 'Oddaj rozszerzeniu',
  'layout.browserProvider.retry': 'Spróbuj ponownie',
  'layout.browserProvider.canvasAria': 'Podgląd na żywo: {name}',
  'layout.browserProvider.ended.service-stopped': 'Usługa rozszerzenia zatrzymała się.',
  'layout.browserProvider.ended.extension-unavailable': 'Rozszerzenie jest niedostępne.',
  'layout.browserProvider.ended.host-shutdown': 'OpenChamber się zamyka.',
  ...
  'sessions.sidebar.header.actions.newSession': 'Nowy czat',
  ...
  'sessions.sidebar.header.actions.sessionDisplayMode': 'Działania rozwijania/zwijania projektów',
  'sessions.sidebar.header.displayMode.label': 'Rozwiń/zwiń projekty',
  ...
  'sessions.sidebar.project.loadingSessions': 'Ładowanie sesji…',
  ...
  'sessions.sidebar.project.actions.syncSessions': 'Synchronizuj sesje',
  ...
  'sessions.sidebar.session.menu.refreshTranscript': 'Synchronizuj wiadomości',
  'sessions.sidebar.session.menu.refreshTranscriptSuccess': 'Wiadomości zsynchronizowane',
  'sessions.sidebar.session.menu.refreshTranscriptFailed': 'Nie udało się zsynchronizować wiadomości',
  ...
  'sessions.sidebar.bulkActions.archiveUndoFailed': 'Nie udało się przywrócić {count} sesji',
  'sessions.sidebar.undo': 'Cofnij',
  'sessions.sidebar.openSettings': 'Ustawienia',
  'sessions.scheduledTasks.dialog.title': 'Zaplanowane zadania',
  'sessions.scheduledTasks.dialog.actions.create': 'Utwórz',
  'sessions.scheduledTasks.dialog.actions.moreAria': 'Więcej działań dla {taskName}',
  'sessions.scheduledTasks.dialog.actions.delete': 'Usuń',
  'sessions.scheduledTasks.dialog.actions.pause': 'Wstrzymaj',
  'sessions.scheduledTasks.dialog.actions.resume': 'Wznów',
  'sessions.scheduledTasks.workspace.filters.all': 'Wszystkie',
  'sessions.scheduledTasks.workspace.filters.active': 'Aktywne',
  'sessions.scheduledTasks.workspace.filters.paused': 'Wstrzymane',
  'sessions.scheduledTasks.workspace.views.aria': 'Widoki harmonogramu',
  'sessions.scheduledTasks.workspace.views.tasks': 'Zadania',
  'sessions.scheduledTasks.workspace.views.history': 'Historia',
  'sessions.scheduledTasks.history.loading': 'Wczytywanie historii uruchomień…',
  'sessions.scheduledTasks.history.error.title': 'Nie udało się wczytać historii uruchomień',
  'sessions.scheduledTasks.history.error.description': 'OpenChamber nie mógł wczytać zapisanych uruchomień.',
  'sessions.scheduledTasks.history.error.more': 'Nie udało się wczytać kolejnych uruchomień. Wczytana historia pozostaje dostępna.',
  'sessions.scheduledTasks.history.retry': 'Spróbuj ponownie',
  'sessions.scheduledTasks.history.empty.title': 'Brak uruchomień',
  'sessions.scheduledTasks.history.empty.description': 'Tutaj pojawią się uruchomienia zaplanowane i ręczne.',
  'sessions.scheduledTasks.history.trigger.scheduled': 'Zaplanowane',
  'sessions.scheduledTasks.history.trigger.manual': 'Ręczne',
  'sessions.scheduledTasks.history.meta.trigger': 'Wyzwalacz',
  'sessions.scheduledTasks.history.meta.started': 'Start',
  'sessions.scheduledTasks.history.meta.ended': 'Koniec',
  'sessions.scheduledTasks.history.meta.duration': 'Czas trwania',
  'sessions.scheduledTasks.history.ended.unavailable': '—',
  'sessions.scheduledTasks.history.duration.pending': 'W toku',
  ...
  'sessions.scheduledTasks.history.loadingMore': 'Wczytywanie…',
  'sessions.scheduledTasks.history.loadMore': 'Wczytaj więcej',
  'sessions.scheduledTasks.workspace.search.placeholder': 'Szukaj zadań…',
  'sessions.scheduledTasks.workspace.search.noResults': 'Brak zadań pasujących do wyszukiwania.',
  'sessions.scheduledTasks.workspace.partialLoadWarning': 'Nie udało się wczytać zaplanowanych zadań dla części projektów. Wczytane zadania pozostają dostępne.',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': 'Wybierz zadanie',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': 'Wybierz zadanie z listy lub utwórz nowe.',
  'sessions.scheduledTasks.workspace.confirm.discardChanges': 'Niezapisane zmiany zostaną odrzucone. Kontynuować?',
  'sessions.scheduledTasks.editor.panel.details': 'Szczegóły',
  'sessions.scheduledTasks.editor.panel.frequency': 'Częstotliwość',
  ...
  'sessions.sidebar.session.actions.pinned': 'Przypięte',
  'sessions.sidebar.session.status.permissionRequired': 'Wymagane uprawnienie',
  'sessions.sidebar.session.status.questionRequired': 'Wymagana odpowiedź',
  ...
  'sessions.sidebar.session.archive.undoFailed': 'Nie udało się cofnąć archiwizacji',
  ...
  'sessions.sidebar.group.showMore': 'Więcej',
  ...
  'sessions.sidebar.group.showFewer': 'Mniej',
  ...
  'chat.fileAttachment.actions.expandImages': 'Pokaż więcej obrazów',
  'chat.fileAttachment.actions.collapseImages': 'Zwiń obrazy',
  ...
  'chat.activity.title': 'Szczegóły przetwarzania',
  'chat.activity.active': 'Przetwarzanie',
  'chat.activity.compacting': 'Kompresowanie',
  'chat.activity.compactionCompleted': 'Kompresja zakończona',
  'chat.activity.compactionFailed': 'Kompresja nie powiodła się',
  'chat.activity.expandAria': 'Rozwiń szczegóły przetwarzania',
  'chat.activity.collapseAria': 'Zwiń szczegóły przetwarzania',
  ...
  'chat.activity.moreHidden': '+{count} więcej...',
  ...
  'chat.emptyState.establishingConversation': 'Nawiązywanie rozmowy',
  ...
  'chat.draftStarters.remove': 'Usuń',
  'chat.draftStarters.expand': 'Pokaż więcej',
  'chat.draftStarters.collapse': 'Zwiń',
  ...
  'chat.assistantStatus.updatingTodos': 'Aktualizowanie zadań',
  'chat.assistantStatus.readingTodos': 'Odczytywanie zadań',
  'chat.assistantStatus.learningSkill': 'Poznawanie umiejętności',
  'chat.assistantStatus.askingQuestion': 'Zadawanie pytania',
  'chat.assistantStatus.executing': 'Wykonywanie kodu',
  'chat.assistantStatus.renamingSession': 'Zmienianie nazwy sesji',
  'chat.assistantStatus.movingSession': 'Przenoszenie sesji',
  'chat.assistantStatus.usingBrowser': 'Używanie przeglądarki',
  'chat.assistantStatus.usingTool': 'Używanie {tool}',
  'chat.assistantStatus.working': 'Praca w toku',
  'chat.assistantStatus.processing': 'Przetwarzanie',
  'chat.assistantStatus.preparing': 'Przygotowywanie',
  'chat.assistantStatus.warmingUp': 'Rozgrzewanie',
  'chat.assistantStatus.gearsTurning': 'Praca w toku',
  'chat.assistantStatus.computing': 'Obliczanie',
  'chat.assistantStatus.calculating': 'Kalkulowanie',
  'chat.assistantStatus.analyzing': 'Analizowanie',
  'chat.assistantStatus.wheelsSpinning': 'Praca w toku',
  'chat.assistantStatus.calibrating': 'Kalibrowanie',
  'chat.assistantStatus.synthesizing': 'Syntezowanie',
  'chat.assistantStatus.connectingDots': 'Łączenie informacji',
  'chat.assistantStatus.inspectingLogic': 'Sprawdzanie logiki',
  'chat.assistantStatus.weighingOptions': 'Rozważanie opcji',
  'chat.assistantStatus.thinking': 'Myślenie',
  'chat.assistantStatus.composing': 'Tworzenie',
  'chat.assistantStatus.sendingMessage': 'Wysyłanie wiadomości',
  'chat.assistantStatus.waitingForPermission': 'Oczekiwanie na uprawnienie',
  'chat.assistantStatus.retrying': 'Ponawianie próby',
  'chat.assistantStatus.retryingIn': 'Ponowna próba {duration}',
  'chat.assistantStatus.retryingAttempt': 'Ponowna próba (próba {attempt})',
  'chat.assistantStatus.retryingInAttempt': 'Ponowna próba {duration} (próba {attempt})',
  ...
  'chat.revertPopover.files': 'Pliki, które się zmienią',
  ...
  'chat.revert.toast.busy': 'Nie można cofnąć, gdy sesja jest zajęta',
  'chat.form.title': 'Formularz',
  'chat.form.reply': 'Wyślij',
  'chat.form.cancel': 'Anuluj',
  'chat.retry.action.quota': 'Osiągnięto limit użycia',
  'chat.retry.action.account': 'Osiągnięto limit konta',
  'chat.retry.action.open': 'Otwórz',
  ...
  'chat.commandAutocomplete.command.reloadDescription': 'Przeładuj konfigurację, dostawców i wtyczki OpenCode bez ponownego uruchamiania',
  ...
  'chat.commandAutocomplete.command.newDescription': 'Rozpocznij nową sesję w bieżącym projekcie.',
  ...
  'chat.fileMentionAutocomplete.groups.skills': 'Umiejętności',
  'chat.fileMentionAutocomplete.groups.agents': 'Agenci',
  'chat.fileMentionAutocomplete.groups.sessions': 'Wczytane sesje',
  'chat.fileMentionAutocomplete.groups.directories': 'Katalogi',
  'chat.fileMentionAutocomplete.groups.recentFiles': 'Ostatnie pliki',
  'chat.fileMentionAutocomplete.groups.files': 'Pliki',
  'chat.fileMentionAutocomplete.sessionType': 'Sesja OpenCode',
  'chat.fileMentionAutocomplete.untitledSession': 'Sesja bez tytułu',
  ...
  'chat.queuedMessage.title': 'Kolejka',
  'chat.queuedMessage.edit': 'edytuj',
  'chat.queuedMessage.send': 'kieruj',
  'chat.queuedMessage.queuing': 'Dodawanie do kolejki…',
  'chat.queuedMessage.queuingAria': 'Dodawanie wiadomości do kolejki',
  'chat.queuedMessage.waitingForCompaction': 'Oczekiwanie na kompresję',
  'chat.queuedMessage.waitingForCompactionAria': 'Oczekiwanie na zakończenie kompresji',
  'chat.queuedMessage.sending': 'Kierowanie…',
  'chat.queuedMessage.sendingAria': 'Kierowanie wiadomością',
  ...
  'chat.textSelection.actions.addToSideChat': 'Dodaj do czatu bocznego',
  'chat.textSelection.title.addToCurrentChat': 'Dodaj do obecnego czatu',
  'chat.messageBody.aborted': 'Generowanie zatrzymane',
  'chat.messageBody.actions.editing': 'Edytowanie…',
  'chat.messageBody.actions.editStaged': 'Edycja oczekuje',
  'chat.messageBody.actions.cancelEdit': 'Anuluj edycję',
  ...
  'chat.messageBody.meta.tpsAria': 'Szybkość generowania: {rate}',
  'chat.messageBody.meta.tpsTooltip': 'Szybkość generowania (tokeny/s), bez czasu wywołań narzędzi',
  ...
  'chat.forkTransition.preparing': 'Przygotowywanie rozwidlenia',
  'chat.forkTransition.copying': 'Kopiowanie rozmowy (długie sesje mogą potrwać)',
  'chat.forkTransition.opening': 'Otwieranie nowej sesji',
  'chat.forkTransition.loading': 'Ładowanie ostatnich wiadomości',
  ...
  'chat.chatInput.actions.queuingMessageAria': 'Queuing…',
  'chat.chatInput.actions.sendingMessageAria': 'Sending…',
  ...
  'chat.chatInput.draftPicker.newProject': 'Nowy projekt',
  ...
  'chat.chatInput.toast.reloadStarted': 'Przeładowywanie konfiguracji…',
  'chat.chatInput.toast.reloadSucceeded': 'Konfiguracja przeładowana',
  'chat.chatInput.toast.reloadFailed': 'Nie udało się przeładować konfiguracji',
  ...
  'chat.chatInput.branchSwitch.description': 'Jak otworzyć tę gałąź w nowej rozmowie?',
  'chat.chatInput.branchSwitch.createWorktree': 'Utwórz worktree',
  'chat.chatInput.branchSwitch.createWorktreeDescription': 'Pozostaw bieżący katalog bez zmian i pracuj w izolowanym worktree.',
  'chat.chatInput.branchSwitch.checkoutHere': 'Checkout tutaj',
  'chat.chatInput.branchSwitch.checkoutHereDescription': 'Przełącz bieżący katalog na tę gałąź.',
  'chat.chatInput.branchSwitch.cancel': 'Anuluj',
  ...
  'chat.messageBody.subagent.completed': 'Ukończono',
  'chat.messageBody.subagent.error': 'Niepowodzenie',
  'chat.messageBody.subagent.cancelled': 'Anulowano',
  'chat.messageBody.subagent.completedDescription': 'Podagent działający w tle zakończył pracę',
  'chat.messageBody.subagent.errorDescription': 'Podagent działający w tle nie wykonał zadania',
  'chat.messageBody.subagent.cancelledDescription': 'Podagent działający w tle został anulowany',
  'chat.messageBody.subagent.openSession': 'Otwórz sesję podagenta: {label}',
  'chat.sessionBackground.moveRunning': 'Przenieś do tła',
  'chat.sessionBackground.moving': 'Przenoszenie…',
  'chat.sessionBackground.moveFailed': 'Nie udało się przenieść pracy do tła',
  'chat.sessionBackground.tasksRunning': '{count} zadanie/zadań w tle',
  ...
  'chat.contextGroup.exploring': 'Eksplorowanie',
  'chat.contextGroup.explored': 'Zeksplorowano',
  'chat.contextGroup.expandAria': 'Rozwiń zeksplorowane narzędzia',
  'chat.contextGroup.collapseAria': 'Zwiń zeksplorowane narzędzia',
  'chat.contextGroup.readSingle': '{count} odczyt',
  'chat.contextGroup.readPlural': '{count} odczyty',
  'chat.contextGroup.searchSingle': '{count} wyszukiwanie',
  'chat.contextGroup.searchPlural': '{count} wyszukiwania',
  'chat.contextGroup.listSingle': '{count} lista',
  'chat.contextGroup.listPlural': '{count} listy',
  'chat.usedGroup.running': 'W toku',
  'chat.usedGroup.used': 'Użyto',
  'chat.usedGroup.expandAria': 'Rozwiń użyte narzędzia',
  'chat.usedGroup.collapseAria': 'Zwiń użyte narzędzia',
  'chat.usedGroup.editSingle': '{count} edycja',
  'chat.usedGroup.editPlural': '{count} edycje',
  'chat.usedGroup.commandSingle': '{count} polecenie',
  'chat.usedGroup.commandPlural': '{count} polecenia',
  'chat.usedGroup.otherSingle': '{count} wywołanie',
  'chat.usedGroup.otherPlural': '{count} wywołania',
  'chat.skillGroup.expandAria': 'Rozwiń wczytane umiejętności',
  'chat.skillGroup.collapseAria': 'Zwiń wczytane umiejętności',
  'chat.skillGroup.summaryOverflow': '{names} i jeszcze {count}',
  'chat.tools.display.read': 'Odczyt pliku',
  'chat.tools.display.write': 'Zapis pliku',
  'chat.tools.display.edit': 'Edycja pliku',
  'chat.tools.display.apply_patch': 'Zastosuj poprawkę',
  'chat.tools.display.bash': 'Polecenie powłoki',
  'chat.tools.display.grep': 'Szukaj w plikach',
  'chat.tools.display.glob': 'Znajdź pliki',
  'chat.tools.display.list': 'Lista katalogu',
  'chat.tools.display.task': 'Zadanie agenta',
  'chat.tools.display.webfetch': 'Pobierz URL',
  'chat.tools.display.websearch': 'Wyszukiwanie w sieci',
  'chat.tools.display.codesearch': 'Wyszukiwanie kodu',
  'chat.tools.display.todowrite': 'Aktualizuj listę zadań',
  'chat.tools.display.todoread': 'Odczytaj listę zadań',
  'chat.tools.display.skill': 'Wczytaj umiejętność',
  'chat.tools.display.question': 'Pytanie',
  'chat.tools.display.lsp': 'LSP',
  'chat.tools.display.structuredoutput': 'Dane strukturalne',
  'chat.tools.display.execute': 'Wykonaj kod',
  'chat.tools.display.session_rename': 'Zmień nazwę sesji',
  'chat.tools.display.session_move': 'Przenieś sesję',
  'chat.tools.display.browser': 'Przeglądarka',
  ...
  'chat.modelControls.costPerMillion': 'Koszt',
  'chat.modelControls.costInput': 'Wejście',
  'chat.modelControls.costOutput': 'Wyjście',
  ...
  'chat.modelControls.keyboardHintSwitchAgentLabel': 'Przełącz agenta',
  ...
  'chat.permissionCard.replaceAll': 'Zamień wszystkie wystąpienia',
  'chat.permissionCard.responseFormat': 'Format odpowiedzi:',
  'chat.permissionCard.allowOnce': 'Zezwól raz',
  'chat.permissionCard.alwaysAgree': 'Zawsze zezwalaj',
  ...
  'chat.toolOutputDialog.image.zoomInAria': 'Powiększ',
  'chat.toolOutputDialog.image.zoomOutAria': 'Pomniejsz',
  'chat.toolOutputDialog.image.resetZoomAria': 'Resetuj powiększenie',
  'chat.image.actions.sheetTitle': 'Obraz',
  'chat.image.actions.saveImage': 'Zapisz obraz',
  'chat.image.actions.saveToPhotos': 'Zapisz w Zdjęciach',
  'chat.image.actions.saving': 'Zapisywanie…',
  'chat.image.actions.saveSuccess': 'Obraz zapisany',
  'chat.image.actions.saveFailed': 'Nie udało się zapisać obrazu',
  ...
  'chat.activity.outputLoading': 'Wczytywanie pełnych danych wyjściowych…',
  'chat.activity.outputLoadFailed': 'Nie udało się wczytać pełnych danych wyjściowych.',
  'chat.activity.outputRetry': 'Spróbuj ponownie',
  ...
  'chat.fileAttachment.image.loadManuallyCount': 'Wczytaj obrazy ({count})',
  ...
  'commandPalette.item.newTerminalTab': 'Nowa karta terminala',
  'commandPalette.session.untitled': 'Nienazwana sesja',
  'commandPalette.title': 'Wyszukiwanie globalne',
  'commandPalette.error.sessions': 'Nie udało się wczytać wyszukiwania czatów. Dostępne wyniki pozostają widoczne.',
  ...
  'contextPanel.mode.context': 'Użycie',
  ...
  'contextPanel.file.notice.turnDiffOutsideWorkspace': 'Diff tej tury jest niedostępny poza projektem. Pokazujemy bieżącą treść pliku.',
  ...
  'contextSidebar.empty.openSession': 'Otwórz sesję, aby sprawdzić użycie.',
  'contextSidebar.section.context': 'Użycie',
  ...
  'contextSidebar.stats.sessionTps': 'TPS sesji',
  ...
  'contextUsage.tooltip.usage': 'Użycie: {percent}',
  ...
  'desktopHostSwitcher.sshError.openRemoteSettings': 'Otwórz instancje zdalne',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.title': 'Host zdalny nie ma Node.js 22+',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance': 'Zainstaluj Node.js 22 lub 24 LTS na maszynie zdalnej (nvm, fnm lub pakiet systemowy). Powłoka logowania z samym Node 18/20 nie wystarczy, chyba że w standardowej ścieżce jest binarka 22+.',
  'desktopHostSwitcher.sshError.packageManagerMissing.title': 'Host zdalny nie ma npm ani bun',
  'desktopHostSwitcher.sshError.packageManagerMissing.guidance': 'Zainstaluj npm (dołączony do Node.js) lub bun na maszynie zdalnej i spróbuj ponownie. OpenChamber potrzebuje jednego z nich, aby zainstalować Host CLI.',
  'desktopHostSwitcher.sshError.nativeBinding.title': 'Nie udało się zbudować zdalnego modułu bazy danych',
  'desktopHostSwitcher.sshError.nativeBinding.guidance': 'Zainstaluj Node.js 22 lub 24 LTS na hoście zdalnym. Nieparzyste wersje, takie jak Node 23, często nie mają gotowej binarki i wymagają python3, gcc oraz make. Gdy będzie dostępne LTS, połącz się ponownie.',
  'desktopHostSwitcher.sshError.openchamberCliMissing.title': 'Nie znaleziono polecenia OpenChamber na hoście zdalnym',
  'desktopHostSwitcher.sshError.openchamberCliMissing.guidance': 'Instalacja się zakończyła, ale openchamber --version nie zwrócił użytecznej wersji. Sprawdź, czy ~/.bun/bin lub globalny bin npm jest w PATH, i spróbuj ponownie. Możesz też uruchomić openchamber --version przez SSH.',
  'desktopHostSwitcher.sshError.openchamberRegistry.title': 'Nie udało się pobrać OpenChamber na hoście zdalnym',
  'desktopHostSwitcher.sshError.openchamberRegistry.guidance': 'Host zdalny nie może dotrzeć do rejestru npm ani skonfigurowanego lustra. Sprawdź sieć, proxy i ustawienia npm registry, a następnie spróbuj ponownie. Możesz też samodzielnie zainstalować @openchambery/web z Node 22 lub 24 i npm.',
  'desktopHostSwitcher.sshError.openchamberInstall.title': 'Nie udało się zainstalować OpenChamber na hoście zdalnym',
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'bun lub npm nie zainstalował @openchambery/web. Sprawdź wyjście menedżera pakietów w logach SSH tego hosta i spróbuj ponownie. Możesz też samodzielnie zainstalować @openchambery/web z Node 22 lub 24.',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.title': 'Zdalne CLI OpenChamber jest zbyt stare',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance': 'Zdalne CLI odrzuciło flagę wysłaną przez ten pulpit (np. --relay-host). Zaktualizuj @openchambery/web na hoście zdalnym do wersji z SSH relay host i spróbuj ponownie.',
  'desktopHostSwitcher.sshError.opencodeInstall.title': 'Nie udało się zainstalować OpenCode CLI na hoście zdalnym',
  'desktopHostSwitcher.sshError.opencodeInstall.guidance': 'Sprawdź sieć i menedżer pakietów na hoście zdalnym, a następnie spróbuj ponownie. Możesz też zainstalować OpenCode CLI ręcznie.',
  'desktopHostSwitcher.sshError.serverStart.title': 'Zdalny serwer OpenChamber nie uruchomił się',
  'desktopHostSwitcher.sshError.serverStart.guidance': 'SSH zadziałało, ale proces Host nie stał się osiągalny. Potwierdź, że zdalny ma Node 22/24 i że wybrany port jest wolny, po czym spróbuj ponownie.',
  'desktopHostSwitcher.sshError.sshAuth.title': 'Uwierzytelnianie SSH nie powiodło się',
  'desktopHostSwitcher.sshError.sshAuth.guidance': 'Sprawdź klucz SSH, hasło i miejsce docelowe w Ustawieniach → Instancje zdalne. Inicjalizacja nie zakończy się, dopóki logowanie SSH nie zadziała.',
  'desktopHostSwitcher.sshError.sshUnreachable.title': 'Nie można połączyć się z hostem SSH',
  'desktopHostSwitcher.sshError.sshUnreachable.guidance': 'Sprawdź nazwę hosta, port i sieć (najpierw połącz VPN lub bastion, jeśli jest wymagany), a następnie spróbuj ponownie.',
  'desktopHostSwitcher.sshError.timeout.title': 'Przekroczono limit czasu połączenia SSH',
  'desktopHostSwitcher.sshError.timeout.guidance': 'Host zdalny nie zakończył inicjalizacji na czas. Sprawdź sieć i czy zainstalowano Node 22 lub 24, a następnie spróbuj ponownie.',
  'desktopHostSwitcher.sshError.unknown.title': 'Nie udało się uruchomić instancji zdalnej',
  'desktopHostSwitcher.sshError.unknown.guidance': 'Inicjalizacja zdalna nie powiodła się. Zobacz dokładny błąd poniżej albo otwórz Ustawienia → Instancje zdalne i sprawdź logi SSH tego hosta.',
  ...
  'diffView.actions.openFilePreview': 'Otwórz ten plik',
  ...
  'chat.history.loadingMore': 'Wczytywanie…',
  'chat.history.loadOlderFailed': 'Nie udało się wczytać starszych wiadomości. Spróbuj ponownie.',
  'chat.history.loadOlderTimeout': 'Wczytywanie starszych wiadomości przekroczyło limit czasu. Spróbuj ponownie.',
  'chat.history.loadFailedTitle': 'Nie udało się wczytać tej rozmowy',
  'chat.history.loadFailedDescription': 'Rozmowa jest nadal dostępna. Spróbuj wczytać ją ponownie.',
  'chat.history.retry': 'Spróbuj ponownie',
  ...
  'gitView.changes.deferredTitle': 'Zmienione pliki: {count}',
  'gitView.changes.deferredStagedCount': 'W indeksie: {count}',
  'gitView.changes.deferredUnstagedCount': 'Poza indeksem: {count}',
  'gitView.changes.deferredHint': 'Bardzo duże zestawy zmian nie są renderowane automatycznie, aby aplikacja pozostawała responsywna.',
  'gitView.changes.deferredLoadAction': 'Wczytaj zmiany',
  ...
  'header.actions.sessionMenu': 'Akcje sesji',
  'header.actions.sessionMenuAria': 'Otwórz menu akcji sesji',
  'header.actions.sessionMenu.servicesWithInstance': 'Przełącz instancję ({current})',
  'header.actions.sessionMenu.viewUsage': 'Zobacz użycie',
  ...
  'header.services.closeAria': 'Zamknij przełącznik instancji',
  ...
  'header.services.open': 'Przełącz instancję',
  'header.services.openWithCurrent': 'Przełącz instancję (bieżąca: {current})',
  ...
  'header.services.title': 'Przełącz instancję',
  'header.services.tooltip.currentInstanceWithShortcuts': 'Przełącz instancję: {current} ({toggle}; następna karta {nextTab})',
  'header.services.tooltip.servicesWithShortcuts': 'Przełącz instancję ({toggle}; następna karta {nextTab})',
  'header.services.used': 'Wykorzystano',
  'header.services.viewAria': 'Przełącz instancję',
  ...
  'helpDialog.item.closeContextPanelTab': 'Zamknij kartę panelu kontekstu',
  'helpDialog.item.cycleServicesTab': 'Przełącz kartę usług',
  'helpDialog.item.cycleTheme': 'Przełącz motyw (Jasny → Ciemny → Systemowy)',
  'helpDialog.item.zoomIn': 'Powiększ',
  'helpDialog.item.zoomOut': 'Pomniejsz',
  'helpDialog.item.zoomReset': 'Resetuj powiększenie',
  ...
  'helpDialog.section.leaderChords': 'Klawisz lidera (Ctrl+X)',
  'helpDialog.item.leaderOpenModel': 'Otwórz selektor modelu',
  'helpDialog.item.leaderOpenAgent': 'Otwórz selektor agenta',
  'helpDialog.item.leaderNewSession': 'Utwórz nową sesję',
  'helpDialog.item.leaderCompact': 'Skompresuj bieżącą sesję',
  'chat.leaderKey.pendingAria': 'Klawisz lidera aktywny. Naciśnij kolejny klawisz.',
  'chat.leaderKey.action.model': 'Model',
  'chat.leaderKey.action.agent': 'Agent',
  'chat.leaderKey.action.newSession': 'Nowa',
  'chat.leaderKey.action.compact': 'Kompresja',
  'helpDialog.item.showKeyboardShortcuts': 'Pokaż skróty klawiaturowe (to okno)',
  'helpDialog.item.switchSession': 'Przełącz sesję',
  ...
  'helpDialog.item.openNewTerminal': 'Otwórz nowy terminal',
  'helpDialog.item.previousTerminalTab': 'Poprzednia karta terminala (gdy terminal ma fokus)',
  'helpDialog.item.nextTerminalTab': 'Następna karta terminala (gdy terminal ma fokus)',
  'helpDialog.item.toggleBottomPanel': 'Przełącz dolny panel',
  'helpDialog.item.toggleTerminalExpanded': 'Przełącz rozszerzenie terminala',
  'helpDialog.item.previousSession': 'Poprzednia sesja',
  'helpDialog.item.nextSession': 'Następna sesja',
  ...
  'helpDialog.proTips.recentSessions': '9 ostatnich czatów pojawia się w wyszukiwaniu globalnym',
  ...
  'sidebarFilesTree.actions.collapseAllTitle': 'Zwiń wszystko',
  'sidebarFilesTree.actions.expandAllTitle': 'Rozwiń wszystko',
  ...
  'updateDialog.actions.applyOtaNow': 'Aktualizuj teraz',
  'updateDialog.actions.later': 'Później',
  ...
  'mobileUpdate.ota.toast.available.title': 'Dostępna aktualizacja',
  'mobileUpdate.ota.toast.available.description': 'Wersja {version} jest gotowa do instalacji.',
  'mobileUpdate.ota.toast.actions.update': 'Aktualizuj',
  'mobileUpdate.ota.toast.actions.dismiss': 'Odrzuć',
  ...
  'updateDialog.status.otaBundleReused': 'Użyto wcześniej pobranego pakietu aktualizacji. Ponowne pobieranie nie jest potrzebne.',
  ...
  'chat.commandAutocomplete.command.modelDescription': 'Otwórz selektor modelu',
  'common.date.today': 'Today',
  'common.date.yesterday': 'Yesterday',
  'common.date.yesterdayWithTime': 'Yesterday {time}',
  'common.relative.justNow': 'Przed chwilą',
  'common.relative.minutesAgoShort': '{count} min temu',
  'common.relative.hoursAgoShort': '{count} godz. temu',
  'common.relative.daysAgoShort': '{count} dn. temu',
  'common.relative.weeksAgoShort': '{count} tyg. temu',
  'common.relative.yearsAgoShort': '{count} lat temu',
  'common.relative.minutesAgoCompact': '{count} min temu',
  'common.relative.hoursAgoCompact': '{count} godz. temu',
  'common.relative.daysAgoCompact': '{count} dn. temu',
  'common.relative.weeksAgoCompact': '{count} tyg. temu',
  'common.relative.monthsAgoCompact': '{count} mies. temu',
  'common.relative.yearsAgoCompact': '{count} lat temu',
  ...
  'header.workStatusPanel.toggleAria': 'Przełącz status pracy',
  'chat.workStatus.ariaLabel': 'Status pracy',
  ...
  'chat.workStatus.section.contextSources': 'Źródła kontekstu',
  'chat.workStatus.context.label': 'Kontekst',
  'chat.workStatus.cost.breakdown': 'Sesja {session} · Subagenci {subagents}',
  ...
  'chat.workStatus.pr.draft': 'Wersja robocza',
  ...
  'chat.workStatus.action.copyBranch': 'Kopiuj nazwę gałęzi',
  ...
  'chat.workStatus.subagent.needsPermission': 'czeka na uprawnienie',
  'chat.workStatus.subagent.askedQuestion': 'zadał pytanie',
  'chat.workStatus.subagent.done': 'Gotowe',
  'chat.workStatus.subagent.workingCount': '{count} pracuje',
  'chat.workStatus.subagent.doneCount': '{count} ukończono',
  ...
  'chat.workStatus.sections.allHidden': 'Wszystkie sekcje są ukryte',
  'chat.workStatus.sections.showAll': 'Pokaż wszystkie',
  'chat.workStatus.sections.dialogTitle': 'Sekcje statusu pracy',
  'chat.workStatus.sections.dialogDescription': 'Wybierz sekcje karty. Przeciągnij, aby zmienić kolejność.',
  ...
  'chat.workStatus.telemetry.duration': 'Czas',
  'chat.workStatus.telemetry.cost': 'Koszt',
  'chat.workStatus.usage.refresh': 'Odśwież limity',
  'chat.workStatus.compact.onBranch': 'Na {branch}',
  'chat.workStatus.compact.changes': 'Zmiany',
  'opencodeUpgrade.screen.title': 'Wymagany jest OpenCode 2.0.15',
  'opencodeUpgrade.screen.outdatedTitle': 'Zaktualizuj OpenCode',
  'opencodeUpgrade.screen.local': 'Zainstalowany jest OpenCode {version}. Ta wersja OpenChamber wymaga OpenCode v2.',
  'opencodeUpgrade.screen.outdatedLocal': 'Zainstalowany jest OpenCode {version}. Ta wersja OpenChamber wymaga OpenCode {minimum} lub nowszego.',
  'opencodeUpgrade.screen.external': 'Połączony serwer używa OpenCode {version}. Zainstaluj OpenCode v2 na tym serwerze i sprawdź ponownie.',
  'opencodeUpgrade.screen.outdatedExternal': 'Połączony serwer używa OpenCode {version}. Zaktualizuj go do OpenCode {minimum} lub nowszego i sprawdź ponownie.',
  'opencodeUpgrade.screen.bundled': 'OpenCode {version} jest dołączony do OpenChamber i jest starszy niż {minimum}. Można zainstalować zarządzaną kopię bez zmiany dołączonego pliku.',
  'opencodeUpgrade.screen.installDescription': 'OpenChamber zainstaluje OpenCode {minimum} lub nowszy w zarządzanej pamięci podręcznej i uruchomi go ponownie. Istniejące pliki OpenCode nie zostaną nadpisane.',
  'opencodeUpgrade.screen.install': 'Zainstaluj OpenCode {minimum}',
  'opencodeUpgrade.screen.update': 'Zaktualizuj do OpenCode {minimum}',
  'opencodeUpgrade.screen.installing': 'Instalowanie OpenCode…',
  'opencodeUpgrade.screen.updating': 'Aktualizowanie OpenCode…',
  'opencodeUpgrade.screen.reconnect': 'Sprawdź ponownie',
  'opencodeUpgrade.screen.reconnecting': 'Sprawdzanie…',
  'opencodeUpgrade.screen.failedTitle': 'OpenCode nie został zaktualizowany',
  'opencodeUpgrade.screen.failedGeneric': 'Instalacja nie została ukończona. OpenCode nadal jest w poprzedniej wersji.',
  'opencodeUpgrade.screen.guide': 'Instrukcja instalacji',
  'opencodeUpgrade.screen.manualGuidance': 'Automatyczna instalacja jest niedostępna w tym środowisku. Zaktualizuj OpenCode samodzielnie i sprawdź ponownie.',
} as const;
