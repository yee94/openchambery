...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.questionDelegate.awaiting': '等待宿主确认…',
  ...
  'chat.questionDelegate.stale': '当前显示上次状态，宿主同步尚待完成。',
  'chat.questionDelegate.pauseFailed': '暂停失败，宿主倒计时可能仍在运行。',
  ...
  'chat.emptyState.draftTitle': '我们在做什么？',
  'chat.emptyState.draftTitleWithProject': '我们在 {project} 中做什么？',
