...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.response.contentFilter': '提供商已拦截此响应',
  'chat.response.transport': '连接提供商失败',
  'chat.response.internal': '提供商内部错误',
  'chat.response.invalidOutput': '提供商返回了无效响应',
  'chat.response.invalidRequest': '提供商拒绝了此请求',
  'chat.response.unsupportedOperation': '提供商不支持此操作',
  'chat.response.noRoute': '模型或提供商配置不可用',
  'chat.response.providerUnknown': '提供商错误',
  'chat.response.timeout': '提供商请求超时',
  'chat.response.permissionRejected': '权限请求被拒绝',
  'chat.response.toolExecution': '工具执行失败',
  'chat.response.compactionFailed': '上下文压缩失败',
  'chat.response.compactionUnavailable': '暂无可压缩的内容',
  'chat.response.compactionInterrupted': '上下文压缩已中断',
  'chat.response.compactionCancelled': '上下文压缩已取消',
  'chat.response.stopped': '用户已停止生成',
  'chat.response.interrupted': '本次响应已中断',
  'chat.response.toolInterrupted': '工具执行已中断',
  'chat.response.resumeExhausted': '执行反复中断，已停止自动恢复',
  'chat.response.retrying': '正在自动重试',
  'chat.response.failed': '执行失败',
  'chat.response.continuingAfterRestart': '重启后继续',
  'chat.queuedMessage.inheritsSessionSelection': '执行时继承会话模型、Agent 与 variant',
  'chat.sessionRecovery.awaitingConfirmation': '服务重启，等待确认任务状态',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': '生成回答失败，请重试。',
  'chat.btw.description': '基于当前对话回答，主会话历史保持原样。',
  'chat.btw.placeholder': '在 Side Chat 提问…',
  'chat.btw.removeQuoteAria': '移除引用',
  'chat.message.conversationQuotesLabel': '对话中的引用',
  'chat.btw.sessionRequired': '请打开已有会话后再开始 Side Chat。',
  'chat.btw.plainTextRequired': '请使用纯文本提问。引用已保留在输入框中。',
  'chat.btw.pending': '正在准备回答…',
  'chat.btw.cancelled': '回答已取消，可重试提问。',
  'chat.btw.resize': '调整 Side Chat 面板大小',
  ...settingsDict,
  'chat.questionDelegate.countdown': '{seconds} 秒后交由模型决定',
  'chat.questionDelegate.awaiting': '等待确认…',
  'chat.questionDelegate.pausing': '正在暂停倒计时…',
  'chat.questionDelegate.paused': '倒计时已暂停',
  'chat.questionDelegate.disabled': '自动倒计时已关闭',
  'chat.questionDelegate.refreshStatus': '刷新状态',
  'chat.questionDelegate.submitting': '正在提交答复…',
  'chat.questionDelegate.uncertain': '提交结果尚待确认。',
  'chat.questionDelegate.settled': '问题已处理',
  'chat.questionDelegate.success': '已发送继续执行答复，模型将自行决定后续方案。',
  'chat.questionDelegate.stale': '当前显示上次状态，最新状态仍在更新。',
  'chat.questionDelegate.pauseFailed': '暂停失败，倒计时可能仍在运行。',
  'chat.questionDelegate.delegateFailed': '托管失败，请检查状态后重试。',
  'chat.questionDelegate.loadFailed': '托管状态刷新失败。',
  'chat.questionDelegate.retry': '重试',
  'chat.questionDelegate.pause': '暂停倒计时',
  'chat.questionDelegate.delegate': '立即托管',
  'common.loading': '加载中...',
  ...
  'mobile.projects.menu.label': '更多操作',
  'mobile.projects.menu.newChat': '新建对话',
  ...
  'mobile.sessions.startNewChat': '新建聊天',
  'mobile.sessions.newChat': '新建聊天',
  ...
  'mobile.sessions.stopSessionAria': '停止 {title}',
  'mobile.sessions.stopGroupAria': '停止 {label} 中所有运行中的会话',
  'mobile.sessions.stopSubsessionsAria': '停止 {title} 的运行中子会话',
  ...
  'mobile.sessions.sheet.title': '最近对话',
  'mobile.sessions.sheet.resizeAria': '调整会话面板大小',
  'mobile.changes.sheet.resizeAria': '调整更改面板大小',
  ...
  'mobile.sessions.newSessionAria': '在此项目中开始新聊天',
  ...
  'layout.rightSidebar.browser': '浏览器',
  'layout.browserProvider.noSurface': '{name} 没有实时画面。',
  'layout.browserProvider.status.connecting': '连接中…',
  'layout.browserProvider.status.reconnecting': '连接已断开，正在重新连接…',
  'layout.browserProvider.status.ready': '点击或输入即可接管',
  'layout.browserProvider.status.readyFocused': '输入即可控制画面；点击外部可离开',
  'layout.browserProvider.status.agentWorking': '智能体正在工作',
  'layout.browserProvider.status.youControl': '由你控制',
  'layout.browserProvider.status.otherControls': '由其他设备控制',
  'layout.browserProvider.handBack': '交还扩展',
  'layout.browserProvider.retry': '重试',
  'layout.browserProvider.canvasAria': '{name} 的实时画面',
  'layout.browserProvider.ended.service-stopped': '扩展的服务已停止。',
  'layout.browserProvider.ended.extension-unavailable': '扩展不可用。',
  'layout.browserProvider.ended.host-shutdown': 'OpenChamber 正在关闭。',
  ...
  'sessions.scheduledTasks.history.error.more': '无法加载更多运行。已加载的历史记录仍可查看。',
  ...
  'sessions.scheduledTasks.history.meta.trigger': '触发方式',
  'sessions.scheduledTasks.history.meta.started': '开始时间',
  'sessions.scheduledTasks.history.meta.ended': '结束时间',
  'sessions.scheduledTasks.history.meta.duration': '耗时',
  'sessions.scheduledTasks.history.ended.unavailable': '—',
  'sessions.scheduledTasks.history.duration.pending': '运行中',
  'sessions.scheduledTasks.history.duration.lessThanOneSecond': '不足 1 秒',
  'sessions.scheduledTasks.history.duration.milliseconds': '{count} 毫秒',
  ...
  'sessions.scheduledTasks.workspace.editor.emptyTitle': '选择计划',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': '从列表中选择计划，或创建新计划。',
  'sessions.scheduledTasks.workspace.confirm.discardChanges': '未保存的更改将被丢弃。是否继续？',
  'sessions.scheduledTasks.editor.panel.details': '详情',
  'sessions.scheduledTasks.editor.panel.frequency': '频率',
  'sessions.scheduledTasks.dialog.description': '服务端计划会创建新会话并发送已配置的提示词。',
  ...
  'sessions.scheduledTasks.dialog.empty.selectProject': '请选择一个项目来管理计划。',
  ...
  'sessions.scheduledTasks.editor.description': '配置一个服务端计划，用于创建新会话并发送提示词。',
  ...
  'sessions.scheduledTasks.editor.enabled.aria': '启用计划',
  'sessions.scheduledTasks.editor.enabled.label': '已启用',
  'sessions.scheduledTasks.editor.goal.label': '作为目标运行',
  'sessions.scheduledTasks.editor.goal.aria': '将此计划作为代理持续推进直至完成的目标运行',
  'sessions.scheduledTasks.editor.goal.budgetLabel': 'Tokens 预算',
  'sessions.scheduledTasks.editor.goal.budgetAria': '用 Tokens 预算限制该目标',
  ...
  'multirun.launcher.agent.info': '所有运行使用同一 Agent。默认使用你当前配置的 Agent。',
  ...
  'multirun.agentSelector.placeholder': '选择 Agent',
  ...
  'sessions.sidebar.header.actions.sessionDisplayMode': '项目展开/折叠操作',
  'sessions.sidebar.header.displayMode.label': '展开/折叠项目',
  ...
  'sessions.sidebar.bulkActions.archiveUndoFailed': '恢复 {count} 个会话失败',
  'sessions.sidebar.undo': '撤销',
  'sessions.sidebar.openSettings': '设置',
  ...
  'sessions.sidebar.session.menu.refreshTranscriptSuccess': '已同步消息',
  'sessions.sidebar.session.menu.refreshTranscriptFailed': '同步消息失败',
  ...
  'sessions.sidebar.session.export.skippedSubtaskSingle': '会话已导出，但跳过了 {count} 个无法加载的子 Agent 任务。',
  'sessions.sidebar.session.export.skippedSubtaskMany': '会话已导出，但跳过了 {count} 个无法加载的子 Agent 任务。',
  'sessions.sidebar.session.export.dialog.title': '导出 Markdown',
  'sessions.sidebar.session.export.dialog.descriptionSingle': '此会话有 {count} 个子 Agent 任务。是否包含在导出中？',
  'sessions.sidebar.session.export.dialog.descriptionMany': '此会话有 {count} 个子 Agent 任务。是否包含在导出中？',
  'sessions.sidebar.session.export.dialog.includeSubtasks': '包含子 Agent 任务',
  ...
  'gitView.changes.deferredTitle': '{count} 个变更文件',
  'gitView.changes.deferredStagedCount': '已暂存：{count}',
  'gitView.changes.deferredUnstagedCount': '未暂存：{count}',
  'gitView.changes.deferredHint': '变更集过大，为保持界面流畅，未自动渲染列表。',
  'gitView.changes.deferredLoadAction': '加载更改',
  ...
  'gitView.pr.actions.resolveFailedChecksAria': '将失败检查发送给 Agent',
  'gitView.pr.actions.savePr': '保存 PR',
  'gitView.pr.actions.savePrAria': '保存拉取请求更改',
  'gitView.pr.actions.sendCommentToAgent': '将评论发送给 Agent',
  'gitView.pr.actions.sendCommentToAgentAria': '将此评论发送给 Agent',
  'gitView.pr.actions.sendToAgent': '发送给 Agent',
  'gitView.pr.actions.shareComments': '分享评论',
  'gitView.pr.actions.shareCommentsAria': '将拉取请求评论发送给 Agent',
  ...
  'gitView.pr.toast.noActiveSessionDescription': '请先打开或创建聊天会话，再向 Agent 发送上下文。',
  ...
  'gitView.pr.toast.sendMessageFailed': '向 Agent 发送消息失败',
  ...
  'contextPanel.file.notice.turnDiffOutsideWorkspace': '项目外文件无法显示本轮改动对比，已改为打开当前文件内容。',
  ...
  'sidebarFilesTree.actions.collapseAllTitle': '全部折叠',
  'sidebarFilesTree.actions.expandAllTitle': '全部展开',
  ...
  'contextUsage.tooltip.usage': '用量：{percent}',
  ...
  'contextSidebar.empty.openSession': '打开会话以查看用量。',
  'contextSidebar.section.context': '用量',
  ...
  'contextSidebar.stats.sessionTps': '会话 TPS',
  ...
  'diffView.actions.openFilePreview': '打开此文件',
  ...
  'chat.history.loadOlderTimeout': '加载更早的消息超时，请重试。',
  ...
  'header.services.openWithCurrent': '切换实例（当前：{current}）',
  'header.services.open': '切换实例',
  'header.services.tooltip.currentInstanceWithShortcuts': '切换实例：{current}（{toggle}；下一标签 {nextTab}）',
  'header.services.tooltip.servicesWithShortcuts': '切换实例（{toggle}；下一标签 {nextTab}）',
  'header.services.title': '切换实例',
  'header.services.viewAria': '切换实例',
  'header.services.closeAria': '关闭实例切换',
  ...
  'header.actions.sessionMenu': '会话操作',
  'header.actions.sessionMenuAria': '打开会话操作菜单',
  'header.actions.sessionMenu.servicesWithInstance': '切换实例（{current}）',
  'header.actions.sessionMenu.viewUsage': '查看用量',
  ...
  'chat.goal.dialog.budgetLabel': 'Tokens 预算',
  ...
  'header.actions.toggleTerminalPanel': '终端面板',
  ...
  'helpDialog.item.cycleAgent': '循环切换 Agent（聊天输入）',
  ...
  'helpDialog.item.previousSession': '上一个会话',
  'helpDialog.item.nextSession': '下一个会话',
  ...
  'helpDialog.item.toggleRightSidebar': '切换审查面板',
  ...
  'helpDialog.item.closeContextPanelTab': '关闭上下文面板标签',
  'helpDialog.item.toggleTerminal': '切换终端',
  'helpDialog.item.newTerminalTab': '新建终端标签（终端聚焦时）',
  'helpDialog.item.openNewTerminal': '打开并新建终端',
  'helpDialog.item.previousTerminalTab': '上一个终端标签（终端聚焦时）',
  'helpDialog.item.nextTerminalTab': '下一个终端标签（终端聚焦时）',
  'helpDialog.item.toggleBottomPanel': '切换底部面板',
  'helpDialog.item.toggleTerminalExpanded': '切换终端展开状态',
  'helpDialog.item.cycleTheme': '循环切换主题（浅色 → 深色 → 跟随系统）',
  'helpDialog.item.zoomIn': '放大',
  'helpDialog.item.zoomOut': '缩小',
  ...
  'helpDialog.item.leaderOpenModel': '打开模型选择器',
  'helpDialog.item.leaderOpenAgent': '打开 Agent 选择器',
  'helpDialog.item.leaderNewSession': '创建新会话',
  'helpDialog.item.leaderCompact': '压缩当前会话',
  'chat.leaderKey.pendingAria': '前导键已激活，请按下后续按键。',
  'chat.leaderKey.action.model': '模型',
  'chat.leaderKey.action.agent': 'Agent',
  'chat.leaderKey.action.newSession': '新建',
  'chat.leaderKey.action.compact': '压缩',
  'helpDialog.keyCombiner.or': '或',
  'helpDialog.proTips.title': '使用提示：',
  'helpDialog.proTips.commandPalette': '使用命令面板（{shortcut}）可快速访问所有操作',
  'helpDialog.proTips.recentSessions': '最近 9 个聊天会显示在全局搜索中',
  ...
  'chat.fileAttachment.actions.expandImages': '展开更多图片',
  'chat.fileAttachment.actions.collapseImages': '收起图片',
  ...
  'chat.activity.compactionCompleted': '已完成压缩',
  'chat.activity.compactionFailed': '压缩失败',
  'chat.activity.expandAria': '展开处理详情',
  'chat.activity.collapseAria': '收起处理详情',
  'chat.activity.completed': '已处理 {duration}',
  'chat.activity.completedStatus': '已处理',
  'chat.activity.agentsWorking': '{count} 个 Agent 处理中',
  'chat.activity.agentsInvolved': '{count} 个 Agent 参与',
  'chat.activity.moreHidden': '还有 {count} 项...',
  'chat.emptyState.opencodeUnreachable': '无法连接 OpenCode',
  'chat.emptyState.startNewChat': '开始新的聊天',
  'chat.emptyState.draftTitle': '今天想穿越去哪？',
  'chat.emptyState.draftTitleWithProject': '今天想跟 {project} 穿越去哪？',
  'chat.emptyState.establishingConversation': '正在建立对话',
  'chat.draftPresets.explore.label': '探索代码库',
  'chat.draftPresets.catchup.label': '同步当前进度',
  'chat.draftPresets.weigh.label': '权衡方案选择',
  'chat.draftPresets.craftGoal.label': '创建 Goal',
  'chat.draftPresets.debug.label': '调试问题',
  'chat.draftPresets.review.label': '审查我的改动',
  'chat.draftStarters.add': '添加快捷入口',
  'chat.draftStarters.searchPlaceholder': '搜索命令和技能…',
  'chat.draftStarters.empty': '没有可添加的项',
  ...
  'chat.draftStarters.expand': '展开更多',
  'chat.draftStarters.collapse': '收起',
  ...
  'chat.assistantStatus.compacting': '正在压缩中',
  'chat.assistantStatus.applyingPatch': '正在应用补丁',
  'chat.assistantStatus.runningCommand': '正在运行命令',
  ...
  'chat.assistantStatus.webCodeSearch': '正在搜索网页代码',
  'chat.assistantStatus.updatingTodos': '正在更新任务',
  'chat.assistantStatus.readingTodos': '正在读取任务',
  'chat.assistantStatus.learningSkill': '正在学习技能',
  'chat.assistantStatus.askingQuestion': '正在提问',
  'chat.assistantStatus.executing': '正在执行代码',
  'chat.assistantStatus.renamingSession': '正在重命名会话',
  'chat.assistantStatus.movingSession': '正在移动会话',
  'chat.assistantStatus.usingBrowser': '正在使用浏览器',
  'chat.assistantStatus.usingTool': '正在使用 {tool}',
  'chat.assistantStatus.working': '正在工作',
  'chat.assistantStatus.processing': '正在处理',
  'chat.assistantStatus.preparing': '正在准备',
  'chat.assistantStatus.warmingUp': '正在预热',
  'chat.assistantStatus.gearsTurning': '正在运转',
  'chat.assistantStatus.computing': '正在计算',
  'chat.assistantStatus.calculating': '正在计算',
  'chat.assistantStatus.analyzing': '正在分析',
  'chat.assistantStatus.wheelsSpinning': '正在运转',
  'chat.assistantStatus.calibrating': '正在校准',
  'chat.assistantStatus.synthesizing': '正在综合分析',
  'chat.assistantStatus.connectingDots': '正在关联信息',
  'chat.assistantStatus.inspectingLogic': '正在检查逻辑',
  ...
  'chat.assistantStatus.retryingAttempt': '正在重试（第 {attempt} 次）',
  'chat.assistantStatus.retryingInAttempt': '{duration}后重试（第 {attempt} 次）',
  ...
  'chat.revertPopover.files': '将改动的文件',
  'chat.revert.toast.undo': '已撤回至 {preview}',
  'chat.revert.toast.redo': '已重做',
  'chat.revert.toast.restored': '已恢复全部消息',
  'chat.revert.toast.busy': '会话进行中，无法撤销',
  'chat.form.title': '表单',
  'chat.form.reply': '提交',
  'chat.form.cancel': '取消',
  'chat.retry.action.quota': '已达用量上限',
  'chat.retry.action.account': '已达账号限额',
  'chat.retry.action.open': '打开',
  ...
  'chat.commandAutocomplete.command.forkDescription': '基于当前对话状态创建新会话',
  'chat.commandAutocomplete.command.timelineDescription': '打开对话时间线',
  'chat.commandAutocomplete.command.modelDescription': '打开模型选择器',
  'chat.commandAutocomplete.command.compactDescription': '使用 AI 压缩会话历史以减少上下文大小',
  'chat.commandAutocomplete.command.reloadDescription': '重新加载 OpenCode 配置、Provider 和插件，无需重启',
  'chat.commandAutocomplete.command.newDescription': '在当前项目中新开会话。',
  ...
  'chat.agentMentionAutocomplete.empty': '未找到 Agent',
  'chat.fileMentionAutocomplete.searchMoreAgents': '输入以搜索更多 Agent',
  'chat.fileMentionAutocomplete.groups.skills': '技能',
  'chat.fileMentionAutocomplete.groups.agents': 'Agent',
  'chat.fileMentionAutocomplete.groups.sessions': '已加载会话',
  'chat.fileMentionAutocomplete.groups.directories': '目录',
  'chat.fileMentionAutocomplete.groups.recentFiles': '最近文件',
  'chat.fileMentionAutocomplete.groups.files': '文件',
  'chat.fileMentionAutocomplete.sessionType': 'OpenCode 会话',
  'chat.fileMentionAutocomplete.untitledSession': '未命名会话',
  'chat.fileMentionAutocomplete.empty': '未找到匹配项',
  'chat.queuedMessage.attachments': '+{count} 个文件',
  'chat.queuedMessage.empty': '（空）',
  'chat.queuedMessage.title': '队列',
  'chat.queuedMessage.edit': '编辑',
  'chat.queuedMessage.send': '引导',
  'chat.queuedMessage.queuing': '正在入队…',
  'chat.queuedMessage.queuingAria': '正在将消息加入队列',
  'chat.queuedMessage.waitingForCompaction': '等待压缩完成',
  'chat.queuedMessage.waitingForCompactionAria': '正在等待压缩完成',
  'chat.queuedMessage.sending': '引导中…',
  'chat.queuedMessage.sendingAria': '正在引导消息',
  ...
  'chat.container.readOnlySubagentPromptBanner': '无法向子 Agent 会话发送消息',
  ...
  'chat.questionCard.fromSubagent': '来自子 Agent',
  ...
  'chat.textSelection.actions.addToSideChat': '添加到 Side Chat',
  'chat.textSelection.title.addToCurrentChat': '添加到当前聊天',
  'chat.messageBody.aborted': '生成已停止',
  'chat.messageBody.actions.editing': '正在编辑…',
  'chat.messageBody.actions.editStaged': '编辑待发送',
  'chat.messageBody.actions.cancelEdit': '取消编辑',
  ...
  'chat.forkTransition.preparing': '正在准备分叉',
  'chat.forkTransition.copying': '正在复制对话（长会话可能较慢）',
  'chat.forkTransition.opening': '正在打开新会话',
  'chat.forkTransition.loading': '正在加载最近消息',
  ...
  'chat.messageBody.meta.tpsAria': '生成速率：{rate}',
  'chat.messageBody.meta.tpsTooltip': '生成速度（token/秒），不含工具调用耗时',
  ...
  'chat.chatInput.actions.modelAgentSettings': '模型与 Agent 设置',
  'chat.chatInput.actions.sendMessageAria': '发送消息',
  'chat.chatInput.actions.queueMessageAria': '将消息加入队列',
  'chat.chatInput.actions.queuingMessageAria': '进队中',
  'chat.chatInput.actions.sendingMessageAria': '发送中',
  ...
  'chat.chatInput.placeholder.chat': '@ 用于文件/Agent；/ 用于命令和技能；! 用于 shell；# 用于代码片段',
  'chat.chatInput.placeholder.chatCompact': '使用 @ / ! # 辅助',
  'chat.chatInput.placeholder.compactTap': '点击输入',
  'chat.chatInput.placeholder.selectSession': '选择或创建会话以开始聊天',
  'chat.chatInput.pastedTextReference': '已粘贴文本 #{index} · {count} 个字符',
  ...
  'chat.chatInput.toast.reloadStarted': '正在重新加载配置…',
  'chat.chatInput.toast.reloadSucceeded': '配置已重新加载',
  'chat.chatInput.toast.reloadFailed': '重新加载配置失败',
  ...
  'chat.chatInput.toast.sendStatusUnknown': '消息发送状态未知，请检查后重试。',
  'chat.chatInput.toast.queueOperationFailed': '队列操作失败。',
  'chat.chatInput.toast.queueOperationStatusUnknown': '队列操作状态未知，服务端状态将自动刷新。',
  ...
  'chat.chatInput.toast.sessionReferenceLoadFailed': '无法加载会话引用。',
  ...
  'chat.chatInput.draftPicker.newProject': '新建项目',
  ...
  'chat.chatInput.branchSwitch.title': '切换到 {branch}？',
  'chat.chatInput.branchSwitch.description': '新对话要以哪种方式打开这个分支？',
  'chat.chatInput.branchSwitch.createWorktree': '新建工作树',
  'chat.chatInput.branchSwitch.createWorktreeDescription': '保持当前目录不变，在独立工作树中继续。',
  'chat.chatInput.branchSwitch.checkoutHere': '检出到当前目录',
  'chat.chatInput.branchSwitch.checkoutHereDescription': '把当前目录切换到这个分支。',
  'chat.chatInput.branchSwitch.cancel': '取消',
  ...
  'chat.toolOutputDialog.image.zoomInAria': '放大',
  'chat.toolOutputDialog.image.zoomOutAria': '缩小',
  'chat.toolOutputDialog.image.resetZoomAria': '重置缩放',
  'chat.image.actions.sheetTitle': '图片',
  'chat.image.actions.saveImage': '保存图片',
  'chat.image.actions.saveToPhotos': '保存到相册',
  'chat.image.actions.saving': '正在保存…',
  'chat.image.actions.saveSuccess': '图片已保存',
  'chat.image.actions.saveFailed': '无法保存图片',
  ...
  'chat.activity.outputLoading': '正在加载完整输出…',
  'chat.activity.outputLoadFailed': '无法加载完整输出。',
  'chat.activity.outputRetry': '重试',
  'chat.fileAttachment.image.loading': '正在加载图片…',
  ...
  'chat.modelControls.provider': '供应商',
  ...
  'chat.modelControls.selectAgent': '选择 Agent',
  'chat.modelControls.costPerMillion': '成本',
  'chat.modelControls.costInput': '输入',
  'chat.modelControls.costOutput': '输出',
  'chat.modelControls.metadataUnavailable': '模型元数据不可用。',
  'chat.modelControls.addNewProvider': '添加新提供商',
  'chat.modelControls.noAgentSelected': '未选择 Agent。',
  'chat.modelControls.resetToDefault': '重置为默认',
  'chat.modelControls.searchModels': '搜索模型',
  'chat.modelControls.searchAgents': '搜索 Agent',
  ...
  'chat.modelControls.keyboardHintSwitchAgent': '{shortcut} 切换 Agent',
  'chat.modelControls.keyboardHintSwitchAgentLabel': '切换 Agent',
  ...
  'chat.usedGroup.running': '运行中',
  'chat.usedGroup.used': '运行了',
  'chat.usedGroup.expandAria': '展开已运行的工具',
  'chat.usedGroup.collapseAria': '折叠已运行的工具',
  'chat.usedGroup.editSingle': '{count} 次编辑',
  'chat.usedGroup.editPlural': '{count} 次编辑',
  'chat.usedGroup.commandSingle': '{count} 次命令',
  'chat.usedGroup.commandPlural': '{count} 次命令',
  'chat.usedGroup.otherSingle': '{count} 次调用',
  'chat.usedGroup.otherPlural': '{count} 次调用',
  'chat.skillGroup.expandAria': '展开已加载的技能',
  'chat.skillGroup.collapseAria': '折叠已加载的技能',
  'chat.skillGroup.summaryOverflow': '{names} 等{count}个',
  'chat.tools.display.read': '读取文件',
  ...
  'chat.tools.display.todowrite': '更新待办',
  'chat.tools.display.todoread': '读取待办',
  'chat.tools.display.skill': '加载技能',
  'chat.tools.display.question': '提问',
  'chat.tools.display.lsp': 'LSP',
  'chat.tools.display.structuredoutput': '结构化输出',
  'chat.tools.display.execute': '执行代码',
  'chat.tools.display.session_rename': '重命名会话',
  'chat.tools.display.session_move': '移动会话',
  'chat.tools.display.browser': '浏览器',
  ...
  'chat.messageBody.subagent.completed': '已完成',
  'chat.messageBody.subagent.error': '失败',
  'chat.messageBody.subagent.cancelled': '已取消',
  'chat.messageBody.subagent.completedDescription': '后台子代理已完成',
  ...
  'chat.sessionBackground.moveRunning': '转到后台',
  'chat.sessionBackground.moving': '转移中…',
  'chat.sessionBackground.moveFailed': '无法将工作转到后台',
  'chat.sessionBackground.tasksRunning': '{count} 个后台任务运行中',
  ...
  'commandPalette.error.sessions': '聊天搜索未能加载。仍会显示可用结果。',
  ...
  'commandPalette.item.newTerminalTab': '新建终端标签',
  ...
  'desktopHostSwitcher.transition.title': '正在切换实例…',
  'desktopHostSwitcher.transition.description': '正在加载所选实例的数据。',
  ...
  'desktopHostSwitcher.sshError.openRemoteSettings': '打开远程实例设置',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.title': '远程主机没有 Node.js 22+',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance': '请在远程安装 Node.js 22 或 24 LTS（nvm、fnm 或系统包）。登录环境只有 Node 18/20 不够，除非常见路径里还有 22+ 可执行文件。',
  'desktopHostSwitcher.sshError.packageManagerMissing.title': '远程主机没有 npm 或 bun',
  'desktopHostSwitcher.sshError.packageManagerMissing.guidance': '请在远程安装 npm（随 Node.js 提供）或 bun，然后重试。安装 Host CLI 需要其中之一。',
  'desktopHostSwitcher.sshError.nativeBinding.title': '远程数据库模块编译失败',
  'desktopHostSwitcher.sshError.nativeBinding.guidance': '请在远程安装 Node.js 22 或 24 LTS。Node 23 这类奇数版本通常没有预编译包，需要 python3、gcc 和 make。装好 LTS 后重新连接。',
  'desktopHostSwitcher.sshError.openchamberCliMissing.title': '远程找不到 OpenChamber 命令',
  'desktopHostSwitcher.sshError.openchamberCliMissing.guidance': '安装已结束，但 openchamber --version 没有给出可用版本。请确认 ~/.bun/bin 或 npm 全局 bin 在 PATH 里，然后重试。也可以先 SSH 上去运行 openchamber --version。',
  'desktopHostSwitcher.sshError.openchamberRegistry.title': '无法从远程下载 OpenChamber',
  'desktopHostSwitcher.sshError.openchamberRegistry.guidance': '远程访问不了 npm 源或当前镜像。请检查网络、代理和 npm registry，然后重试。也可以用 Node 22/24 和 npm 自行安装 @openchambery/web。',
  'desktopHostSwitcher.sshError.openchamberInstall.title': '无法在远程安装 OpenChamber',
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'bun 或 npm 安装 @openchambery/web 失败。请查看该主机 SSH 日志里的包管理器输出，然后重试。也可以用 Node 22/24 自行安装 @openchambery/web。',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.title': '远程 OpenChamber CLI 版本过旧',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance': '远程 CLI 不认识当前桌面端发送的参数（例如 --relay-host）。请把远程的 @openchambery/web 升级到支持 SSH relay host 的版本，然后重试。',
  'desktopHostSwitcher.sshError.opencodeInstall.title': '无法在远程安装 OpenCode CLI',
  'desktopHostSwitcher.sshError.opencodeInstall.guidance': '请检查远程网络和包管理器，然后重试。也可以在远程手动安装 OpenCode CLI。',
  'desktopHostSwitcher.sshError.serverStart.title': '远程 OpenChamber 服务没有启动',
  'desktopHostSwitcher.sshError.serverStart.guidance': 'SSH 已连通，但 Host 进程没有变为可访问。确认远程是 Node 22/24，且所选端口空闲，然后重试。',
  'desktopHostSwitcher.sshError.sshAuth.title': 'SSH 认证失败',
  'desktopHostSwitcher.sshError.sshAuth.guidance': '请在「设置 → 远程实例」中检查密钥、密码和目标地址。SSH 登录成功后才能完成初始化。',
  'desktopHostSwitcher.sshError.sshUnreachable.title': '无法连接到 SSH 主机',
  'desktopHostSwitcher.sshError.sshUnreachable.guidance': '请检查主机名、端口和网络（如需 VPN 或跳板机请先连上），然后重试。',
  'desktopHostSwitcher.sshError.timeout.title': 'SSH 连接超时',
  'desktopHostSwitcher.sshError.timeout.guidance': '远程没有在时限内完成初始化。请检查网络，并确认远程已安装 Node 22/24，然后重试。',
  'desktopHostSwitcher.sshError.unknown.title': '远程实例启动失败',
  'desktopHostSwitcher.sshError.unknown.guidance': '远程初始化失败。请看下方具体错误，或到「设置 → 远程实例」查看该主机的 SSH 日志。',
  ...
  'miniChat.header.defaultAgent': '默认 Agent',
  ...
  'updateDialog.status.otaBundleReused': '已使用之前下载的更新包，无需重新下载。',
  ...
  'updateDialog.actions.applyOtaNow': '一键更新',
  'updateDialog.actions.later': '稍后',
  ...
  'mobileUpdate.ota.toast.available.title': '发现新版本',
  'mobileUpdate.ota.toast.available.description': '版本 {version} 已可安装。',
  'mobileUpdate.ota.toast.actions.update': '更新',
  'mobileUpdate.ota.toast.actions.dismiss': '忽略',
  ...
  'common.relative.minutesAgoCompact': '{count} 分钟前',
  'common.relative.hoursAgoCompact': '{count} 小时前',
  'common.relative.daysAgoCompact': '{count} 天前',
  'common.relative.weeksAgoCompact': '{count} 周前',
  'common.relative.monthsAgoCompact': '{count} 个月前',
  ...
  'header.workStatusPanel.toggleAria': '切换工作状态',
  ...
  'chat.workStatus.section.telemetry': '本轮统计',
  'chat.workStatus.section.subagents': '子智能体',
  'chat.workStatus.section.mcp': 'MCP',
  'chat.workStatus.section.contextSources': '上下文来源',
  'chat.workStatus.context.label': '上下文',
  'chat.workStatus.cost.breakdown': '会话 {session} · 子代理 {subagents}',
  'chat.workStatus.git.changedFileSingle': '{count} 个文件已更改',
  'chat.workStatus.git.changedFilePlural': '{count} 个文件已更改',
  ...
  'chat.workStatus.attention.cherryPick': '正在拣选',
  ...
  'chat.workStatus.action.copyBranch': '复制分支名',
  'chat.workStatus.action.openChanges': '打开变更',
  'chat.workStatus.action.openPr': '打开拉取请求',
  'chat.workStatus.action.openSubagent': '打开 {name}',
  'chat.workStatus.subagent.untitled': '子代理',
  'chat.workStatus.subagent.working': '工作中',
  'chat.workStatus.subagent.needsPermission': '等待权限',
  'chat.workStatus.subagent.askedQuestion': '提出了问题',
  'chat.workStatus.subagent.done': '已完成',
  'chat.workStatus.subagent.workingCount': '{count} 个工作中',
  'chat.workStatus.subagent.doneCount': '{count} 个已完成',
  ...
  'chat.workStatus.sections.open': '选择分区',
  'chat.workStatus.sections.allHidden': '所有分区都已隐藏',
  'chat.workStatus.sections.showAll': '全部显示',
  'chat.workStatus.sections.dialogTitle': '工作状态分区',
  'chat.workStatus.sections.dialogDescription': '选择卡片显示哪些分区。拖拽可调整顺序。',
  'chat.workStatus.breakdown.skills': '技能',
  'chat.workStatus.breakdown.mcp': 'MCP 服务器',
  'chat.workStatus.telemetry.tokens': 'Token',
  'chat.workStatus.telemetry.duration': '耗时',
  'chat.workStatus.telemetry.cost': '花费',
  'chat.workStatus.usage.refresh': '刷新额度',
  'chat.workStatus.compact.onBranch': '在 {branch}',
  'chat.workStatus.compact.changes': '变更',
  'opencodeUpgrade.screen.title': '需要 OpenCode 2.0.15',
  'opencodeUpgrade.screen.outdatedTitle': '更新 OpenCode',
  'opencodeUpgrade.screen.local': '当前安装的是 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode v2。',
  'opencodeUpgrade.screen.outdatedLocal': '当前安装的是 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode {minimum} 或更新版本。',
  'opencodeUpgrade.screen.external': '已连接的服务器正在运行 OpenCode {version}。请在该服务器上安装 OpenCode v2，然后重新检查。',
  'opencodeUpgrade.screen.outdatedExternal': '已连接的服务器正在运行 OpenCode {version}。请将其更新到 OpenCode {minimum} 或更新版本，然后重新检查。',
  'opencodeUpgrade.screen.bundled': '随 OpenChamber 附带的 OpenCode {version} 低于 {minimum}。可以安装一份托管副本，而不改动附带的二进制文件。',
  'opencodeUpgrade.screen.installDescription': 'OpenChamber 会把 OpenCode {minimum} 或更新版本安装到托管缓存并重启。不会覆盖你现有的 OpenCode 文件。',
  'opencodeUpgrade.screen.install': '安装 OpenCode {minimum}',
  'opencodeUpgrade.screen.update': '更新到 OpenCode {minimum}',
  'opencodeUpgrade.screen.installing': '正在安装 OpenCode…',
  'opencodeUpgrade.screen.updating': '正在更新 OpenCode…',
  'opencodeUpgrade.screen.reconnect': '重新检查',
  'opencodeUpgrade.screen.reconnecting': '正在检查…',
  'opencodeUpgrade.screen.failedTitle': 'OpenCode 并未升级',
  'opencodeUpgrade.screen.failedGeneric': '安装没有完成。OpenCode 仍是之前的版本。',
  'opencodeUpgrade.screen.guide': '安装指南',
  'opencodeUpgrade.screen.manualGuidance': '此运行时无法自动安装。请自行更新 OpenCode，然后重新检查。',
};
