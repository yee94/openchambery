...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.assistantStatus.switchingToPlanning': '正在切换到规划',
  'chat.assistantStatus.switchingToBuilding': '正在切换到构建',
  ...
  'chat.tools.display.plan_enter': '计划模式',
  'chat.tools.display.plan_exit': '构建模式',
