...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.assistantStatus.switchingToPlanning': '계획으로 전환 중',
  'chat.assistantStatus.switchingToBuilding': '빌드로 전환 중',
  ...
  'chat.tools.display.plan_enter': '계획 모드',
  'chat.tools.display.plan_exit': '빌드 모드',
