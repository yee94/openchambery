...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.response.contentFilter': '공급자가 응답을 차단했습니다',
  'chat.response.transport': '공급자 연결에 실패했습니다',
  'chat.response.internal': '공급자 내부 오류',
  'chat.response.invalidOutput': '공급자가 잘못된 응답을 반환했습니다',
  'chat.response.invalidRequest': '공급자가 요청을 거부했습니다',
  'chat.response.unsupportedOperation': '공급자가 이 작업을 지원하지 않습니다',
  'chat.response.noRoute': '모델 또는 공급자 구성을 사용할 수 없습니다',
  'chat.response.providerUnknown': '공급자 오류',
  'chat.response.timeout': '공급자 요청 시간이 초과되었습니다',
  'chat.response.permissionRejected': '권한이 거부되었습니다',
  'chat.response.toolExecution': '도구 실행에 실패했습니다',
  'chat.response.compactionFailed': '컨텍스트 압축에 실패했습니다',
  'chat.response.compactionUnavailable': '아직 압축할 내용이 없습니다',
  'chat.response.compactionInterrupted': '컨텍스트 압축이 중단되었습니다',
  'chat.response.compactionCancelled': '컨텍스트 압축이 취소되었습니다',
  'chat.response.stopped': '사용자가 생성을 중지했습니다',
  'chat.response.interrupted': '응답이 중단되었습니다',
  'chat.response.toolInterrupted': '도구 실행이 중단되었습니다',
  'chat.response.resumeExhausted': '반복된 중단으로 자동 복구가 중지되었습니다',
  'chat.response.retrying': '자동 재시도 중',
  'chat.response.failed': '실행에 실패했습니다',
  'chat.response.continuingAfterRestart': '재시작 후 계속',
  'chat.queuedMessage.inheritsSessionSelection': '실행 시 세션의 모델, 에이전트 및 변형 설정을 상속합니다.',
  'chat.sessionRecovery.awaitingConfirmation': '서비스가 재시작되었습니다. 작업 상태 확인을 기다리고 있습니다.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': '답변 생성에 실패했습니다. 다시 시도하세요.',
  'chat.btw.description': '대화 기록을 그대로 유지하며 현재 대화에 관해 질문합니다.',
  'chat.btw.placeholder': 'Side Chat에서 질문…',
  'chat.btw.removeQuoteAria': '인용 삭제',
  'chat.message.conversationQuotesLabel': '대화에서 인용',
  'chat.btw.sessionRequired': '기존 대화를 연 후 Side Chat을 시작하세요.',
  'chat.btw.plainTextRequired': '일반 텍스트로 질문하세요. 참조는 입력란에 유지됩니다.',
  'chat.btw.pending': '답변 준비 중…',
  'chat.btw.cancelled': '답변이 취소되었습니다. 다시 시도하여 질문하세요.',
  'chat.btw.resize': 'Side Chat 패널 크기 조절',
  ...settingsDict,
  'chat.questionDelegate.countdown': '{seconds}초 후 모델이 결정합니다',
  'chat.questionDelegate.awaiting': '확인 대기 중…',
  'chat.questionDelegate.pausing': '카운트다운 일시 정지 중…',
  'chat.questionDelegate.paused': '카운트다운이 일시 정지되었습니다',
  'chat.questionDelegate.disabled': '자동 카운트다운이 꺼져 있습니다',
  'chat.questionDelegate.refreshStatus': '상태 새로 고침',
  'chat.questionDelegate.submitting': '답변 제출 중…',
  'chat.questionDelegate.uncertain': '제출 결과가 불확실합니다. 확인을 기다리고 있습니다.',
  'chat.questionDelegate.settled': '질문이 처리되었습니다',
  'chat.questionDelegate.success': '계속 진행하라는 답변을 보냈습니다. 모델이 다음 방안을 결정합니다.',
  'chat.questionDelegate.stale': '마지막 상태를 표시합니다. 최신 상태 업데이트가 진행 중입니다.',
  'chat.questionDelegate.pauseFailed': '일시 정지에 실패했습니다. 카운트다운이 계속될 수 있습니다.',
  'chat.questionDelegate.delegateFailed': '위임에 실패했습니다. 상태를 확인하고 다시 시도하세요.',
  'chat.questionDelegate.loadFailed': '위임 상태를 새로 고치지 못했습니다.',
  'chat.questionDelegate.retry': '다시 시도',
  'chat.questionDelegate.pause': '카운트다운 일시 정지',
  'chat.questionDelegate.delegate': '지금 위임',
  'common.loading': '로딩 중...',
  ...
  'mobile.sessions.mainWorkspace': '메인 워크스페이스',
  'mobile.sessions.section.pinned': '고정 / 진행 중',
  'mobile.sessions.searchAria': '세션 검색',
  'mobile.sessions.section.otherProjects': '프로젝트 전환',
  'mobile.sessions.section.projects': '프로젝트',
  'mobile.projects.menu.label': '더보기',
  'mobile.projects.menu.newChat': '새 채팅',
  'mobile.projects.menu.newProject': '새 프로젝트',
  'mobile.projects.menu.scanQr': 'QR 코드 스캔',
  'mobile.projects.menu.switchInstance': '인스턴스 전환',
  ...
  'mobile.sessions.startNewChat': '새 채팅',
  ...
  'mobile.projects.closeConfirmMessage': '“{title}”을(를) 닫을까요? 프로젝트 목록에서 제거되며 세션은 디스크에 남습니다.',
  ...
  'mobile.sessions.stopSessionAria': '{title} 중지',
  'mobile.sessions.stopGroupAria': '{label}의 실행 중인 모든 세션 중지',
  'mobile.sessions.stopSubsessionsAria': '{title}의 실행 중인 하위 세션 중지',
  ...
  'mobile.sessions.newSessionAria': '이 프로젝트에서 새 채팅 시작',
  ...
  'mobile.files.html.fullscreenAria': '전체 화면 미리보기 열기',
  'mobile.files.html.exitFullscreenAria': '전체 화면 종료',
  'mobile.files.html.viewSourceAria': '소스 보기',
  'mobile.files.html.viewPreviewAria': '미리보기 보기',
  ...
  'layout.rightSidebar.browser': '브라우저',
  'layout.browserProvider.noSurface': '{name}에는 실시간 화면이 없습니다.',
  'layout.browserProvider.status.connecting': '연결 중…',
  'layout.browserProvider.status.reconnecting': '연결이 끊겼습니다. 다시 연결하는 중…',
  'layout.browserProvider.status.ready': '클릭하거나 입력하여 제어권을 가져오세요',
  'layout.browserProvider.status.readyFocused': '입력하여 화면을 제어하고, 바깥을 클릭하면 벗어납니다',
  'layout.browserProvider.status.agentWorking': '에이전트가 작업 중',
  'layout.browserProvider.status.youControl': '내가 제어 중',
  'layout.browserProvider.status.otherControls': '다른 기기가 제어 중',
  'layout.browserProvider.handBack': '확장에 돌려주기',
  'layout.browserProvider.retry': '다시 시도',
  'layout.browserProvider.canvasAria': '{name}의 실시간 화면',
  'layout.browserProvider.ended.service-stopped': '확장의 서비스가 중지되었습니다.',
  'layout.browserProvider.ended.extension-unavailable': '확장을 사용할 수 없습니다.',
  'layout.browserProvider.ended.host-shutdown': 'OpenChamber가 종료되고 있습니다.',
  ...
  'sessions.scheduledTasks.dialog.actions.create': '만들기',
  'sessions.scheduledTasks.dialog.actions.moreAria': '{taskName} 추가 작업',
  'sessions.scheduledTasks.dialog.actions.delete': '삭제',
  'sessions.scheduledTasks.dialog.actions.pause': '일시 중지',
  'sessions.scheduledTasks.dialog.actions.resume': '계속',
  'sessions.scheduledTasks.workspace.filters.all': '전체',
  'sessions.scheduledTasks.workspace.filters.active': '활성',
  'sessions.scheduledTasks.workspace.filters.paused': '일시 중지',
  'sessions.scheduledTasks.workspace.views.aria': '예약 작업 보기',
  'sessions.scheduledTasks.workspace.views.tasks': '작업',
  'sessions.scheduledTasks.workspace.views.history': '기록',
  'sessions.scheduledTasks.history.loading': '실행 기록 불러오는 중…',
  'sessions.scheduledTasks.history.error.title': '실행 기록을 불러올 수 없습니다',
  'sessions.scheduledTasks.history.error.description': 'OpenChamber가 기록된 실행을 불러오지 못했습니다.',
  'sessions.scheduledTasks.history.error.more': '실행 기록을 더 불러오지 못했습니다. 이미 불러온 기록은 계속 사용할 수 있습니다.',
  'sessions.scheduledTasks.history.retry': '다시 시도',
  'sessions.scheduledTasks.history.empty.title': '아직 실행 기록이 없습니다',
  'sessions.scheduledTasks.history.empty.description': '예약 실행과 수동 실행이 여기에 표시됩니다.',
  'sessions.scheduledTasks.history.trigger.scheduled': '예약',
  'sessions.scheduledTasks.history.trigger.manual': '수동',
  'sessions.scheduledTasks.history.meta.trigger': '트리거',
  'sessions.scheduledTasks.history.meta.started': '시작',
  'sessions.scheduledTasks.history.meta.ended': '종료',
  'sessions.scheduledTasks.history.meta.duration': '소요 시간',
  'sessions.scheduledTasks.history.ended.unavailable': '—',
  'sessions.scheduledTasks.history.duration.pending': '진행 중',
  'sessions.scheduledTasks.history.duration.lessThanOneSecond': '1초 미만',
  'sessions.scheduledTasks.history.duration.milliseconds': '{count}밀리초',
  'sessions.scheduledTasks.history.duration.seconds': '{count}초',
  'sessions.scheduledTasks.history.duration.minutesSeconds': '{minutes}분 {seconds}초',
  'sessions.scheduledTasks.history.duration.minutes': '{count}분',
  ...
  'sessions.scheduledTasks.history.loadingMore': '더 불러오는 중…',
  'sessions.scheduledTasks.history.loadMore': '더 불러오기',
  'sessions.scheduledTasks.workspace.search.placeholder': '작업 검색…',
  'sessions.scheduledTasks.workspace.search.noResults': '검색과 일치하는 작업이 없습니다.',
  'sessions.scheduledTasks.workspace.partialLoadWarning': '일부 프로젝트의 예약 작업을 불러오지 못했습니다. 불러온 작업은 계속 사용할 수 있습니다.',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': '작업 선택',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': '목록에서 작업을 선택하거나 새 작업을 만드세요.',
  'sessions.scheduledTasks.workspace.confirm.discardChanges': '저장하지 않은 변경 사항이 삭제됩니다. 계속할까요?',
  'sessions.scheduledTasks.editor.panel.details': '세부 정보',
  'sessions.scheduledTasks.editor.panel.frequency': '빈도',
  ...
  'sessions.sidebar.header.actions.sessionDisplayMode': '프로젝트 펼치기/접기 작업',
  'sessions.sidebar.header.displayMode.label': '프로젝트 펼치기/접기',
  ...
  'sessions.sidebar.bulkActions.archiveUndoFailed': '세션 {count}개 복원 실패',
  'sessions.sidebar.undo': '실행 취소',
  'sessions.sidebar.openSettings': '설정',
  ...
  'sessions.sidebar.session.menu.refreshTranscript': '메시지 동기화',
  'sessions.sidebar.session.menu.refreshTranscriptSuccess': '메시지를 동기화했습니다',
  'sessions.sidebar.session.menu.refreshTranscriptFailed': '메시지를 동기화하지 못했습니다',
  ...
  'sessions.sidebar.session.actions.pinned': '고정',
  'sessions.sidebar.session.status.permissionRequired': '권한 필요',
  'sessions.sidebar.session.status.questionRequired': '질문 응답 필요',
  ...
  'sessions.sidebar.session.archive.undoFailed': '보관 실행 취소 실패',
  ...
  'gitView.changes.deferredTitle': '변경된 파일 {count}개',
  'gitView.changes.deferredStagedCount': '스테이징됨: {count}',
  'gitView.changes.deferredUnstagedCount': '미스테이징: {count}',
  'gitView.changes.deferredHint': '변경 사항이 많아 앱 반응성을 유지하기 위해 목록을 자동으로 렌더링하지 않습니다.',
  'gitView.changes.deferredLoadAction': '변경사항 불러오기',
  ...
  'contextPanel.file.notice.turnDiffOutsideWorkspace': '프로젝트 밖 파일은 턴 변경 diff를 볼 수 없어 현재 파일 내용을 엽니다.',
  ...
  'sidebarFilesTree.actions.collapseAllTitle': '모두 접기',
  'sidebarFilesTree.actions.expandAllTitle': '모두 펼치기',
  ...
  'contextUsage.tooltip.usage': '사용량: {percent}',
  ...
  'contextSidebar.empty.openSession': '세션을 열어 사용량을 확인하세요.',
  'contextSidebar.section.context': '사용량',
  ...
  'contextSidebar.stats.sessionTps': '세션 TPS',
  ...
  'diffView.actions.openFilePreview': '이 파일 열기',
  ...
  'chat.history.loadingMore': '더 불러오는 중…',
  'chat.history.loadOlderFailed': '이전 메시지를 불러오지 못했습니다. 다시 시도하세요.',
  'chat.history.loadOlderTimeout': '이전 메시지 불러오기가 시간 초과되었습니다. 다시 시도하세요.',
  ...
  'header.services.openWithCurrent': '인스턴스 전환(현재: {current})',
  'header.services.open': '인스턴스 전환',
  'header.services.tooltip.currentInstanceWithShortcuts': '인스턴스 전환: {current} ({toggle}; 다음 탭 {nextTab})',
  'header.services.tooltip.servicesWithShortcuts': '인스턴스 전환 ({toggle}; 다음 탭 {nextTab})',
  'header.services.title': '인스턴스 전환',
  'header.services.viewAria': '인스턴스 전환',
  'header.services.closeAria': '인스턴스 전환 닫기',
  ...
  'header.actions.sessionMenu': '세션 작업',
  'header.actions.sessionMenuAria': '세션 작업 메뉴 열기',
  'header.actions.sessionMenu.servicesWithInstance': '인스턴스 전환 ({current})',
  'header.actions.sessionMenu.viewUsage': '사용량 보기',
  ...
  'helpDialog.item.previousSession': '이전 세션',
  'helpDialog.item.nextSession': '다음 세션',
  ...
  'helpDialog.item.toggleRightSidebar': '리뷰 패널 전환',
  ...
  'helpDialog.item.closeContextPanelTab': '컨텍스트 패널 탭 닫기',
  'helpDialog.item.toggleTerminal': '터미널 전환',
  'helpDialog.item.newTerminalTab': '새 터미널 탭 (터미널 포커스 시)',
  'helpDialog.item.openNewTerminal': '새 터미널 열기',
  'helpDialog.item.previousTerminalTab': '이전 터미널 탭 (터미널 포커스 시)',
  'helpDialog.item.nextTerminalTab': '다음 터미널 탭 (터미널 포커스 시)',
  'helpDialog.item.toggleBottomPanel': '하단 패널 전환',
  'helpDialog.item.toggleTerminalExpanded': '터미널 펼치기/접기',
  'helpDialog.item.cycleTheme': '테마 순환(라이트 → 다크 → 시스템)',
  'helpDialog.item.zoomIn': '확대',
  'helpDialog.item.zoomOut': '축소',
  ...
  'helpDialog.item.leaderOpenModel': '모델 선택기 열기',
  'helpDialog.item.leaderOpenAgent': '에이전트 선택기 열기',
  'helpDialog.item.leaderNewSession': '새 세션 만들기',
  'helpDialog.item.leaderCompact': '현재 세션 압축',
  'chat.leaderKey.pendingAria': '리더 키가 활성화되었습니다. 다음 키를 누르세요.',
  'chat.leaderKey.action.model': '모델',
  'chat.leaderKey.action.agent': '에이전트',
  'chat.leaderKey.action.newSession': '새 세션',
  'chat.leaderKey.action.compact': '압축',
  ...
  'helpDialog.proTips.recentSessions': '최근 채팅 9개가 전역 검색에 표시됩니다',
  ...
  'chat.fileAttachment.actions.expandImages': '이미지 더 보기',
  'chat.fileAttachment.actions.collapseImages': '이미지 접기',
  ...
  'chat.activity.title': '처리 세부 정보',
  'chat.activity.active': '처리 중',
  'chat.activity.compacting': '압축 중',
  'chat.activity.compactionCompleted': '압축 완료',
  'chat.activity.compactionFailed': '압축 실패',
  'chat.activity.expandAria': '처리 세부 정보 펼치기',
  ...
  'chat.activity.moreHidden': '+{count}개 더...',
  ...
  'chat.emptyState.establishingConversation': '대화를 시작하는 중',
  ...
  'chat.draftStarters.remove': '제거',
  'chat.draftStarters.expand': '더 보기',
  'chat.draftStarters.collapse': '접기',
  ...
  'chat.assistantStatus.updatingTodos': '작업 업데이트 중',
  'chat.assistantStatus.readingTodos': '작업 읽는 중',
  'chat.assistantStatus.learningSkill': '스킬 학습 중',
  'chat.assistantStatus.askingQuestion': '질문 중',
  'chat.assistantStatus.executing': '코드 실행 중',
  'chat.assistantStatus.renamingSession': '세션 이름 변경 중',
  'chat.assistantStatus.movingSession': '세션 이동 중',
  'chat.assistantStatus.usingBrowser': '브라우저 사용 중',
  'chat.assistantStatus.usingTool': '{tool} 사용 중',
  'chat.assistantStatus.working': '작업 중',
  'chat.assistantStatus.processing': '처리 중',
  'chat.assistantStatus.preparing': '준비 중',
  'chat.assistantStatus.warmingUp': '준비 중',
  'chat.assistantStatus.gearsTurning': '처리 중',
  'chat.assistantStatus.computing': '계산 중',
  'chat.assistantStatus.calculating': '계산 중',
  'chat.assistantStatus.analyzing': '분석 중',
  'chat.assistantStatus.wheelsSpinning': '처리 중',
  'chat.assistantStatus.calibrating': '조정 중',
  'chat.assistantStatus.synthesizing': '종합 중',
  'chat.assistantStatus.connectingDots': '연결 중',
  'chat.assistantStatus.inspectingLogic': '로직 검사 중',
  ...
  'chat.assistantStatus.retryingAttempt': '재시도 중 ({attempt}번째 시도)',
  'chat.assistantStatus.retryingInAttempt': '{duration}에 재시도 ({attempt}번째 시도)',
  ...
  'chat.revertPopover.files': '변경될 파일',
  'chat.revert.toast.undo': '{preview}(으)로 되돌림',
  'chat.revert.toast.redo': '다시 실행',
  'chat.revert.toast.restored': '모든 메시지 복원됨',
  'chat.revert.toast.busy': '세션이 실행 중일 때는 되돌릴 수 없습니다',
  'chat.form.title': '양식',
  'chat.form.reply': '제출',
  'chat.form.cancel': '취소',
  'chat.retry.action.quota': '사용량 한도에 도달했습니다',
  'chat.retry.action.account': '계정 한도에 도달했습니다',
  'chat.retry.action.open': '열기',
  ...
  'chat.commandAutocomplete.command.forkDescription': '현재 대화 상태에서 새 세션 분기',
  'chat.commandAutocomplete.command.timelineDescription': '대화 타임라인 열기',
  'chat.commandAutocomplete.command.modelDescription': '모델 선택기 열기',
  'chat.commandAutocomplete.command.compactDescription': 'AI로 세션 기록을 압축해 컨텍스트 크기를 줄입니다',
  'chat.commandAutocomplete.command.reloadDescription': '재시작 없이 OpenCode 설정, 공급자, 플러그인을 다시 불러옵니다',
  ...
  'chat.commandAutocomplete.command.newDescription': '현재 프로젝트에서 새 세션을 시작합니다.',
  ...
  'chat.fileMentionAutocomplete.groups.skills': '스킬',
  'chat.fileMentionAutocomplete.groups.agents': '에이전트',
  'chat.fileMentionAutocomplete.groups.sessions': '불러온 세션',
  'chat.fileMentionAutocomplete.groups.directories': '디렉터리',
  'chat.fileMentionAutocomplete.groups.recentFiles': '최근 파일',
  'chat.fileMentionAutocomplete.groups.files': '파일',
  'chat.fileMentionAutocomplete.sessionType': 'OpenCode 세션',
  'chat.fileMentionAutocomplete.untitledSession': '제목 없는 세션',
  'chat.fileMentionAutocomplete.empty': '일치하는 항목 없음',
  'chat.queuedMessage.attachments': '+{count} 파일(s)',
  'chat.queuedMessage.empty': '(비어 있음)',
  'chat.queuedMessage.title': '대기열',
  'chat.queuedMessage.edit': '편집',
  'chat.queuedMessage.send': '유도',
  'chat.queuedMessage.queuing': '대기열에 추가 중…',
  'chat.queuedMessage.queuingAria': '메시지를 대기열에 추가하는 중',
  'chat.queuedMessage.waitingForCompaction': '압축 대기 중',
  'chat.queuedMessage.waitingForCompactionAria': '압축이 끝날 때까지 대기 중',
  'chat.queuedMessage.sending': '유도 중…',
  'chat.queuedMessage.sendingAria': '메시지 유도 중',
  ...
  'chat.textSelection.actions.addToSideChat': '사이드 채팅에 추가',
  'chat.textSelection.title.addToCurrentChat': '현재 채팅에 추가',
  'chat.messageBody.aborted': '생성이 중지됨',
  'chat.messageBody.actions.editing': '편집 중…',
  'chat.messageBody.actions.editStaged': '편집 전송 대기',
  'chat.messageBody.actions.cancelEdit': '편집 취소',
  ...
  'chat.messageBody.meta.tpsAria': '생성 속도: {rate}',
  'chat.messageBody.meta.tpsTooltip': '생성 속도(token/초). 도구 호출 시간은 제외됩니다',
  ...
  'chat.forkTransition.preparing': '포크를 준비하는 중',
  'chat.forkTransition.copying': '대화를 복사하는 중 (긴 세션은 시간이 걸릴 수 있음)',
  'chat.forkTransition.opening': '새 세션을 여는 중',
  'chat.forkTransition.loading': '최근 메시지를 불러오는 중',
  ...
  'chat.chatInput.actions.attachCancel': '취소',
  ...
  'chat.chatInput.actions.queuingMessageAria': '대기열 추가 중…',
  'chat.chatInput.actions.sendingMessageAria': '전송 중…',
  ...
  'chat.chatInput.toast.reloadStarted': '설정을 다시 불러오는 중…',
  'chat.chatInput.toast.reloadSucceeded': '설정을 다시 불러왔습니다',
  'chat.chatInput.toast.reloadFailed': '설정을 다시 불러오지 못했습니다',
  ...
  'chat.chatInput.draftPicker.newProject': '새 프로젝트',
  ...
  'chat.chatInput.branchSwitch.title': '{branch}(으)로 전환할까요?',
  'chat.chatInput.branchSwitch.description': '새 대화에서 이 브랜치를 어떻게 열까요?',
  'chat.chatInput.branchSwitch.createWorktree': '워크트리 만들기',
  'chat.chatInput.branchSwitch.createWorktreeDescription': '현재 디렉터리는 그대로 두고 독립된 워크트리에서 작업합니다.',
  'chat.chatInput.branchSwitch.checkoutHere': '여기에서 체크아웃',
  'chat.chatInput.branchSwitch.checkoutHereDescription': '현재 디렉터리를 이 브랜치로 전환합니다.',
  'chat.chatInput.branchSwitch.cancel': '취소',
  ...
  'chat.toolOutputDialog.image.zoomInAria': '확대',
  'chat.toolOutputDialog.image.zoomOutAria': '축소',
  'chat.toolOutputDialog.image.resetZoomAria': '확대/축소 재설정',
  'chat.image.actions.sheetTitle': '이미지',
  'chat.image.actions.saveImage': '이미지 저장',
  'chat.image.actions.saveToPhotos': '사진에 저장',
  'chat.image.actions.saving': '저장 중…',
  'chat.image.actions.saveSuccess': '이미지를 저장했습니다',
  'chat.image.actions.saveFailed': '이미지를 저장할 수 없습니다',
  ...
  'chat.activity.outputLoading': '전체 출력을 불러오는 중…',
  'chat.activity.outputLoadFailed': '전체 출력을 불러오지 못했습니다.',
  'chat.activity.outputRetry': '다시 시도',
  ...
  'chat.fileAttachment.image.loadManuallyCount': '이미지 {count}개 불러오기',
  ...
  'chat.permissionCard.replaceAll': '모든 항목 바꾸기',
  'chat.permissionCard.responseFormat': '응답 형식:',
  'chat.permissionCard.allowOnce': '한 번 허용',
  'chat.permissionCard.alwaysAgree': '항상 허용',
  ...
  'chat.modelControls.costPerMillion': '비용',
  'chat.modelControls.costInput': '입력',
  'chat.modelControls.costOutput': '출력',
  ...
  'chat.modelControls.keyboardHintSwitchAgentLabel': '에이전트 전환',
  ...
  'chat.contextGroup.exploring': '탐색 중',
  'chat.contextGroup.explored': '탐색함',
  'chat.contextGroup.expandAria': '탐색한 도구 펼치기',
  'chat.contextGroup.collapseAria': '탐색한 도구 접기',
  'chat.contextGroup.readSingle': '읽기 {count}회',
  'chat.contextGroup.readPlural': '읽기 {count}회',
  'chat.contextGroup.searchSingle': '검색 {count}회',
  'chat.contextGroup.searchPlural': '검색 {count}회',
  'chat.contextGroup.listSingle': '목록 {count}회',
  'chat.contextGroup.listPlural': '목록 {count}회',
  'chat.usedGroup.running': '실행 중',
  'chat.usedGroup.used': '실행함',
  'chat.usedGroup.expandAria': '실행한 도구 펼치기',
  'chat.usedGroup.collapseAria': '실행한 도구 접기',
  'chat.usedGroup.editSingle': '편집 {count}회',
  'chat.usedGroup.editPlural': '편집 {count}회',
  'chat.usedGroup.commandSingle': '명령 {count}회',
  'chat.usedGroup.commandPlural': '명령 {count}회',
  'chat.usedGroup.otherSingle': '호출 {count}회',
  'chat.usedGroup.otherPlural': '호출 {count}회',
  'chat.skillGroup.expandAria': '불러온 스킬 펼치기',
  'chat.skillGroup.collapseAria': '불러온 스킬 접기',
  'chat.skillGroup.summaryOverflow': '{names} 외 {count}개',
  'chat.tools.display.read': '파일 읽기',
  'chat.tools.display.write': '파일 쓰기',
  'chat.tools.display.edit': '파일 편집',
  'chat.tools.display.apply_patch': '패치 적용',
  'chat.tools.display.bash': '셸 명령',
  'chat.tools.display.grep': '파일 검색',
  'chat.tools.display.glob': '파일 찾기',
  'chat.tools.display.list': '디렉터리 목록',
  'chat.tools.display.task': '에이전트 작업',
  'chat.tools.display.webfetch': 'URL 가져오기',
  'chat.tools.display.websearch': '웹 검색',
  'chat.tools.display.codesearch': '코드 검색',
  'chat.tools.display.todowrite': '할 일 업데이트',
  'chat.tools.display.todoread': '할 일 읽기',
  'chat.tools.display.skill': '스킬 불러오기',
  'chat.tools.display.question': '질문',
  'chat.tools.display.lsp': 'LSP',
  'chat.tools.display.structuredoutput': '구조화 출력',
  'chat.tools.display.execute': '코드 실행',
  'chat.tools.display.session_rename': '세션 이름 바꾸기',
  'chat.tools.display.session_move': '세션 이동',
  'chat.tools.display.browser': '브라우저',
  ...
  'chat.messageBody.subagent.completed': '완료',
  'chat.messageBody.subagent.error': '실패',
  'chat.messageBody.subagent.cancelled': '취소됨',
  'chat.messageBody.subagent.completedDescription': '백그라운드 하위 에이전트가 완료되었습니다',
  ...
  'chat.sessionBackground.moveRunning': '백그라운드로 이동',
  'chat.sessionBackground.moving': '이동 중…',
  'chat.sessionBackground.moveFailed': '작업을 백그라운드로 옮기지 못했습니다',
  'chat.sessionBackground.tasksRunning': '백그라운드 작업 {count}개 실행 중',
  ...
  'commandPalette.title': '전역 검색',
  'commandPalette.error.sessions': '채팅 검색을 불러오지 못했습니다. 사용 가능한 결과는 계속 표시됩니다.',
  ...
  'commandPalette.item.newTerminalTab': '새 터미널 탭',
  ...
  'desktopHostSwitcher.sshError.openRemoteSettings': '원격 인스턴스 설정 열기',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.title': '원격 호스트에 Node.js 22+가 없습니다',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance': '원격에 Node.js 22 또는 24 LTS를 설치하세요(nvm, fnm 또는 시스템 패키지). 로그인 셸이 Node 18/20만 노출하면 부족하며, 표준 경로에 22+ 바이너리가 있어야 합니다.',
  'desktopHostSwitcher.sshError.packageManagerMissing.title': '원격 호스트에 npm 또는 bun이 없습니다',
  'desktopHostSwitcher.sshError.packageManagerMissing.guidance': '원격에 npm(Node.js에 포함) 또는 bun을 설치한 뒤 다시 시도하세요. Host CLI를 설치하려면 둘 중 하나가 필요합니다.',
  'desktopHostSwitcher.sshError.nativeBinding.title': '원격 데이터베이스 모듈을 빌드하지 못했습니다',
  'desktopHostSwitcher.sshError.nativeBinding.guidance': '원격에 Node.js 22 또는 24 LTS를 설치하세요. Node 23 같은 홀수 버전은 미리 빌드된 바이너리가 없는 경우가 많아 python3, gcc, make가 필요합니다. LTS를 준비한 뒤 다시 연결하세요.',
  'desktopHostSwitcher.sshError.openchamberCliMissing.title': '원격에서 OpenChamber 명령을 찾을 수 없습니다',
  'desktopHostSwitcher.sshError.openchamberCliMissing.guidance': '설치는 끝났지만 openchamber --version 이 사용 가능한 버전을 반환하지 않았습니다. ~/.bun/bin 또는 npm 전역 bin 이 PATH 에 있는지 확인한 뒤 다시 시도하세요. SSH 에서 openchamber --version 을 실행해 확인할 수도 있습니다.',
  'desktopHostSwitcher.sshError.openchamberRegistry.title': '원격에서 OpenChamber를 내려받지 못했습니다',
  'desktopHostSwitcher.sshError.openchamberRegistry.guidance': '원격에서 npm 레지스트리 또는 설정된 미러에 접근할 수 없습니다. 네트워크, 프록시, npm registry 를 확인한 뒤 다시 시도하세요. Node 22/24와 npm으로 @openchambery/web을 직접 설치할 수도 있습니다.',
  'desktopHostSwitcher.sshError.openchamberInstall.title': '원격에 OpenChamber를 설치하지 못했습니다',
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'bun 또는 npm이 @openchambery/web 설치에 실패했습니다. 이 호스트의 SSH 로그에서 패키지 관리자 출력을 확인한 뒤 다시 시도하세요. Node 22/24로 직접 설치할 수도 있습니다.',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.title': '원격 OpenChamber CLI가 너무 오래되었습니다',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance': '원격 CLI가 이 데스크톱이 보낸 플래그(예: --relay-host)를 거부했습니다. SSH relay host를 지원하는 @openchambery/web으로 업그레이드한 뒤 다시 시도하세요.',
  'desktopHostSwitcher.sshError.opencodeInstall.title': '원격에 OpenCode CLI를 설치하지 못했습니다',
  'desktopHostSwitcher.sshError.opencodeInstall.guidance': '원격 네트워크와 패키지 관리자를 확인한 뒤 다시 시도하세요. OpenCode CLI를 원격에 직접 설치할 수도 있습니다.',
  'desktopHostSwitcher.sshError.serverStart.title': '원격 OpenChamber 서버가 시작되지 않았습니다',
  'desktopHostSwitcher.sshError.serverStart.guidance': 'SSH는 연결됐지만 Host 프로세스에 도달하지 못했습니다. 원격이 Node 22/24인지, 선택한 포트가 비어 있는지 확인한 뒤 다시 시도하세요.',
  'desktopHostSwitcher.sshError.sshAuth.title': 'SSH 인증에 실패했습니다',
  'desktopHostSwitcher.sshError.sshAuth.guidance': '설정 → 원격 인스턴스에서 키, 비밀번호, 대상을 확인하세요. SSH 로그인이 성공할 때까지 초기화는 끝나지 않습니다.',
  'desktopHostSwitcher.sshError.sshUnreachable.title': 'SSH 호스트에 연결할 수 없습니다',
  'desktopHostSwitcher.sshError.sshUnreachable.guidance': '호스트 이름, 포트, 네트워크(필요하면 먼저 VPN이나 배스천)를 확인한 뒤 다시 시도하세요.',
  'desktopHostSwitcher.sshError.timeout.title': 'SSH 연결 시간이 초과되었습니다',
  'desktopHostSwitcher.sshError.timeout.guidance': '원격이 제한 시간 안에 초기화를 끝내지 못했습니다. 네트워크와 Node 22/24 설치 여부를 확인한 뒤 다시 시도하세요.',
  'desktopHostSwitcher.sshError.unknown.title': '원격 인스턴스를 시작하지 못했습니다',
  'desktopHostSwitcher.sshError.unknown.guidance': '원격 초기화에 실패했습니다. 아래의 구체적인 오류를 보거나, 설정 → 원격 인스턴스에서 이 호스트의 SSH 로그를 확인하세요.',
  ...
  'updateDialog.status.otaBundleReused': '이전에 다운로드한 업데이트 패키지를 사용했습니다. 다시 다운로드할 필요가 없습니다.',
  ...
  'updateDialog.actions.applyOtaNow': '지금 업데이트',
  'updateDialog.actions.later': '나중에',
  ...
  'mobileUpdate.ota.toast.available.title': '업데이트 사용 가능',
  'mobileUpdate.ota.toast.available.description': '버전 {version}을(를) 설치할 수 있습니다.',
  'mobileUpdate.ota.toast.actions.update': '업데이트',
  'mobileUpdate.ota.toast.actions.dismiss': '닫기',
  ...
  'common.relative.justNow': '방금',
  'common.relative.minutesAgoShort': '{count}분 전',
  'common.relative.hoursAgoShort': '{count}시간 전',
  'common.relative.daysAgoShort': '{count}일 전',
  'common.relative.weeksAgoShort': '{count}주 전',
  'common.relative.yearsAgoShort': '{count}년 전',
  'common.relative.minutesAgoCompact': '{count}분 전',
  'common.relative.hoursAgoCompact': '{count}시간 전',
  'common.relative.daysAgoCompact': '{count}일 전',
  'common.relative.weeksAgoCompact': '{count}주 전',
  'common.relative.monthsAgoCompact': '{count}개월 전',
  'common.relative.yearsAgoCompact': '{count}년 전',
  ...
  'header.workStatusPanel.toggleAria': '작업 상태 전환',
  ...
  'chat.workStatus.section.subagents': '하위 에이전트',
  'chat.workStatus.section.mcp': 'MCP',
  'chat.workStatus.section.contextSources': '컨텍스트 출처',
  'chat.workStatus.context.label': '컨텍스트',
  'chat.workStatus.cost.breakdown': '세션 {session} · 하위 에이전트 {subagents}',
  ...
  'chat.workStatus.pr.checksPending': '{count}개 진행 중',
  ...
  'chat.workStatus.attention.revert': '되돌리는 중',
  'chat.workStatus.attention.bisect': '이분 탐색 중',
  'chat.workStatus.action.openContext': '컨텍스트 패널 열기',
  'chat.workStatus.action.openGit': 'Git 패널 열기',
  'chat.workStatus.action.copyBranch': '브랜치 이름 복사',
  ...
  'chat.workStatus.subagent.untitled': '하위 에이전트',
  'chat.workStatus.subagent.working': '작업 중',
  'chat.workStatus.subagent.needsPermission': '권한 대기',
  'chat.workStatus.subagent.askedQuestion': '질문을 함',
  'chat.workStatus.subagent.done': '완료',
  'chat.workStatus.subagent.workingCount': '{count}개 작업 중',
  'chat.workStatus.subagent.doneCount': '{count}개 완료',
  ...
  'chat.workStatus.goal.pause': '일시 중지',
  'chat.workStatus.goal.resume': '다시 시작',
  'chat.workStatus.goal.updateFailed': '목표를 업데이트할 수 없습니다',
  'chat.workStatus.sections.open': '섹션 선택',
  'chat.workStatus.sections.allHidden': '모든 섹션이 숨겨져 있습니다',
  'chat.workStatus.sections.showAll': '모두 표시',
  'chat.workStatus.sections.dialogTitle': '작업 상태 섹션',
  'chat.workStatus.sections.dialogDescription': '카드에 표시할 섹션을 고릅니다. 끌어 순서를 바꿀 수 있습니다.',
  'chat.workStatus.breakdown.skills': '스킬',
  'chat.workStatus.breakdown.mcp': 'MCP 서버',
  'chat.workStatus.telemetry.tokens': '토큰',
  'chat.workStatus.telemetry.duration': '소요 시간',
  'chat.workStatus.telemetry.cost': '비용',
  'chat.workStatus.usage.refresh': '할당량 새로고침',
  'chat.workStatus.compact.onBranch': '{branch}에서',
  'chat.workStatus.compact.changes': '변경',
  'opencodeUpgrade.screen.title': 'OpenCode 2.0.15가 필요합니다',
  'opencodeUpgrade.screen.outdatedTitle': 'OpenCode 업데이트',
  'opencodeUpgrade.screen.local': 'OpenCode {version}이 설치되어 있습니다. 이 OpenChamber 버전에는 OpenCode v2가 필요합니다.',
  'opencodeUpgrade.screen.outdatedLocal': 'OpenCode {version}이 설치되어 있습니다. 이 OpenChamber 버전에는 OpenCode {minimum} 이상이 필요합니다.',
  'opencodeUpgrade.screen.external': '연결된 서버가 OpenCode {version}을 실행 중입니다. 해당 서버에 OpenCode v2를 설치한 뒤 다시 확인하세요.',
  'opencodeUpgrade.screen.outdatedExternal': '연결된 서버가 OpenCode {version}을 실행 중입니다. OpenCode {minimum} 이상으로 업데이트한 뒤 다시 확인하세요.',
  'opencodeUpgrade.screen.bundled': 'OpenChamber에 포함된 OpenCode {version}은 {minimum}보다 오래되었습니다. 포함된 바이너리는 바꾸지 않고 관리형 사본을 설치할 수 있습니다.',
  'opencodeUpgrade.screen.installDescription': 'OpenChamber가 OpenCode {minimum} 이상을 관리형 캐시에 설치하고 다시 시작합니다. 기존 OpenCode 파일은 덮어쓰지 않습니다.',
  'opencodeUpgrade.screen.install': 'OpenCode {minimum} 설치',
  'opencodeUpgrade.screen.update': 'OpenCode {minimum} 이상으로 업데이트',
  'opencodeUpgrade.screen.installing': 'OpenCode를 설치하는 중…',
  'opencodeUpgrade.screen.updating': 'OpenCode를 업데이트하는 중…',
  'opencodeUpgrade.screen.reconnect': '다시 확인',
  'opencodeUpgrade.screen.reconnecting': '확인하는 중…',
  'opencodeUpgrade.screen.failedTitle': 'OpenCode가 업그레이드되지 않았습니다',
  'opencodeUpgrade.screen.failedGeneric': '설치가 끝나지 않았습니다. OpenCode는 이전 버전 그대로입니다.',
  'opencodeUpgrade.screen.guide': '설치 가이드',
  'opencodeUpgrade.screen.manualGuidance': '이 런타임에서는 자동 설치를 할 수 없습니다. OpenCode를 직접 업데이트한 뒤 다시 확인하세요.',
};
