...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.questionDelegate.awaiting': 'Очікування підтвердження хоста…',
  ...
  'chat.questionDelegate.stale': 'Показано останній відомий стан; синхронізація з хостом триває.',
  'chat.questionDelegate.pauseFailed': 'Помилка призупинення. Відлік на хості може тривати.',
