...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.response.contentFilter': 'Провайдер заблокував відповідь',
  'chat.response.transport': 'Не вдалося підключитися до провайдера',
  'chat.response.internal': 'Внутрішня помилка провайдера',
  'chat.response.invalidOutput': 'Некоректна відповідь провайдера',
  'chat.response.invalidRequest': 'Провайдер відхилив запит',
  'chat.response.unsupportedOperation': 'Провайдер не підтримує цю операцію',
  'chat.response.noRoute': 'Модель або конфігурація провайдера недоступна',
  'chat.response.providerUnknown': 'Помилка провайдера',
  'chat.response.timeout': 'Час очікування відповіді провайдера вичерпано',
  'chat.response.permissionRejected': 'У дозволі відмовлено',
  'chat.response.toolExecution': 'Не вдалося виконати інструмент',
  'chat.response.compactionFailed': 'Не вдалося стиснути контекст',
  'chat.response.compactionUnavailable': 'Ще немає вмісту для стиснення',
  'chat.response.compactionInterrupted': 'Стиснення контексту перервано',
  'chat.response.compactionCancelled': 'Стиснення контексту скасовано',
  'chat.response.stopped': 'Зупинено користувачем',
  'chat.response.interrupted': 'Відповідь перервано',
  'chat.response.toolInterrupted': 'Виконання інструмента перервано',
  'chat.response.resumeExhausted': 'Автоматичне відновлення зупинено після повторних переривань',
  'chat.response.retrying': 'Автоматична повторна спроба',
  'chat.response.failed': 'Помилка виконання',
  'chat.response.continuingAfterRestart': 'Продовження після перезапуску',
  'chat.queuedMessage.inheritsSessionSelection': 'Під час виконання успадковує модель, агента й варіант сеансу.',
  'chat.sessionRecovery.awaitingConfirmation': 'Службу перезапущено. Очікуємо підтвердження стану завдання.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': 'Помилка створення відповіді. Спробуйте ще раз.',
  'chat.btw.description': 'Запитайте про розмову, зберігаючи її історію без змін.',
  'chat.btw.placeholder': 'Запитайте в Side Chat…',
  'chat.btw.removeQuoteAria': 'Видалити цитату',
  'chat.message.conversationQuotesLabel': 'Цитата з розмови',
  'chat.btw.sessionRequired': 'Відкрийте наявну розмову, щоб відкрити Side Chat.',
  'chat.btw.plainTextRequired': 'Використовуйте звичайний текст. Посилання залишаються в полі введення.',
  'chat.btw.pending': 'Підготовка відповіді…',
  'chat.btw.cancelled': 'Відповідь скасовано. Спробуйте ще раз, щоб повторити запитання.',
  'chat.btw.resize': 'Змінити розмір панелі Side Chat',
  ...settingsDict,
  'chat.questionDelegate.countdown': 'Модель вирішить через {seconds} с',
  'chat.questionDelegate.awaiting': 'Очікування підтвердження…',
  'chat.questionDelegate.pausing': 'Призупинення відліку…',
  'chat.questionDelegate.paused': 'Відлік призупинено',
  'chat.questionDelegate.disabled': 'Автоматичний відлік вимкнено',
  'chat.questionDelegate.refreshStatus': 'Оновити стан',
  'chat.questionDelegate.submitting': 'Надсилання відповіді…',
  'chat.questionDelegate.uncertain': 'Результат надсилання невизначений. Очікування підтвердження.',
  'chat.questionDelegate.settled': 'Питання вирішено',
  'chat.questionDelegate.success': 'Надіслано відповідь із проханням продовжити. Модель визначить подальші кроки.',
  'chat.questionDelegate.stale': 'Показано останній відомий стан; оновлення триває.',
  'chat.questionDelegate.pauseFailed': 'Помилка призупинення. Відлік може тривати.',
  'chat.questionDelegate.delegateFailed': 'Помилка делегування. Перевірте стан і повторіть спробу.',
  'chat.questionDelegate.loadFailed': 'Помилка оновлення стану делегування.',
  'chat.questionDelegate.retry': 'Повторити',
  'chat.questionDelegate.pause': 'Призупинити відлік',
  'chat.questionDelegate.delegate': 'Делегувати зараз',
  ...
  "mobile.instances.status.connected": "Підключено",
  "mobile.instances.status.saved": "Збережено",
  ...
  "mobile.menu.newSession": "Новий чат",
  "mobile.chat.syncingMessages": "Синхронізація повідомлень...",
  ...
  "mobile.sessions.mainWorkspace": "Основна робоча область",
  "mobile.sessions.section.pinned": "Закріплені / В роботі",
  "mobile.sessions.searchAria": "Пошук сесій",
  "mobile.sessions.section.otherProjects": "Інші проєкти",
  "mobile.sessions.section.projects": "Проєкти",
  "mobile.projects.menu.label": "Більше дій",
  "mobile.projects.menu.newChat": "Новий чат",
  "mobile.projects.menu.newProject": "Новий проєкт",
  "mobile.projects.menu.scanQr": "Сканувати QR-код",
  "mobile.projects.menu.switchInstance": "Змінити екземпляр",
  ...
  "mobile.sessions.startNewChat": "Новий чат",
  ...
  "mobile.projects.closeConfirmMessage": "Закрити «{title}»? Його буде прибрано зі списку проєктів. Сесії залишаться на диску.",
  ...
  "mobile.sessions.stopSessionAria": "Зупинити {title}",
  "mobile.sessions.stopGroupAria": "Зупинити всі запущені сесії в {label}",
  "mobile.sessions.stopSubsessionsAria": "Зупинити запущені підсесії {title}",
  ...
  "mobile.sessions.newSessionAria": "Почати новий чат у цьому проєкті",
  ...
  "mobile.files.html.fullscreenAria": "Відкрити повноекранний перегляд",
  "mobile.files.html.exitFullscreenAria": "Вийти з повноекранного режиму",
  "mobile.files.html.viewSourceAria": "Переглянути код",
  "mobile.files.html.viewPreviewAria": "Переглянути попередній перегляд",
  ...
  "layout.rightSidebar.browser": "Браузер",
  "layout.browserProvider.noSurface": "{name} не має живого перегляду.",
  "layout.browserProvider.status.connecting": "З'єднання…",
  "layout.browserProvider.status.reconnecting": "З'єднання втрачено. Повторне підключення…",
  "layout.browserProvider.status.ready": "Клацніть або натисніть клавішу, щоб узяти керування",
  "layout.browserProvider.status.readyFocused": "Набирайте, щоб керувати переглядом; клацніть поза ним, щоб вийти",
  "layout.browserProvider.status.agentWorking": "Агент працює",
  "layout.browserProvider.status.youControl": "Ви керуєте",
  "layout.browserProvider.status.otherControls": "Керує інший пристрій",
  "layout.browserProvider.handBack": "Повернути розширенню",
  "layout.browserProvider.retry": "Спробувати ще раз",
  "layout.browserProvider.canvasAria": "Живий перегляд {name}",
  "layout.browserProvider.ended.service-stopped": "Сервіс розширення зупинився.",
  "layout.browserProvider.ended.extension-unavailable": "Розширення недоступне.",
  "layout.browserProvider.ended.host-shutdown": "OpenChamber завершує роботу.",
  ...
  "sessions.sidebar.header.actions.newSession": "Новий чат",
  ...
  "sessions.scheduledTasks.dialog.actions.create": "Створити",
  "sessions.scheduledTasks.dialog.actions.moreAria": "Додаткові дії для {taskName}",
  "sessions.scheduledTasks.dialog.actions.delete": "Видалити",
  "sessions.scheduledTasks.dialog.actions.pause": "Призупинити",
  "sessions.scheduledTasks.dialog.actions.resume": "Продовжити",
  "sessions.scheduledTasks.workspace.filters.all": "Усі",
  "sessions.scheduledTasks.workspace.filters.active": "Активні",
  "sessions.scheduledTasks.workspace.filters.paused": "Призупинені",
  "sessions.scheduledTasks.workspace.views.aria": "Подання запланованих завдань",
  "sessions.scheduledTasks.workspace.views.tasks": "Завдання",
  "sessions.scheduledTasks.workspace.views.history": "Історія",
  "sessions.scheduledTasks.history.loading": "Завантаження історії запусків…",
  "sessions.scheduledTasks.history.error.title": "Не вдалося завантажити історію запусків",
  "sessions.scheduledTasks.history.error.description": "OpenChamber не зміг завантажити записані запуски.",
  "sessions.scheduledTasks.history.error.more": "Не вдалося завантажити більше запусків. Завантажена історія залишається доступною.",
  "sessions.scheduledTasks.history.retry": "Повторити",
  "sessions.scheduledTasks.history.empty.title": "Запусків ще немає",
  "sessions.scheduledTasks.history.empty.description": "Тут з’являться заплановані та ручні запуски.",
  "sessions.scheduledTasks.history.trigger.scheduled": "За розкладом",
  "sessions.scheduledTasks.history.trigger.manual": "Вручну",
  "sessions.scheduledTasks.history.meta.trigger": "Запуск",
  "sessions.scheduledTasks.history.meta.started": "Початок",
  "sessions.scheduledTasks.history.meta.ended": "Кінець",
  "sessions.scheduledTasks.history.meta.duration": "Тривалість",
  "sessions.scheduledTasks.history.ended.unavailable": "—",
  "sessions.scheduledTasks.history.duration.pending": "Виконується",
  "sessions.scheduledTasks.history.duration.lessThanOneSecond": "<1 с",
  "sessions.scheduledTasks.history.duration.milliseconds": "{count} мс",
  "sessions.scheduledTasks.history.duration.seconds": "{count} с",
  "sessions.scheduledTasks.history.duration.minutesSeconds": "{minutes} хв {seconds} с",
  "sessions.scheduledTasks.history.duration.minutes": "{count} хв",
  ...
  "sessions.scheduledTasks.history.loadingMore": "Завантаження…",
  "sessions.scheduledTasks.history.loadMore": "Завантажити ще",
  "sessions.scheduledTasks.workspace.search.placeholder": "Пошук завдань…",
  "sessions.scheduledTasks.workspace.search.noResults": "Жодне завдання не відповідає пошуку.",
  "sessions.scheduledTasks.workspace.partialLoadWarning": "Не вдалося завантажити заплановані завдання деяких проєктів. Завантажені завдання залишаються доступними.",
  "sessions.scheduledTasks.workspace.editor.emptyTitle": "Виберіть завдання",
  "sessions.scheduledTasks.workspace.editor.emptyDescription": "Виберіть завдання зі списку або створіть нове.",
  "sessions.scheduledTasks.workspace.confirm.discardChanges": "Незбережені зміни буде відкинуто. Продовжити?",
  "sessions.scheduledTasks.editor.panel.details": "Деталі",
  "sessions.scheduledTasks.editor.panel.frequency": "Періодичність",
  ...
  "sessions.sidebar.header.actions.sessionDisplayMode": "Дії розгортання/згортання проєктів",
  "sessions.sidebar.header.displayMode.label": "Розгорнути/згорнути проєкти",
  ...
  "sessions.sidebar.projectsTitle": "Projects",
  "sessions.sidebar.projectsSyncing": "Syncing sessions…",
  ...
  "sessions.sidebar.bulkActions.archiveUndoFailed": "Не вдалося відновити сесій: {count}",
  "sessions.sidebar.undo": "Скасувати",
  "sessions.sidebar.openSettings": "Налаштування",
  ...
  "sessions.sidebar.project.actions.syncSessions": "Синхронізувати сеанси",
  ...
  "sessions.sidebar.session.menu.refreshTranscript": "Синхронізувати повідомлення",
  "sessions.sidebar.session.menu.refreshTranscriptSuccess": "Повідомлення синхронізовано",
  "sessions.sidebar.session.menu.refreshTranscriptFailed": "Не вдалося синхронізувати повідомлення",
  ...
  "sessions.sidebar.session.actions.pinned": "Закріплено",
  "sessions.sidebar.session.status.permissionRequired": "Потрібен дозвіл",
  "sessions.sidebar.session.status.questionRequired": "Потрібна відповідь",
  ...
  "sessions.sidebar.session.archive.undoFailed": "Не вдалося скасувати архівування",
  ...
  "sessions.sidebar.group.showMore": "Більше",
  ...
  "sessions.sidebar.group.showFewer": "Менше",
  ...
  "gitView.changes.deferredTitle": "Змінених файлів: {count}",
  "gitView.changes.deferredStagedCount": "Індексовані: {count}",
  "gitView.changes.deferredUnstagedCount": "Неіндексовані: {count}",
  "gitView.changes.deferredHint": "Великі набори змін не відображаються автоматично, щоб застосунок залишався швидким.",
  "gitView.changes.deferredLoadAction": "Завантажити зміни",
  ...
  "contextPanel.mode.context": "Використання",
  ...
  "contextPanel.file.notice.turnDiffOutsideWorkspace": "Diff цього ходу недоступний поза проєктом. Показано поточний вміст файлу.",
  ...
  "sidebarFilesTree.actions.collapseAllTitle": "Згорнути все",
  "sidebarFilesTree.actions.expandAllTitle": "Розгорнути все",
  ...
  "contextUsage.tooltip.usage": "Використання: {percent}",
  ...
  "contextSidebar.empty.openSession": "Відкрийте сесію, щоб переглянути використання.",
  "contextSidebar.section.context": "Використання",
  ...
  "contextSidebar.stats.sessionTps": "TPS сесії",
  ...
  "diffView.actions.openFilePreview": "Відкрити цей файл",
  ...
  'chat.history.loadingMore': 'Завантаження…',
  'chat.history.loadOlderFailed': 'Не вдалося завантажити старіші повідомлення. Спробуйте ще раз.',
  'chat.history.loadOlderTimeout': 'Час очікування завантаження старіших повідомлень минув. Спробуйте ще раз.',
  ...
  'chat.history.retry': 'Спробувати ще раз',
  ...
  "header.services.openWithCurrent": "Перемкнути екземпляр (поточний: {current})",
  "header.services.open": "Перемкнути екземпляр",
  "header.services.tooltip.currentInstanceWithShortcuts": "Перемкнути екземпляр: {current} ({toggle}; наступна вкладка {nextTab})",
  "header.services.tooltip.servicesWithShortcuts": "Перемкнути екземпляр ({toggle}; наступна вкладка {nextTab})",
  "header.services.title": "Перемкнути екземпляр",
  "header.services.viewAria": "Перемкнути екземпляр",
  "header.services.closeAria": "Закрити перемикач екземпляра",
  ...
  "header.actions.sessionMenu": "Дії сесії",
  "header.actions.sessionMenuAria": "Відкрити меню дій сесії",
  "header.actions.sessionMenu.servicesWithInstance": "Перемкнути екземпляр ({current})",
  "header.actions.sessionMenu.viewUsage": "Переглянути використання",
  ...
  "helpDialog.item.previousSession": "Попередня сесія",
  "helpDialog.item.nextSession": "Наступна сесія",
  ...
  "helpDialog.item.toggleRightSidebar": "Перемкнути панель перегляду",
  ...
  "helpDialog.item.closeContextPanelTab": "Закрити вкладку панелі контексту",
  "helpDialog.item.toggleTerminal": "Перемкнути термінал",
  "helpDialog.item.newTerminalTab": "Нова вкладка термінала (коли термінал у фокусі)",
  "helpDialog.item.openNewTerminal": "Відкрити новий термінал",
  "helpDialog.item.previousTerminalTab": "Попередня вкладка термінала (коли термінал у фокусі)",
  "helpDialog.item.nextTerminalTab": "Наступна вкладка термінала (коли термінал у фокусі)",
  "helpDialog.item.toggleBottomPanel": "Перемкнути нижню панель",
  ...
  "helpDialog.item.zoomIn": "Збільшити",
  "helpDialog.item.zoomOut": "Зменшити",
  ...
  "helpDialog.item.leaderOpenModel": "Відкрити вибір моделі",
  "helpDialog.item.leaderOpenAgent": "Відкрити вибір агента",
  "helpDialog.item.leaderNewSession": "Створити нову сесію",
  "helpDialog.item.leaderCompact": "Стиснути поточну сесію",
  "chat.leaderKey.pendingAria": "Клавіша лідера активна. Натисніть наступну клавішу.",
  "chat.leaderKey.action.model": "Модель",
  "chat.leaderKey.action.agent": "Агент",
  "chat.leaderKey.action.newSession": "Нова",
  "chat.leaderKey.action.compact": "Стиснути",
  ...
  "helpDialog.proTips.recentSessions": "9 останніх чатів відображаються в глобальному пошуку",
  ...
  "chat.fileAttachment.actions.expandImages": "Показати більше зображень",
  "chat.fileAttachment.actions.collapseImages": "Згорнути зображення",
  ...
  "chat.activity.title": "Деталі обробки",
  "chat.activity.active": "Обробка",
  "chat.activity.compacting": "Стиснення",
  "chat.activity.compactionCompleted": "Стиснення завершено",
  "chat.activity.compactionFailed": "Не вдалося стиснути",
  "chat.activity.expandAria": "Розгорнути деталі обробки",
  "chat.activity.collapseAria": "Згорнути деталі обробки",
  "chat.activity.completed": "Оброблено за {duration}",
  "chat.activity.completedStatus": "Оброблено",
  "chat.activity.agentsWorking": "{count} агентів працюють",
  "chat.activity.agentsInvolved": "{count} агентів брали участь",
  "chat.activity.moreHidden": "+{count} більше...",
  ...
  "chat.emptyState.establishingConversation": "Встановлення розмови",
  ...
  "chat.draftStarters.expand": "Показати більше",
  "chat.draftStarters.collapse": "Згорнути",
  ...
  "chat.assistantStatus.findingFiles": "Пошук файлів",
  "chat.assistantStatus.listingDirectory": "Перегляд каталогу",
  "chat.assistantStatus.delegatingTask": "Делегування завдання",
  "chat.assistantStatus.taskWorking": "{name} у роботі",
  "chat.assistantStatus.fetchingUrl": "Отримання URL",
  "chat.assistantStatus.searchingWeb": "Пошук у мережі",
  "chat.assistantStatus.webCodeSearch": "Пошук вебкоду",
  "chat.assistantStatus.updatingTodos": "Оновлення завдань",
  "chat.assistantStatus.readingTodos": "Читання завдань",
  "chat.assistantStatus.learningSkill": "Вивчення навички",
  "chat.assistantStatus.askingQuestion": "Формування запитання",
  "chat.assistantStatus.executing": "Виконання коду",
  "chat.assistantStatus.renamingSession": "Перейменування сесії",
  "chat.assistantStatus.movingSession": "Переміщення сесії",
  "chat.assistantStatus.usingBrowser": "Використання браузера",
  "chat.assistantStatus.usingTool": "Використання {tool}",
  "chat.assistantStatus.working": "Робота триває",
  "chat.assistantStatus.processing": "Обробка",
  "chat.assistantStatus.preparing": "Підготовка",
  "chat.assistantStatus.warmingUp": "Підготовка",
  "chat.assistantStatus.gearsTurning": "Обробка",
  "chat.assistantStatus.computing": "Обчислення",
  "chat.assistantStatus.calculating": "Розрахунок",
  "chat.assistantStatus.analyzing": "Аналіз",
  "chat.assistantStatus.wheelsSpinning": "Обробка",
  "chat.assistantStatus.calibrating": "Калібрування",
  "chat.assistantStatus.synthesizing": "Узагальнення",
  "chat.assistantStatus.connectingDots": "Встановлення зв’язків",
  "chat.assistantStatus.inspectingLogic": "Перевірка логіки",
  ...
  "chat.assistantStatus.retryingAttempt": "Повторна спроба (спроба {attempt})",
  "chat.assistantStatus.retryingInAttempt": "Повторна спроба {duration} (спроба {attempt})",
  ...
  "chat.revertPopover.files": "Файли, які зміняться",
  ...
  "chat.revert.toast.busy": "Не можна скасувати, поки сесія зайнята",
  "chat.form.title": "Форма",
  "chat.form.reply": "Надіслати",
  "chat.form.cancel": "Скасувати",
  "chat.retry.action.quota": "Досягнуто ліміт використання",
  "chat.retry.action.account": "Досягнуто ліміт облікового запису",
  "chat.retry.action.open": "Відкрити",
  ...
  "chat.commandAutocomplete.command.reloadDescription": "Перезавантажити конфігурацію, провайдерів і плагіни OpenCode без перезапуску",
  ...
  "chat.commandAutocomplete.command.newDescription": "Почати нову сесію в поточному проєкті.",
  ...
  "chat.fileMentionAutocomplete.groups.skills": "Навички",
  "chat.fileMentionAutocomplete.groups.agents": "Агенти",
  "chat.fileMentionAutocomplete.groups.sessions": "Завантажені сеанси",
  "chat.fileMentionAutocomplete.groups.directories": "Каталоги",
  "chat.fileMentionAutocomplete.groups.recentFiles": "Нещодавні файли",
  "chat.fileMentionAutocomplete.groups.files": "Файли",
  "chat.fileMentionAutocomplete.sessionType": "Сеанс OpenCode",
  "chat.fileMentionAutocomplete.untitledSession": "Сеанс без назви",
  ...
  "chat.queuedMessage.title": "Черга",
  "chat.queuedMessage.edit": "редагувати",
  "chat.queuedMessage.send": "скерувати",
  "chat.queuedMessage.queuing": "Додавання в чергу…",
  "chat.queuedMessage.queuingAria": "Додавання повідомлення в чергу",
  "chat.queuedMessage.waitingForCompaction": "Очікування стиснення",
  "chat.queuedMessage.waitingForCompactionAria": "Очікування завершення стиснення",
  "chat.queuedMessage.sending": "Скерування…",
  "chat.queuedMessage.sendingAria": "Скерування повідомлення",
  ...
  "chat.textSelection.actions.addToSideChat": "Додати до бічного чату",
  "chat.textSelection.title.addToCurrentChat": "Додати до поточного чату",
  "chat.messageBody.aborted": "Генерацію зупинено",
  "chat.messageBody.actions.editing": "Редагування…",
  "chat.messageBody.actions.editStaged": "Редагування очікує",
  "chat.messageBody.actions.cancelEdit": "Скасувати редагування",
  ...
  "chat.messageBody.meta.tpsAria": "Швидкість генерації: {rate}",
  "chat.messageBody.meta.tpsTooltip": "Швидкість генерації (токенів/с), без часу викликів інструментів",
  ...
  "chat.forkTransition.preparing": "Підготовка відгалуження",
  "chat.forkTransition.copying": "Копіювання розмови (довгі сеанси можуть зайняти час)",
  "chat.forkTransition.opening": "Відкриття нового сеансу",
  "chat.forkTransition.loading": "Завантаження останніх повідомлень",
  ...
  "chat.chatInput.actions.attachPhotos": "Прикріпити фото",
  "chat.chatInput.actions.attachCancel": "Скасувати",
  ...
  "chat.chatInput.actions.queuingMessageAria": "Додавання до черги…",
  "chat.chatInput.actions.sendingMessageAria": "Надсилання…",
  ...
  "chat.chatInput.toast.reloadStarted": "Перезавантаження конфігурації…",
  "chat.chatInput.toast.reloadSucceeded": "Конфігурацію перезавантажено",
  "chat.chatInput.toast.reloadFailed": "Не вдалося перезавантажити конфігурацію",
  ...
  "chat.chatInput.toast.sessionReferenceLoadFailed": "Не вдалося завантажити посилання на сеанс.",
  ...
  "chat.chatInput.draftPicker.newProject": "Новий проєкт",
  ...
  "chat.chatInput.branchSwitch.title": "Перейти на {branch}?",
  "chat.chatInput.branchSwitch.description": "Як відкрити цю гілку для нової розмови?",
  "chat.chatInput.branchSwitch.createWorktree": "Створити worktree",
  "chat.chatInput.branchSwitch.createWorktreeDescription": "Залишити поточний каталог без змін і працювати в ізольованому worktree.",
  "chat.chatInput.branchSwitch.checkoutHere": "Checkout сюди",
  "chat.chatInput.branchSwitch.checkoutHereDescription": "Перемкнути поточний каталог на цю гілку.",
  "chat.chatInput.branchSwitch.cancel": "Скасувати",
  ...
  "chat.toolOutputDialog.image.zoomInAria": "Збільшити",
  "chat.toolOutputDialog.image.zoomOutAria": "Зменшити",
  "chat.toolOutputDialog.image.resetZoomAria": "Скинути масштаб",
  "chat.image.actions.sheetTitle": "Зображення",
  "chat.image.actions.saveImage": "Зберегти зображення",
  "chat.image.actions.saveToPhotos": "Зберегти у Фото",
  "chat.image.actions.saving": "Збереження…",
  "chat.image.actions.saveSuccess": "Зображення збережено",
  "chat.image.actions.saveFailed": "Не вдалося зберегти зображення",
  ...
  "chat.activity.outputLoading": "Завантаження повного виводу…",
  "chat.activity.outputLoadFailed": "Не вдалося завантажити повний вивід.",
  "chat.activity.outputRetry": "Спробувати ще раз",
  "chat.fileAttachment.image.loading": "Завантаження зображення…",
  "chat.fileAttachment.image.loadFailed": "Не вдалося завантажити зображення.",
  "chat.fileAttachment.image.retry": "Повторити завантаження зображення",
  "chat.fileAttachment.image.loadManually": "Завантажити зображення",
  "chat.fileAttachment.image.loadManuallyCount": "Завантажити зображення ({count})",
  ...
  "chat.permissionCard.replaceAll": "Замінити всі входження",
  "chat.permissionCard.responseFormat": "Формат відповіді:",
  "chat.permissionCard.allowOnce": "Дозволити один раз",
  "chat.permissionCard.alwaysAgree": "Завжди дозволяти",
  ...
  "chat.modelControls.costPerMillion": "Вартість",
  "chat.modelControls.costInput": "Вхід",
  "chat.modelControls.costOutput": "Вихід",
  ...
  "chat.modelControls.keyboardHintSwitchAgentLabel": "Змінити агента",
  ...
  "chat.contextGroup.exploring": "Досліджується",
  "chat.contextGroup.explored": "Досліджено",
  "chat.contextGroup.expandAria": "Розгорнути досліджені інструменти",
  "chat.contextGroup.collapseAria": "Згорнути досліджені інструменти",
  "chat.contextGroup.readSingle": "{count} читання",
  "chat.contextGroup.readPlural": "{count} читань",
  "chat.contextGroup.searchSingle": "{count} пошук",
  "chat.contextGroup.searchPlural": "{count} пошуків",
  "chat.contextGroup.listSingle": "{count} список",
  "chat.contextGroup.listPlural": "{count} списків",
  "chat.usedGroup.running": "Виконується",
  "chat.usedGroup.used": "Використано",
  "chat.usedGroup.expandAria": "Розгорнути використані інструменти",
  "chat.usedGroup.collapseAria": "Згорнути використані інструменти",
  "chat.usedGroup.editSingle": "{count} редагування",
  "chat.usedGroup.editPlural": "{count} редагувань",
  "chat.usedGroup.commandSingle": "{count} команда",
  "chat.usedGroup.commandPlural": "{count} команд",
  "chat.usedGroup.otherSingle": "{count} виклик",
  "chat.usedGroup.otherPlural": "{count} викликів",
  "chat.skillGroup.expandAria": "Розгорнути завантажені навички",
  "chat.skillGroup.collapseAria": "Згорнути завантажені навички",
  "chat.skillGroup.summaryOverflow": "{names} і ще {count}",
  "chat.tools.display.read": "Читання файлу",
  "chat.tools.display.write": "Запис файлу",
  "chat.tools.display.edit": "Редагування файлу",
  "chat.tools.display.apply_patch": "Застосувати патч",
  "chat.tools.display.bash": "Команда оболонки",
  "chat.tools.display.grep": "Пошук у файлах",
  "chat.tools.display.glob": "Знайти файли",
  "chat.tools.display.list": "Список каталогу",
  "chat.tools.display.task": "Завдання агента",
  "chat.tools.display.webfetch": "Отримати URL",
  "chat.tools.display.websearch": "Вебпошук",
  "chat.tools.display.codesearch": "Пошук коду",
  "chat.tools.display.todowrite": "Оновити список справ",
  "chat.tools.display.todoread": "Прочитати список справ",
  "chat.tools.display.skill": "Завантажити навичку",
  "chat.tools.display.question": "Запитання",
  "chat.tools.display.lsp": "LSP",
  "chat.tools.display.structuredoutput": "Структурований вивід",
  "chat.tools.display.execute": "Виконати код",
  "chat.tools.display.session_rename": "Перейменувати сесію",
  "chat.tools.display.session_move": "Перемістити сесію",
  "chat.tools.display.browser": "Браузер",
  ...
  "chat.messageBody.subagent.completed": "Завершено",
  "chat.messageBody.subagent.error": "Помилка",
  "chat.messageBody.subagent.cancelled": "Скасовано",
  "chat.messageBody.subagent.completedDescription": "Фоновий підаґент завершив роботу",
  ...
  "chat.sessionBackground.moveRunning": "Перемістити у фон",
  "chat.sessionBackground.moving": "Переміщення…",
  "chat.sessionBackground.moveFailed": "Не вдалося перемістити роботу у фон",
  "chat.sessionBackground.tasksRunning": "{count} фонове(-их) завдання(-ь)",
  ...
  "commandPalette.title": "Глобальний пошук",
  "commandPalette.error.sessions": "Не вдалося завантажити пошук чатів. Доступні результати залишаються видимими.",
  ...
  "commandPalette.item.newTerminalTab": "Нова вкладка термінала",
  ...
  "desktopHostSwitcher.sshError.openRemoteSettings": "Відкрити віддалені інстанси",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.title": "На віддаленому хості немає Node.js 22+",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance": "Встановіть Node.js 22 або 24 LTS на віддаленій машині (nvm, fnm або системний пакет). Оболонка входу лише з Node 18/20 недостатня, якщо у стандартному шляху немає бінарника 22+.",
  "desktopHostSwitcher.sshError.packageManagerMissing.title": "На віддаленому хості немає npm або bun",
  "desktopHostSwitcher.sshError.packageManagerMissing.guidance": "Встановіть npm (йде з Node.js) або bun на віддаленій машині й повторіть спробу. OpenChamber потребує одного з них, щоб установити Host CLI.",
  "desktopHostSwitcher.sshError.nativeBinding.title": "Не вдалося зібрати віддалений модуль бази даних",
  "desktopHostSwitcher.sshError.nativeBinding.guidance": "Встановіть Node.js 22 або 24 LTS на віддаленому хості. Непарні версії на кшталт Node 23 часто не мають готового бінарника і потребують python3, gcc і make. Коли буде LTS, підключіться знову.",
  "desktopHostSwitcher.sshError.openchamberCliMissing.title": "На віддаленому хості не знайдено команду OpenChamber",
  "desktopHostSwitcher.sshError.openchamberCliMissing.guidance": "Встановлення завершилось, але openchamber --version не повернув придатної версії. Перевірте, що ~/.bun/bin або глобальний bin npm є в PATH, і повторіть спробу. Також можна виконати openchamber --version через SSH.",
  "desktopHostSwitcher.sshError.openchamberRegistry.title": "Не вдалося завантажити OpenChamber на віддаленому хості",
  "desktopHostSwitcher.sshError.openchamberRegistry.guidance": "Віддалений хост не може досягти реєстру npm або налаштованого дзеркала. Перевірте мережу, проксі й npm registry і повторіть спробу. Можна також самостійно встановити @openchambery/web за допомогою Node 22 або 24 і npm.",
  "desktopHostSwitcher.sshError.openchamberInstall.title": "Не вдалося встановити OpenChamber на віддаленому хості",
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "bun або npm не зміг встановити @openchambery/web. Перегляньте вивід менеджера пакетів у SSH-журналах цього хоста й повторіть спробу. Можна також самостійно встановити @openchambery/web за допомогою Node 22 або 24.",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.title": "Віддалений CLI OpenChamber застарілий",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance": "Віддалений CLI відхилив прапорець, який надіслав цей робочий стіл (наприклад --relay-host). Оновіть @openchambery/web на віддаленому хості до збірки з SSH relay host і повторіть спробу.",
  "desktopHostSwitcher.sshError.opencodeInstall.title": "Не вдалося встановити OpenCode CLI на віддаленому хості",
  "desktopHostSwitcher.sshError.opencodeInstall.guidance": "Перевірте віддалену мережу й менеджер пакетів і повторіть спробу. OpenCode CLI також можна встановити вручну.",
  "desktopHostSwitcher.sshError.serverStart.title": "Віддалений сервер OpenChamber не запустився",
  "desktopHostSwitcher.sshError.serverStart.guidance": "SSH з’єднався, але процес Host не став доступним. Переконайтеся, що віддалений хост на Node 22/24 і вибраний порт вільний, потім повторіть спробу.",
  "desktopHostSwitcher.sshError.sshAuth.title": "Помилка автентифікації SSH",
  "desktopHostSwitcher.sshError.sshAuth.guidance": "Перевірте ключ SSH, пароль і призначення в Параметрах → Віддалені інстанси. Ініціалізація не завершиться, доки вхід SSH не вдасться.",
  "desktopHostSwitcher.sshError.sshUnreachable.title": "Не вдалося досягти SSH-хоста",
  "desktopHostSwitcher.sshError.sshUnreachable.guidance": "Перевірте ім’я хоста, порт і мережу (спочатку підключіть VPN або бастіон, якщо потрібно) і повторіть спробу.",
  "desktopHostSwitcher.sshError.timeout.title": "Час очікування SSH-з’єднання вичерпано",
  "desktopHostSwitcher.sshError.timeout.guidance": "Віддалений хост не завершив ініціалізацію вчасно. Перевірте мережу й наявність Node 22 або 24 і повторіть спробу.",
  "desktopHostSwitcher.sshError.unknown.title": "Не вдалося запустити віддалений інстанс",
  "desktopHostSwitcher.sshError.unknown.guidance": "Віддалена ініціалізація не вдалася. Подивіться точну помилку нижче або відкрийте Параметри → Віддалені інстанси й перевірте SSH-журнали цього хоста.",
  ...
  "updateDialog.status.otaBundleReused": "Використано раніше завантажений пакет оновлення. Повторне завантаження не потрібне.",
  ...
  "updateDialog.actions.applyOtaNow": "Оновити зараз",
  "updateDialog.actions.later": "Пізніше",
  ...
  "mobileUpdate.ota.toast.available.title": "Доступне оновлення",
  "mobileUpdate.ota.toast.available.description": "Версія {version} готова до встановлення.",
  "mobileUpdate.ota.toast.actions.update": "Оновити",
  "mobileUpdate.ota.toast.actions.dismiss": "Сховати",
  ...
  "common.relative.justNow": "Щойно",
  "common.relative.minutesAgoShort": "{count} хв тому",
  "common.relative.hoursAgoShort": "{count} год тому",
  "common.relative.daysAgoShort": "{count} дн. тому",
  "common.relative.weeksAgoShort": "{count} тиж. тому",
  "common.relative.yearsAgoShort": "{count} р. тому",
  "common.relative.minutesAgoCompact": "{count} хв тому",
  "common.relative.hoursAgoCompact": "{count} год тому",
  "common.relative.daysAgoCompact": "{count} дн. тому",
  "common.relative.weeksAgoCompact": "{count} тиж. тому",
  "common.relative.monthsAgoCompact": "{count} міс. тому",
  "common.relative.yearsAgoCompact": "{count} р. тому",
  ...
  "header.workStatusPanel.toggleAria": "Перемкнути статус роботи",
  "chat.workStatus.ariaLabel": "Статус роботи",
  "chat.workStatus.section.session": "Сесія",
  "chat.workStatus.section.project": "Проєкт",
  "chat.workStatus.section.usage": "Використання",
  "chat.workStatus.section.telemetry": "Статистика кроку",
  "chat.workStatus.section.subagents": "Субагенти",
  "chat.workStatus.section.mcp": "MCP",
  "chat.workStatus.section.contextSources": "Джерела контексту",
  "chat.workStatus.context.label": "Контекст",
  "chat.workStatus.cost.breakdown": "Сесія {session} · Субагенти {subagents}",
  "chat.workStatus.git.changedFileSingle": "Змінено {count} файл",
  "chat.workStatus.git.changedFilePlural": "Змінено {count} файлів",
  "chat.workStatus.pr.untitled": "Запит на злиття без назви",
  "chat.workStatus.pr.draft": "Чернетка",
  "chat.workStatus.pr.checks": "Перевірки",
  "chat.workStatus.pr.checksFailed": "{count} не вдалося",
  ...
  "chat.workStatus.action.copyBranch": "Копіювати назву гілки",
  "chat.workStatus.action.openChanges": "Відкрити зміни",
  "chat.workStatus.action.openPr": "Відкрити запит на злиття",
  ...
  "chat.workStatus.subagent.needsPermission": "чекає дозволу",
  "chat.workStatus.subagent.askedQuestion": "поставив питання",
  "chat.workStatus.subagent.done": "Готово",
  "chat.workStatus.subagent.workingCount": "{count} працюють",
  "chat.workStatus.subagent.doneCount": "{count} завершено",
  ...
  "chat.workStatus.goal.resume": "Продовжити",
  "chat.workStatus.goal.updateFailed": "Не вдалося оновити ціль",
  "chat.workStatus.sections.open": "Вибрати розділи",
  "chat.workStatus.sections.allHidden": "Усі розділи приховано",
  "chat.workStatus.sections.showAll": "Показати всі",
  "chat.workStatus.sections.dialogTitle": "Розділи статусу роботи",
  "chat.workStatus.sections.dialogDescription": "Виберіть розділи картки. Перетягніть, щоб змінити порядок.",
  "chat.workStatus.breakdown.skills": "Навички",
  "chat.workStatus.breakdown.mcp": "Сервери MCP",
  "chat.workStatus.telemetry.tokens": "Токени",
  "chat.workStatus.telemetry.duration": "Тривалість",
  "chat.workStatus.telemetry.cost": "Вартість",
  "chat.workStatus.usage.refresh": "Оновити квоти",
  "chat.workStatus.compact.onBranch": "На {branch}",
  "chat.workStatus.compact.changes": "Зміни",
  "opencodeUpgrade.screen.title": "Потрібен OpenCode 2.0.15",
  "opencodeUpgrade.screen.outdatedTitle": "Оновити OpenCode",
  "opencodeUpgrade.screen.local": "Встановлено OpenCode {version}. Цій версії OpenChamber потрібен OpenCode v2.",
  "opencodeUpgrade.screen.outdatedLocal": "Встановлено OpenCode {version}. Цій версії OpenChamber потрібен OpenCode {minimum} або новіший.",
  "opencodeUpgrade.screen.external": "Підключений сервер працює на OpenCode {version}. Встановіть OpenCode v2 на цьому сервері й перевірте знову.",
  "opencodeUpgrade.screen.outdatedExternal": "Підключений сервер працює на OpenCode {version}. Оновіть його до OpenCode {minimum} або новішого й перевірте знову.",
  "opencodeUpgrade.screen.bundled": "OpenCode {version} входить до складу OpenChamber і старіший за {minimum}. Можна встановити керовану копію, не змінюючи вкладений двійковий файл.",
  "opencodeUpgrade.screen.installDescription": "OpenChamber встановить OpenCode {minimum} або новіший у керований кеш і перезапустить процес. Наявні файли OpenCode не перезаписуються.",
  "opencodeUpgrade.screen.install": "Встановити OpenCode {minimum}",
  "opencodeUpgrade.screen.update": "Оновити до OpenCode {minimum}",
  "opencodeUpgrade.screen.installing": "Встановлення OpenCode…",
  "opencodeUpgrade.screen.updating": "Оновлення OpenCode…",
  "opencodeUpgrade.screen.reconnect": "Перевірити знову",
  "opencodeUpgrade.screen.reconnecting": "Перевірка…",
  "opencodeUpgrade.screen.failedTitle": "OpenCode не оновлено",
  "opencodeUpgrade.screen.failedGeneric": "Встановлення не завершилося. OpenCode лишився на попередній версії.",
  "opencodeUpgrade.screen.guide": "Посібник зі встановлення",
  "opencodeUpgrade.screen.manualGuidance": "Автоматичне встановлення недоступне для цього runtime. Оновіть OpenCode самостійно й перевірте знову.",
};
