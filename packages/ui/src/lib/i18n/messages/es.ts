...
export const dict: Record<I18nKey, string> = {
  'chat.chatInput.stopUnconfirmed': 'La detención aún no está confirmada. Inténtalo de nuevo.',
  'chat.response.rateLimit': 'Se alcanzó el límite de solicitudes del proveedor',
  'chat.response.auth': 'Falló la autenticación del proveedor. Inicia sesión de nuevo y reintenta.',
  'chat.response.quota': 'Cuota del proveedor agotada',
  'chat.response.contentFilter': 'El proveedor bloqueó la respuesta',
  'chat.response.transport': 'Falló la conexión con el proveedor',
  'chat.response.internal': 'Error interno del proveedor',
  'chat.response.invalidOutput': 'Respuesta no válida del proveedor',
  'chat.response.invalidRequest': 'El proveedor rechazó la solicitud',
  'chat.response.unsupportedOperation': 'El proveedor no admite esta operación',
  'chat.response.noRoute': 'Modelo o configuración del proveedor no disponible',
  'chat.response.providerUnknown': 'Error del proveedor',
  'chat.response.timeout': 'La solicitud al proveedor agotó el tiempo de espera',
  'chat.response.permissionRejected': 'Permiso denegado',
  'chat.response.toolExecution': 'Falló la ejecución de la herramienta',
  'chat.response.compactionFailed': 'Falló la compactación del contexto',
  'chat.response.compactionUnavailable': 'Todavía no hay contenido para compactar',
  'chat.response.compactionInterrupted': 'Compactación del contexto interrumpida',
  'chat.response.compactionCancelled': 'Compactación del contexto cancelada',
  'chat.response.stopped': 'Detenido por el usuario',
  'chat.response.interrupted': 'Respuesta interrumpida',
  'chat.response.toolInterrupted': 'Ejecución de la herramienta interrumpida',
  'chat.response.resumeExhausted': 'Recuperación automática detenida tras interrupciones repetidas',
  'chat.response.retrying': 'Reintentando automáticamente',
  'chat.response.failed': 'La ejecución falló',
  'chat.response.continuingAfterRestart': 'Continuando después del reinicio',
  'chat.queuedMessage.inheritsSessionSelection': 'Hereda el modelo, el agente y la variante de la sesión al ejecutarse.',
  'chat.sessionRecovery.awaitingConfirmation': 'Servicio reiniciado. Esperando confirmar el estado de la tarea.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': 'Error al generar la respuesta. Vuelve a intentarlo.',
  'chat.btw.description': 'Pregunta sobre la conversación manteniendo su historial intacto.',
  'chat.btw.placeholder': 'Pregunta en Side Chat…',
  'chat.btw.removeQuoteAria': 'Quitar cita',
  'chat.message.conversationQuotesLabel': 'Citado de la conversación',
  'chat.btw.sessionRequired': 'Abre una conversación existente para iniciar Side Chat.',
  'chat.btw.plainTextRequired': 'Usa texto sin formato. Tus referencias se conservan en el editor.',
  'chat.btw.pending': 'Preparando la respuesta…',
  'chat.btw.cancelled': 'Respuesta cancelada. Vuelve a intentarlo para preguntar de nuevo.',
  'chat.btw.resize': 'Cambiar el tamaño del panel de Side Chat',
  ...settingsDict,
  'chat.questionDelegate.countdown': 'El modelo decidirá en {seconds} s',
  'chat.questionDelegate.awaiting': 'Esperando confirmación…',
  'chat.questionDelegate.pausing': 'Pausando la cuenta atrás…',
  'chat.questionDelegate.paused': 'Cuenta atrás pausada',
  'chat.questionDelegate.disabled': 'Cuenta atrás automática desactivada',
  'chat.questionDelegate.refreshStatus': 'Actualizar estado',
  'chat.questionDelegate.submitting': 'Enviando respuesta…',
  'chat.questionDelegate.uncertain': 'El resultado del envío es incierto. Esperando confirmación.',
  'chat.questionDelegate.settled': 'Pregunta resuelta',
  'chat.questionDelegate.success': 'Se envió la respuesta para continuar. El modelo decidirá cómo proceder.',
  'chat.questionDelegate.stale': 'Se muestra el último estado conocido; la actualización está en curso.',
  'chat.questionDelegate.pauseFailed': 'Error al pausar. La cuenta atrás puede seguir activa.',
  'chat.questionDelegate.delegateFailed': 'Error al delegar. Comprueba el estado y vuelve a intentarlo.',
  'chat.questionDelegate.loadFailed': 'Error al actualizar el estado de delegación.',
  'chat.questionDelegate.retry': 'Reintentar',
  'chat.questionDelegate.pause': 'Pausar cuenta atrás',
  'chat.questionDelegate.delegate': 'Delegar ahora',
  ...
  "mobile.connect.link.divider": "O usa un enlace de emparejamiento",
  "mobile.connect.address.divider": "O introduce la dirección del servidor",
  "mobile.connect.link.label": "Enlace de emparejamiento",
  "mobile.connect.link.placeholder": "Pega el enlace openchamber://connect",
  "mobile.connect.link.invalid": "Ese enlace de emparejamiento no es válido o ha caducado.",
  ...
  "mobile.connect.manual.toggle": "Conexión manual",
  ...
  "mobile.instances.status.connected": "Conectado",
  "mobile.instances.status.saved": "Guardado",
  "mobile.instances.status.connectedDirect": "Conectado · Red local",
  "mobile.instances.status.connectedRelay": "Conectado · Relay",
  "mobile.instances.status.connectedSshRelay": "Conectado · SSH por relay",
  "mobile.instances.sshBadge": "SSH",
  "mobile.instances.sshViaDesktop": "Enrutado por el escritorio a SSH",
  "mobile.connect.error.sshNotConnected": "Esa instancia SSH no está conectada ahora.",
  "mobile.connect.ssh.fallbackDesktop": "Instancia SSH no disponible: se conectó al escritorio.",
  ...
  "mobile.select.sheetAria": "Seleccionar una opción",
  ...
  "mobile.menu.newSession": "Nuevo chat",
  ...
  "mobile.projects.menu.label": "Más acciones",
  "mobile.projects.menu.newChat": "Nueva conversación",
  "mobile.projects.menu.newProject": "Nuevo proyecto",
  "mobile.projects.menu.scanQr": "Escanear código QR",
  "mobile.projects.menu.switchInstance": "Cambiar instancia",
  ...
  "mobile.sessions.startNewChat": "Nuevo chat",
  ...
  "mobile.projects.closeConfirmMessage": "¿Cerrar “{title}”? Saldrá de tu lista de proyectos. Las sesiones se quedan en el disco.",
  ...
  "mobile.sessions.stopSessionAria": "Detener {title}",
  "mobile.sessions.stopGroupAria": "Detener todas las sesiones en ejecución en {label}",
  "mobile.sessions.stopSubsessionsAria": "Detener subsessions en ejecución de {title}",
  ...
  "mobile.sessions.sheet.title": "Conversaciones recientes",
  "mobile.sessions.sheet.resizeAria": "Cambiar el tamaño del panel de sesiones",
  "mobile.changes.sheet.resizeAria": "Cambiar el tamaño del panel de cambios",
  ...
  "mobile.sessions.newSessionAria": "Iniciar un nuevo chat en este proyecto",
  ...
  "mobile.files.html.fullscreenAria": "Abrir vista previa a pantalla completa",
  "mobile.files.html.exitFullscreenAria": "Salir de pantalla completa",
  "mobile.files.html.viewSourceAria": "Ver código fuente",
  "mobile.files.html.viewPreviewAria": "Ver vista previa",
  ...
  "layout.rightSidebar.browser": "Navegador",
  "layout.browserProvider.noSurface": "{name} no tiene vista en vivo.",
  "layout.browserProvider.status.connecting": "Conectando…",
  "layout.browserProvider.status.reconnecting": "Conexión perdida. Reconectando…",
  "layout.browserProvider.status.ready": "Haz clic o escribe para tomar el control",
  "layout.browserProvider.status.readyFocused": "Escribe para controlar la vista; haz clic fuera para salir",
  "layout.browserProvider.status.agentWorking": "El agente está trabajando",
  "layout.browserProvider.status.youControl": "Tienes el control",
  "layout.browserProvider.status.otherControls": "Otro dispositivo tiene el control",
  "layout.browserProvider.handBack": "Devolver a la extensión",
  "layout.browserProvider.retry": "Reintentar",
  "layout.browserProvider.canvasAria": "Vista en vivo de {name}",
  "layout.browserProvider.ended.service-stopped": "El servicio de la extensión se detuvo.",
  "layout.browserProvider.ended.extension-unavailable": "La extensión no está disponible.",
  "layout.browserProvider.ended.host-shutdown": "OpenChamber se está cerrando.",
  ...
  "sessions.scheduledTasks.dialog.actions.create": "Crear",
  "sessions.scheduledTasks.dialog.actions.moreAria": "Más acciones para {taskName}",
  "sessions.scheduledTasks.dialog.actions.delete": "Eliminar",
  "sessions.scheduledTasks.dialog.actions.pause": "Pausar",
  "sessions.scheduledTasks.dialog.actions.resume": "Reanudar",
  "sessions.scheduledTasks.workspace.filters.all": "Todas",
  "sessions.scheduledTasks.workspace.filters.active": "Activas",
  "sessions.scheduledTasks.workspace.filters.paused": "En pausa",
  "sessions.scheduledTasks.workspace.views.aria": "Vistas de tareas programadas",
  "sessions.scheduledTasks.workspace.views.tasks": "Tareas",
  "sessions.scheduledTasks.workspace.views.history": "Historial",
  "sessions.scheduledTasks.history.loading": "Cargando historial de ejecuciones…",
  "sessions.scheduledTasks.history.error.title": "No se pudo cargar el historial",
  "sessions.scheduledTasks.history.error.description": "OpenChamber no pudo cargar las ejecuciones registradas.",
  "sessions.scheduledTasks.history.error.more": "No se pudieron cargar más ejecuciones. El historial cargado sigue disponible.",
  "sessions.scheduledTasks.history.retry": "Reintentar",
  "sessions.scheduledTasks.history.empty.title": "Aún no hay ejecuciones",
  "sessions.scheduledTasks.history.empty.description": "Las ejecuciones programadas y manuales aparecerán aquí.",
  "sessions.scheduledTasks.history.trigger.scheduled": "Programada",
  "sessions.scheduledTasks.history.trigger.manual": "Manual",
  "sessions.scheduledTasks.history.meta.trigger": "Disparo",
  "sessions.scheduledTasks.history.meta.started": "Inicio",
  "sessions.scheduledTasks.history.meta.ended": "Fin",
  "sessions.scheduledTasks.history.meta.duration": "Duración",
  "sessions.scheduledTasks.history.ended.unavailable": "—",
  "sessions.scheduledTasks.history.duration.pending": "En curso",
  "sessions.scheduledTasks.history.duration.lessThanOneSecond": "<1 s",
  "sessions.scheduledTasks.history.duration.milliseconds": "{count} ms",
  "sessions.scheduledTasks.history.duration.seconds": "{count} s",
  "sessions.scheduledTasks.history.duration.minutesSeconds": "{minutes} min {seconds} s",
  "sessions.scheduledTasks.history.duration.minutes": "{count} min",
  ...
  "sessions.scheduledTasks.history.loadingMore": "Cargando más…",
  "sessions.scheduledTasks.history.loadMore": "Cargar más",
  "sessions.scheduledTasks.workspace.search.placeholder": "Buscar tareas…",
  "sessions.scheduledTasks.workspace.search.noResults": "Ninguna tarea coincide con la búsqueda.",
  "sessions.scheduledTasks.workspace.partialLoadWarning": "No se pudieron cargar las tareas programadas de algunos proyectos. Las tareas cargadas siguen disponibles.",
  "sessions.scheduledTasks.workspace.editor.emptyTitle": "Selecciona una tarea",
  "sessions.scheduledTasks.workspace.editor.emptyDescription": "Elige una tarea de la lista o crea una nueva.",
  "sessions.scheduledTasks.workspace.confirm.discardChanges": "Los cambios sin guardar se descartarán. ¿Continuar?",
  "sessions.scheduledTasks.editor.panel.details": "Detalles",
  "sessions.scheduledTasks.editor.panel.frequency": "Frecuencia",
  ...
  "sessions.sidebar.header.actions.sessionDisplayMode": "Acciones de expandir/contraer proyectos",
  "sessions.sidebar.header.displayMode.label": "Expandir/contraer proyectos",
  ...
  "sessions.sidebar.projectsTitle": "Proyectos",
  "sessions.sidebar.projectsSyncing": "Sincronizando sesiones…",
  "sessions.sidebar.project.loadingSessions": "Cargando sesiones…",
  ...
  "sessions.sidebar.bulkActions.archiveUndoFailed": "No se pudieron restaurar {count} sesiones",
  "sessions.sidebar.undo": "Deshacer",
  "sessions.sidebar.openSettings": "Ajustes",
  ...
  "sessions.sidebar.project.actions.syncSessions": "Sincronizar sesiones",
  ...
  "sessions.sidebar.session.menu.refreshTranscript": "Sincronizar mensajes",
  "sessions.sidebar.session.menu.refreshTranscriptSuccess": "Mensajes sincronizados",
  "sessions.sidebar.session.menu.refreshTranscriptFailed": "No se pudieron sincronizar los mensajes",
  ...
  "sessions.sidebar.session.actions.pinned": "Fijado",
  "sessions.sidebar.session.status.permissionRequired": "Permiso requerido",
  "sessions.sidebar.session.status.questionRequired": "Pregunta pendiente",
  ...
  "sessions.sidebar.session.archive.undoFailed": "No se pudo deshacer el archivado",
  ...
  "sessions.sidebar.group.showMore": "Más",
  ...
  "sessions.sidebar.group.showFewer": "Menos",
  ...
  "gitView.changes.deferredTitle": "{count} archivos modificados",
  "gitView.changes.deferredStagedCount": "Preparados: {count}",
  "gitView.changes.deferredUnstagedCount": "Sin preparar: {count}",
  "gitView.changes.deferredHint": "Los conjuntos de cambios muy grandes no se muestran automáticamente para mantener la aplicación fluida.",
  "gitView.changes.deferredLoadAction": "Cargar cambios",
  ...
  "contextPanel.file.notice.turnDiffOutsideWorkspace": "El diff del turno no está disponible fuera del proyecto. Se muestra el contenido actual del archivo.",
  ...
  "sidebarFilesTree.actions.collapseAllTitle": "Contraer todo",
  "sidebarFilesTree.actions.expandAllTitle": "Expandir todo",
  ...
  "contextUsage.pending": "Pendiente de actualización",
  "contextUsage.pendingDescription": "Contexto compactado. El uso se actualizará cuando la siguiente respuesta del modelo indique el número de tokens.",
  ...
  "contextUsage.tooltip.usage": "Uso: {percent}",
  "contextUsage.tooltip.usedOfLimit": "{used} / {limit}",
  ...
  "contextSidebar.empty.openSession": "Abre una sesión para inspeccionar el uso.",
  "contextSidebar.section.context": "Uso",
  ...
  "contextSidebar.stats.sessionTps": "TPS de la sesión",
  ...
  "diffView.actions.openFilePreview": "Abrir este archivo",
  ...
  'chat.history.loadingMore': 'Cargando más…',
  'chat.history.loadOlderFailed': 'No se pudieron cargar los mensajes anteriores. Inténtalo de nuevo.',
  'chat.history.loadOlderTimeout': 'La carga de mensajes anteriores agotó el tiempo de espera. Inténtalo de nuevo.',
  'chat.history.loadFailedTitle': 'No se pudo cargar esta conversación',
  'chat.history.loadFailedDescription': 'La conversación sigue disponible. Intenta cargarla de nuevo.',
  'chat.history.retry': 'Intentar de nuevo',
  ...
  "header.services.openWithCurrent": "Cambiar de instancia (actual: {current})",
  "header.services.open": "Cambiar de instancia",
  "header.services.tooltip.currentInstanceWithShortcuts": "Cambiar de instancia: {current} ({toggle}; siguiente pestaña {nextTab})",
  "header.services.tooltip.servicesWithShortcuts": "Cambiar de instancia ({toggle}; siguiente pestaña {nextTab})",
  "header.services.title": "Cambiar de instancia",
  "header.services.viewAria": "Cambiar de instancia",
  "header.services.closeAria": "Cerrar el selector de instancia",
  ...
  "header.actions.sessionMenu": "Acciones de sesión",
  "header.actions.sessionMenuAria": "Abrir menú de acciones de sesión",
  "header.actions.sessionMenu.servicesWithInstance": "Cambiar de instancia ({current})",
  "header.actions.sessionMenu.viewUsage": "Ver uso",
  ...
  "chat.goal.usage.tokens": "{used}",
  "chat.goal.usage.tokensWithBudget": "{used}/{budget}",
  ...
  "directoryTree.section.pinnedInProgress": "Fijados / En progreso",
  ...
  "helpDialog.item.previousSession": "Sesión anterior",
  "helpDialog.item.nextSession": "Sesión siguiente",
  ...
  "helpDialog.item.toggleRightSidebar": "Mostrar u ocultar panel de revisión",
  ...
  "helpDialog.item.closeContextPanelTab": "Cerrar pestaña del panel de contexto",
  "helpDialog.item.toggleTerminal": "Mostrar u ocultar terminal",
  "helpDialog.item.newTerminalTab": "Nueva pestaña de terminal (con el terminal enfocado)",
  "helpDialog.item.openNewTerminal": "Abrir terminal nuevo",
  "helpDialog.item.previousTerminalTab": "Pestaña de terminal anterior (con el terminal enfocado)",
  "helpDialog.item.nextTerminalTab": "Pestaña de terminal siguiente (con el terminal enfocado)",
  "helpDialog.item.toggleBottomPanel": "Mostrar u ocultar el panel inferior",
  ...
  "helpDialog.item.zoomIn": "Acercar",
  "helpDialog.item.zoomOut": "Alejar",
  ...
  "helpDialog.item.leaderOpenModel": "Abrir selector de modelo",
  "helpDialog.item.leaderOpenAgent": "Abrir selector de agente",
  "helpDialog.item.leaderNewSession": "Crear nueva sesión",
  "helpDialog.item.leaderCompact": "Compactar sesión actual",
  "chat.leaderKey.pendingAria": "Tecla líder activa. Pulsa una tecla de seguimiento.",
  "chat.leaderKey.action.model": "Modelo",
  "chat.leaderKey.action.agent": "Agente",
  "chat.leaderKey.action.newSession": "Nueva",
  "chat.leaderKey.action.compact": "Compactar",
  ...
  "helpDialog.proTips.recentSessions": "Los nueve chats más recientes aparecen en la búsqueda global",
  ...
  "chat.fileAttachment.actions.expandImages": "Mostrar más imágenes",
  "chat.fileAttachment.actions.collapseImages": "Mostrar menos imágenes",
  ...
  "chat.activity.title": "Detalles del procesamiento",
  "chat.activity.active": "Procesando",
  "chat.activity.compacting": "Comprimiendo",
  "chat.activity.compactionCompleted": "Compresión completada",
  "chat.activity.compactionFailed": "Falló la compactación",
  "chat.activity.expandAria": "Expandir detalles del procesamiento",
  "chat.activity.collapseAria": "Contraer detalles del procesamiento",
  "chat.activity.completed": "Procesado en {duration}",
  "chat.activity.completedStatus": "Procesado",
  "chat.activity.agentsWorking": "{count} agentes trabajando",
  "chat.activity.agentsInvolved": "{count} agentes involucrados",
  "chat.activity.moreHidden": "+{count} más...",
  ...
  "chat.emptyState.establishingConversation": "Estableciendo conversación",
  ...
  "chat.draftStarters.remove": "Quitar",
  "chat.draftStarters.expand": "Mostrar más",
  "chat.draftStarters.collapse": "Mostrar menos",
  ...
  "chat.statusRow.abortPrompt": "Pulsa Esc de nuevo para detener",
  "chat.assistantStatus.readingFile": "Leyendo archivo",
  "chat.assistantStatus.writingFile": "Escribiendo archivo",
  "chat.assistantStatus.editingFile": "Editando archivo",
  "chat.assistantStatus.compacting": "Comprimiendo",
  "chat.assistantStatus.applyingPatch": "Aplicando parche",
  "chat.assistantStatus.runningCommand": "Ejecutando comando",
  "chat.assistantStatus.searchingContent": "Buscando contenido",
  ...
  "chat.assistantStatus.updatingTodos": "Actualizando tareas",
  "chat.assistantStatus.readingTodos": "Leyendo tareas",
  "chat.assistantStatus.learningSkill": "Aprendiendo habilidad",
  "chat.assistantStatus.askingQuestion": "Haciendo pregunta",
  "chat.assistantStatus.executing": "Ejecutando código",
  "chat.assistantStatus.renamingSession": "Renombrando la sesión",
  "chat.assistantStatus.movingSession": "Moviendo la sesión",
  "chat.assistantStatus.usingBrowser": "Usando el navegador",
  "chat.assistantStatus.usingTool": "Usando {tool}",
  "chat.assistantStatus.working": "Trabajando",
  "chat.assistantStatus.processing": "Procesando",
  "chat.assistantStatus.preparing": "Preparando",
  "chat.assistantStatus.warmingUp": "Preparando el entorno",
  "chat.assistantStatus.gearsTurning": "En marcha",
  "chat.assistantStatus.computing": "Computando",
  "chat.assistantStatus.calculating": "Calculando",
  "chat.assistantStatus.analyzing": "Analizando",
  "chat.assistantStatus.wheelsSpinning": "En funcionamiento",
  "chat.assistantStatus.calibrating": "Calibrando",
  "chat.assistantStatus.synthesizing": "Sintetizando",
  "chat.assistantStatus.connectingDots": "Conectando ideas",
  "chat.assistantStatus.inspectingLogic": "Revisando lógica",
  ...
  "chat.assistantStatus.retryingAttempt": "Reintentando (intento {attempt})",
  "chat.assistantStatus.retryingInAttempt": "Reintentando {duration} (intento {attempt})",
  ...
  "chat.revertPopover.files": "Archivos que cambiarán",
  ...
  "chat.revert.toast.busy": "No se puede revertir mientras la sesión está ocupada",
  "chat.form.title": "Formulario",
  "chat.form.reply": "Enviar",
  "chat.form.cancel": "Cancelar",
  "chat.retry.action.quota": "Límite de uso alcanzado",
  "chat.retry.action.account": "Límite de la cuenta alcanzado",
  "chat.retry.action.open": "Abrir",
  ...
  "chat.commandAutocomplete.command.reloadDescription": "Recargar la configuración, los proveedores y los complementos de OpenCode sin reiniciar",
  "chat.commandAutocomplete.command.newDescription": "Iniciar una nueva sesión en el proyecto actual.",
  ...
  "chat.fileMentionAutocomplete.groups.skills": "Habilidades",
  "chat.fileMentionAutocomplete.groups.agents": "Agentes",
  "chat.fileMentionAutocomplete.groups.sessions": "Sesiones cargadas",
  "chat.fileMentionAutocomplete.groups.directories": "Directorios",
  "chat.fileMentionAutocomplete.groups.recentFiles": "Archivos recientes",
  "chat.fileMentionAutocomplete.groups.files": "Archivos",
  "chat.fileMentionAutocomplete.sessionType": "Sesión de OpenCode",
  "chat.fileMentionAutocomplete.untitledSession": "Sesión sin título",
  ...
  "chat.queuedMessage.title": "Cola",
  "chat.queuedMessage.edit": "editar",
  "chat.queuedMessage.send": "guiar",
  "chat.queuedMessage.queuing": "Encolando…",
  "chat.queuedMessage.queuingAria": "Encolando mensaje",
  "chat.queuedMessage.waitingForCompaction": "Esperando la compactación",
  "chat.queuedMessage.waitingForCompactionAria": "Esperando a que termine la compactación",
  "chat.queuedMessage.sending": "Guiando…",
  "chat.queuedMessage.sendingAria": "Guiando el mensaje",
  ...
  "chat.textSelection.actions.addToSideChat": "Añadir al chat lateral",
  "chat.textSelection.title.addToCurrentChat": "Añadir al chat actual",
  "chat.messageBody.aborted": "Generación detenida",
  "chat.messageBody.actions.editing": "Editando…",
  "chat.messageBody.actions.editStaged": "Edición pendiente",
  "chat.messageBody.actions.cancelEdit": "Cancelar la edición",
  "chat.messageBody.actions.editAria": "Editar el mensaje y conservar los cambios",
  "chat.messageBody.actions.edit": "Editar y conservar los cambios",
  ...
  "chat.messageBody.actions.openSourceSessionAria": "Abrir sesión original",
  "chat.messageBody.actions.openSourceSession": "Abrir sesión original",
  ...
  "chat.messageBody.meta.tpsAria": "Velocidad de generación: {rate}",
  "chat.messageBody.meta.tpsTooltip": "Velocidad de generación (tokens/s), sin incluir el tiempo de las herramientas",
  ...
  "chat.forkTransition.preparing": "Preparando la bifurcación",
  "chat.forkTransition.copying": "Copiando la conversación (las sesiones largas pueden tardar)",
  "chat.forkTransition.opening": "Abriendo la nueva sesión",
  "chat.forkTransition.loading": "Cargando mensajes recientes",
  "chat.forkTransition.progress": "{current} / {total}",
  ...
  "chat.chatInput.actions.attachCancel": "Cancelar",
  ...
  "chat.chatInput.actions.queuingMessageAria": "Encolando…",
  "chat.chatInput.actions.sendingMessageAria": "Enviando…",
  ...
  "chat.chatInput.toast.reloadStarted": "Recargando la configuración…",
  "chat.chatInput.toast.reloadSucceeded": "Configuración recargada",
  "chat.chatInput.toast.reloadFailed": "No se pudo recargar la configuración",
  ...
  "chat.chatInput.toast.sendStatusUnknown": "Estado del mensaje desconocido. Verifique e intente de nuevo.",
  "chat.chatInput.toast.queueOperationFailed": "La operación de la cola falló.",
  "chat.chatInput.toast.queueOperationStatusUnknown": "Se desconoce el estado de la operación de la cola. El estado del servidor se actualizará automáticamente.",
  ...
  "chat.chatInput.toast.sessionReferenceLoadFailed": "No se pudo cargar la referencia de la sesión.",
  ...
  "chat.chatInput.draftPicker.newProject": "Nuevo proyecto",
  ...
  "chat.chatInput.branchSwitch.title": "¿Cambiar a {branch}?",
  "chat.chatInput.branchSwitch.description": "¿Cómo quieres abrir esta rama para la nueva conversación?",
  "chat.chatInput.branchSwitch.createWorktree": "Crear worktree",
  "chat.chatInput.branchSwitch.createWorktreeDescription": "Mantén el directorio actual y trabaja en un worktree aislado.",
  "chat.chatInput.branchSwitch.checkoutHere": "Hacer checkout aquí",
  "chat.chatInput.branchSwitch.checkoutHereDescription": "Cambia el directorio actual a esta rama.",
  "chat.chatInput.branchSwitch.cancel": "Cancelar",
  ...
  "chat.toolOutputDialog.image.zoomInAria": "Acercar",
  "chat.toolOutputDialog.image.zoomOutAria": "Alejar",
  "chat.toolOutputDialog.image.resetZoomAria": "Restablecer zoom",
  "chat.image.actions.sheetTitle": "Imagen",
  "chat.image.actions.saveImage": "Guardar imagen",
  "chat.image.actions.saveToPhotos": "Guardar en Fotos",
  "chat.image.actions.saving": "Guardando…",
  "chat.image.actions.saveSuccess": "Imagen guardada",
  "chat.image.actions.saveFailed": "No se pudo guardar la imagen",
  ...
  "chat.activity.outputLoading": "Cargando la salida completa…",
  "chat.activity.outputLoadFailed": "No se pudo cargar la salida completa.",
  "chat.activity.outputRetry": "Reintentar",
  "chat.fileAttachment.image.loading": "Cargando imagen…",
  "chat.fileAttachment.image.loadFailed": "No se pudo cargar la imagen.",
  "chat.fileAttachment.image.retry": "Reintentar la carga de la imagen",
  "chat.fileAttachment.image.loadManually": "Cargar imagen",
  "chat.fileAttachment.image.loadManuallyCount": "Cargar {count} imágenes",
  ...
  "chat.permissionCard.replaceAll": "Reemplazar todas las coincidencias",
  "chat.permissionCard.responseFormat": "Formato de respuesta:",
  "chat.permissionCard.allowOnce": "Permitir una vez",
  "chat.permissionCard.alwaysAgree": "Permitir siempre",
  ...
  "chat.modelControls.costPerMillion": "Costo",
  "chat.modelControls.costInput": "Entrada",
  "chat.modelControls.costOutput": "Salida",
  ...
  "chat.modelControls.keyboardHintSwitchAgentLabel": "Cambiar agente",
  ...
  "chat.contextGroup.exploring": "Explorando",
  "chat.contextGroup.explored": "Explorado",
  "chat.contextGroup.expandAria": "Expandir herramientas exploradas",
  "chat.contextGroup.collapseAria": "Contraer herramientas exploradas",
  "chat.contextGroup.readSingle": "{count} lectura",
  "chat.contextGroup.readPlural": "{count} lecturas",
  "chat.contextGroup.searchSingle": "{count} búsqueda",
  "chat.contextGroup.searchPlural": "{count} búsquedas",
  "chat.contextGroup.listSingle": "{count} lista",
  "chat.contextGroup.listPlural": "{count} listas",
  "chat.usedGroup.running": "En ejecución",
  "chat.usedGroup.used": "Usado",
  "chat.usedGroup.expandAria": "Expandir herramientas usadas",
  "chat.usedGroup.collapseAria": "Contraer herramientas usadas",
  "chat.usedGroup.editSingle": "{count} edición",
  "chat.usedGroup.editPlural": "{count} ediciones",
  "chat.usedGroup.commandSingle": "{count} comando",
  "chat.usedGroup.commandPlural": "{count} comandos",
  "chat.usedGroup.otherSingle": "{count} llamada",
  "chat.usedGroup.otherPlural": "{count} llamadas",
  "chat.skillGroup.expandAria": "Expandir skills cargadas",
  "chat.skillGroup.collapseAria": "Contraer skills cargadas",
  "chat.skillGroup.summaryOverflow": "{names} y {count} más",
  "chat.tools.display.read": "Leer archivo",
  "chat.tools.display.write": "Escribir archivo",
  "chat.tools.display.edit": "Editar archivo",
  "chat.tools.display.apply_patch": "Aplicar parche",
  "chat.tools.display.bash": "Comando de shell",
  "chat.tools.display.grep": "Buscar en archivos",
  "chat.tools.display.glob": "Buscar archivos",
  "chat.tools.display.list": "Listar directorio",
  "chat.tools.display.task": "Tarea de agente",
  "chat.tools.display.webfetch": "Obtener URL",
  "chat.tools.display.websearch": "Búsqueda web",
  "chat.tools.display.codesearch": "Búsqueda de código",
  "chat.tools.display.todowrite": "Actualizar lista de tareas",
  "chat.tools.display.todoread": "Leer lista de tareas",
  "chat.tools.display.skill": "Cargar skill",
  "chat.tools.display.question": "Pregunta",
  "chat.tools.display.lsp": "LSP",
  "chat.tools.display.structuredoutput": "Salida estructurada",
  "chat.tools.display.execute": "Ejecutar código",
  "chat.tools.display.session_rename": "Renombrar sesión",
  "chat.tools.display.session_move": "Mover sesión",
  "chat.tools.display.browser": "Navegador",
  ...
  "chat.messageBody.subagent.completed": "Completado",
  "chat.messageBody.subagent.error": "Fallido",
  "chat.messageBody.subagent.cancelled": "Cancelado",
  "chat.messageBody.subagent.completedDescription": "El subagente en segundo plano ha terminado",
  ...
  "chat.sessionBackground.moveRunning": "Mover a segundo plano",
  "chat.sessionBackground.moving": "Moviendo…",
  "chat.sessionBackground.moveFailed": "No se pudo mover el trabajo a segundo plano",
  "chat.sessionBackground.tasksRunning": "{count} tarea(s) en segundo plano",
  ...
  "commandPalette.title": "Búsqueda global",
  "commandPalette.error.sessions": "No se pudo cargar la búsqueda de chats. Los resultados disponibles siguen visibles.",
  ...
  "commandPalette.item.newTerminalTab": "Nueva pestaña de terminal",
  ...
  "desktopHostSwitcher.sshError.openRemoteSettings": "Abrir instancias remotas",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.title": "El host remoto no tiene Node.js 22+",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance": "Instala Node.js 22 o 24 LTS en la máquina remota (nvm, fnm o el paquete del sistema). Un shell de inicio que solo expone Node 18/20 no basta, salvo que exista un binario 22+ en una ruta estándar.",
  "desktopHostSwitcher.sshError.packageManagerMissing.title": "El host remoto no tiene npm ni bun",
  "desktopHostSwitcher.sshError.packageManagerMissing.guidance": "Instala npm (incluido con Node.js) o bun en la máquina remota y vuelve a intentarlo. OpenChamber necesita uno de ellos para instalar el CLI Host.",
  "desktopHostSwitcher.sshError.nativeBinding.title": "Falló la compilación del módulo de base de datos remoto",
  "desktopHostSwitcher.sshError.nativeBinding.guidance": "Instala Node.js 22 o 24 LTS en el host remoto. Las versiones impares como Node 23 suelen no tener binario prediseñado y necesitan python3, gcc y make. Cuando haya un runtime LTS, vuelve a conectar.",
  "desktopHostSwitcher.sshError.openchamberCliMissing.title": "No se encontró el comando OpenChamber en el remoto",
  "desktopHostSwitcher.sshError.openchamberCliMissing.guidance": "La instalación terminó, pero openchamber --version no devolvió una versión usable. Comprueba que ~/.bun/bin o el bin global de npm esté en el PATH y reintenta. También puedes ejecutar openchamber --version por SSH.",
  "desktopHostSwitcher.sshError.openchamberRegistry.title": "No se pudo descargar OpenChamber en el host remoto",
  "desktopHostSwitcher.sshError.openchamberRegistry.guidance": "El remoto no pudo alcanzar el registro npm ni el espejo configurado. Revisa la red, el proxy y el registry de npm, y reintenta. También puedes instalar @openchambery/web tú mismo con Node 22 o 24 y npm.",
  "desktopHostSwitcher.sshError.openchamberInstall.title": "No se pudo instalar OpenChamber en el host remoto",
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "bun o npm no pudieron instalar @openchambery/web. Revisa la salida del gestor de paquetes en los registros SSH de este host y reintenta. También puedes instalar @openchambery/web tú mismo con Node 22 o 24.",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.title": "El CLI remoto de OpenChamber es demasiado antiguo",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance": "El CLI remoto rechazó un flag que envió este escritorio (por ejemplo --relay-host). Actualiza @openchambery/web en el remoto a una versión con SSH relay host y reintenta.",
  "desktopHostSwitcher.sshError.opencodeInstall.title": "No se pudo instalar OpenCode CLI en el host remoto",
  "desktopHostSwitcher.sshError.opencodeInstall.guidance": "Revisa la red y el gestor de paquetes remotos y reintenta. También puedes instalar OpenCode CLI manualmente.",
  "desktopHostSwitcher.sshError.serverStart.title": "El servidor OpenChamber remoto no arrancó",
  "desktopHostSwitcher.sshError.serverStart.guidance": "SSH conectó, pero el proceso Host no quedó accesible. Confirma que el remoto use Node 22/24 y que el puerto elegido esté libre, y reintenta.",
  "desktopHostSwitcher.sshError.sshAuth.title": "Falló la autenticación SSH",
  "desktopHostSwitcher.sshError.sshAuth.guidance": "Revisa la clave SSH, la contraseña y el destino en Ajustes → Instancias remotas. El arranque no termina hasta que el inicio de sesión SSH funcione.",
  "desktopHostSwitcher.sshError.sshUnreachable.title": "No se pudo alcanzar el host SSH",
  "desktopHostSwitcher.sshError.sshUnreachable.guidance": "Revisa el nombre de host, el puerto y la red (conecta primero la VPN o un bastión si hace falta) y reintenta.",
  "desktopHostSwitcher.sshError.timeout.title": "La conexión SSH agotó el tiempo",
  "desktopHostSwitcher.sshError.timeout.guidance": "El host remoto no terminó el arranque a tiempo. Revisa la red y que Node 22 o 24 esté instalado, y reintenta.",
  "desktopHostSwitcher.sshError.unknown.title": "La instancia remota no pudo iniciarse",
  "desktopHostSwitcher.sshError.unknown.guidance": "Falló la inicialización remota. Mira el error concreto abajo, o abre Ajustes → Instancias remotas y revisa los registros SSH de este host.",
  ...
  "updateDialog.status.otaBundleReused": "Se usó el paquete de actualización descargado anteriormente. No hace falta descargarlo de nuevo.",
  ...
  "updateDialog.actions.applyOtaNow": "Actualizar ahora",
  "updateDialog.actions.later": "Más tarde",
  ...
  "mobileUpdate.ota.toast.available.title": "Actualización disponible",
  "mobileUpdate.ota.toast.available.description": "La versión {version} está lista para instalar.",
  "mobileUpdate.ota.toast.actions.update": "Actualizar",
  "mobileUpdate.ota.toast.actions.dismiss": "Descartar",
  ...
  "common.relative.justNow": "Ahora mismo",
  "common.relative.minutesAgoShort": "hace {count} min",
  "common.relative.hoursAgoShort": "hace {count} h",
  "common.relative.daysAgoShort": "hace {count} d",
  "common.relative.weeksAgoShort": "hace {count} sem",
  "common.relative.yearsAgoShort": "hace {count} a",
  "common.relative.minutesAgoCompact": "hace {count} min",
  "common.relative.hoursAgoCompact": "hace {count} h",
  "common.relative.daysAgoCompact": "hace {count} d",
  "common.relative.weeksAgoCompact": "hace {count} sem",
  "common.relative.monthsAgoCompact": "hace {count} meses",
  "common.relative.yearsAgoCompact": "hace {count} a",
  ...
  "header.workStatusPanel.toggleAria": "Alternar estado del trabajo",
  ...
  "chat.workStatus.section.contextSources": "Fuentes de contexto",
  "chat.workStatus.context.label": "Contexto",
  "chat.workStatus.cost.breakdown": "Sesión {session} · Subagentes {subagents}",
  "chat.workStatus.git.changedFileSingle": "{count} archivo cambiado",
  "chat.workStatus.git.changedFilePlural": "{count} archivos cambiados",
  "chat.workStatus.pr.untitled": "Solicitud de extracción sin título",
  "chat.workStatus.pr.draft": "Borrador",
  "chat.workStatus.pr.checks": "Comprobaciones",
  "chat.workStatus.pr.checksFailed": "{count} fallidas",
  ...
  "chat.workStatus.action.copyBranch": "Copiar nombre de la rama",
  "chat.workStatus.action.openChanges": "Abrir cambios",
  "chat.workStatus.action.openPr": "Abrir solicitud de extracción",
  "chat.workStatus.action.openSubagent": "Abrir {name}",
  "chat.workStatus.subagent.untitled": "Subagente",
  "chat.workStatus.subagent.working": "trabajando",
  "chat.workStatus.subagent.needsPermission": "espera permiso",
  "chat.workStatus.subagent.askedQuestion": "hizo una pregunta",
  "chat.workStatus.subagent.done": "Listo",
  "chat.workStatus.subagent.workingCount": "{count} trabajando",
  "chat.workStatus.subagent.doneCount": "{count} completados",
  "chat.workStatus.mcp.toggle": "Alternar {name}",
  "chat.workStatus.mcp.needsAuth": "Iniciar sesión",
  "chat.workStatus.mcp.failed": "Error",
  ...
  "chat.workStatus.sections.allHidden": "Todas las secciones están ocultas",
  "chat.workStatus.sections.showAll": "Mostrar todas",
  "chat.workStatus.sections.dialogTitle": "Secciones del estado del trabajo",
  "chat.workStatus.sections.dialogDescription": "Elige qué secciones muestra la tarjeta. Arrastra para reordenar.",
  ...
  "chat.workStatus.telemetry.duration": "Duración",
  "chat.workStatus.telemetry.cost": "Coste",
  "chat.workStatus.usage.refresh": "Actualizar cuotas",
  "chat.workStatus.compact.onBranch": "En {branch}",
  "chat.workStatus.compact.changes": "Cambios",
  "opencodeUpgrade.screen.title": "Se requiere OpenCode 2.0.15",
  "opencodeUpgrade.screen.outdatedTitle": "Actualizar OpenCode",
  "opencodeUpgrade.screen.local": "OpenCode {version} está instalado. Esta versión de OpenChamber requiere OpenCode v2.",
  "opencodeUpgrade.screen.outdatedLocal": "OpenCode {version} está instalado. Esta versión de OpenChamber requiere OpenCode {minimum} o posterior.",
  "opencodeUpgrade.screen.external": "El servidor conectado ejecuta OpenCode {version}. Instala OpenCode v2 en ese servidor y vuelve a comprobar.",
  "opencodeUpgrade.screen.outdatedExternal": "El servidor conectado ejecuta OpenCode {version}. Actualízalo a OpenCode {minimum} o posterior y vuelve a comprobar.",
  "opencodeUpgrade.screen.bundled": "OpenCode {version} viene incluido con OpenChamber y es anterior a {minimum}. Se puede instalar una copia administrada sin cambiar el binario incluido.",
  "opencodeUpgrade.screen.installDescription": "OpenChamber instalará OpenCode {minimum} o posterior en su caché administrada y reiniciará. No se sobrescriben tus archivos actuales de OpenCode.",
  "opencodeUpgrade.screen.install": "Instalar OpenCode {minimum}",
  "opencodeUpgrade.screen.update": "Actualizar a OpenCode {minimum}",
  "opencodeUpgrade.screen.installing": "Instalando OpenCode…",
  "opencodeUpgrade.screen.updating": "Actualizando OpenCode…",
  "opencodeUpgrade.screen.reconnect": "Comprobar de nuevo",
  "opencodeUpgrade.screen.reconnecting": "Comprobando…",
  "opencodeUpgrade.screen.failedTitle": "OpenCode no se actualizó",
  "opencodeUpgrade.screen.failedGeneric": "La instalación no terminó. OpenCode sigue en la versión anterior.",
  "opencodeUpgrade.screen.guide": "Guía de instalación",
  "opencodeUpgrade.screen.manualGuidance": "La instalación automática no está disponible en este runtime. Actualiza OpenCode tú mismo y vuelve a comprobar.",
};
