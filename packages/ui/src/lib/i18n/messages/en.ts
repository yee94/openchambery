...
export const dict = {
  ...
  'chat.assistantStatus.switchingToPlanning': 'Switching to planning',
  'chat.assistantStatus.switchingToBuilding': 'Switching to building',
  ...
  'chat.tools.display.plan_enter': 'Plan Mode',
  'chat.tools.display.plan_exit': 'Build Mode',
