...
export const dict = {
  ...
  'chat.questionDelegate.awaiting': 'Waiting for host confirmation…',
  ...
  'chat.questionDelegate.stale': 'Showing the last known status; host sync is incomplete.',
  'chat.questionDelegate.pauseFailed': 'Pause failed. The host countdown may still be running.',
