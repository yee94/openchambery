...
export const dict = {
  ...
  'chat.btw.questionRequired': 'Type a question after /btw.',
  'chat.btw.sessionRequired': 'Open an existing conversation to ask a side question.',
  'chat.btw.plainTextRequired': 'Use plain text for a side question. Your references remain in the composer.',
  'chat.btw.pending': 'Preparing an answer…',
  'chat.btw.cancelled': 'Answer cancelled. Retry to ask again.',
  'chat.btw.resize': 'Resize side question panel',
  ...settingsDict,
