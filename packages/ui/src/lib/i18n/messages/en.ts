...
export const dict = {
  ...
  'chat.response.contentFilter': 'Response blocked by the provider',
  'chat.response.transport': 'Provider connection failed',
  'chat.response.internal': 'Provider internal error',
  'chat.response.invalidOutput': 'Invalid response from the provider',
  'chat.response.invalidRequest': 'Provider rejected the request',
  'chat.response.unsupportedOperation': 'Operation not supported by the provider',
  'chat.response.noRoute': 'Model or provider configuration unavailable',
  'chat.response.providerUnknown': 'Provider error',
  'chat.response.timeout': 'Provider request timed out',
  'chat.response.permissionRejected': 'Permission denied',
  'chat.response.toolExecution': 'Tool execution failed',
  'chat.response.compactionFailed': 'Context compaction failed',
  'chat.response.compactionUnavailable': 'Nothing to compact yet',
  'chat.response.compactionInterrupted': 'Context compaction interrupted',
  'chat.response.compactionCancelled': 'Context compaction cancelled',
  'chat.response.stopped': 'Stopped by user',
  'chat.response.interrupted': 'Response interrupted',
  'chat.response.toolInterrupted': 'Tool execution interrupted',
  'chat.response.resumeExhausted': 'Automatic recovery stopped after repeated interruptions',
  'chat.response.retrying': 'Retrying automatically',
  'chat.response.failed': 'Execution failed',
  'chat.response.continuingAfterRestart': 'Continuing after restart',
  'chat.queuedMessage.inheritsSessionSelection': 'Inherits the session model, agent, and variant at execution.',
  'chat.sessionRecovery.awaitingConfirmation': 'Service restarted. Waiting to confirm task status.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': 'Answer generation failed. Please retry.',
  'chat.btw.description': 'Ask about the conversation while keeping its history unchanged.',
  'chat.btw.placeholder': 'Ask in Side Chat…',
  'chat.btw.removeQuoteAria': 'Remove quote',
  'chat.message.conversationQuotesLabel': 'Quoted from the conversation',
  'chat.btw.sessionRequired': 'Open an existing conversation to start Side Chat.',
  'chat.btw.plainTextRequired': 'Use plain text in Side Chat. Your references remain in the composer.',
  'chat.btw.pending': 'Preparing an answer…',
  'chat.btw.cancelled': 'Answer cancelled. Retry to ask again.',
  'chat.btw.resize': 'Resize Side Chat panel',
  ...settingsDict,
  'chat.questionDelegate.countdown': 'Model decides in {seconds}s',
  'chat.questionDelegate.awaiting': 'Waiting for confirmation…',
  'chat.questionDelegate.pausing': 'Pausing countdown…',
  'chat.questionDelegate.paused': 'Countdown paused',
  'chat.questionDelegate.disabled': 'Automatic countdown is off',
  'chat.questionDelegate.refreshStatus': 'Refresh status',
  'chat.questionDelegate.submitting': 'Submitting reply…',
  'chat.questionDelegate.uncertain': 'Submission outcome is uncertain. Waiting for confirmation.',
  'chat.questionDelegate.settled': 'Question resolved',
  'chat.questionDelegate.success': 'Continuation reply sent. The model will decide how to proceed.',
  'chat.questionDelegate.stale': 'Showing the last known status. Latest status is still updating.',
  'chat.questionDelegate.pauseFailed': 'Pause failed. The countdown may still be running.',
  'chat.questionDelegate.delegateFailed': 'Delegation failed. Check the status and retry.',
  'chat.questionDelegate.loadFailed': 'Could not refresh delegation status.',
  'chat.questionDelegate.retry': 'Retry',
  'chat.questionDelegate.pause': 'Pause countdown',
  'chat.questionDelegate.delegate': 'Delegate now',
  ...
  // Floating tab bar: keep short so 4 items fit on a phone in every locale.
  ...
  'mobile.settings.switchInstance': 'Switch instance',
  'mobile.menu.update': 'Update',
  'mobile.menu.settings': 'Settings',
  'mobile.sessions.newChatCta': 'New Session in {project}',
  ...
  'mobile.projects.menu.label': 'More actions',
  'mobile.projects.menu.newChat': 'New chat',
  'mobile.projects.menu.newProject': 'New project',
  'mobile.projects.menu.scanQr': 'Scan QR code',
  ...
  'mobile.sessions.startNewChat': 'New Session',
  'mobile.sessions.newChat': 'New Session',
  ...
  'mobile.sessions.stopSessionAria': 'Stop {title}',
  'mobile.sessions.stopGroupAria': 'Stop all running in {label}',
  'mobile.sessions.stopSubsessionsAria': 'Stop running subsessions of {title}',
  ...
  'mobile.sessions.newSessionAria': 'Start a new chat in this project',
  ...
  'layout.rightSidebar.browser': 'Browser',
  'layout.browserProvider.noSurface': '{name} has no live view.',
  'layout.browserProvider.status.connecting': 'Connecting…',
  'layout.browserProvider.status.reconnecting': 'Connection lost. Reconnecting…',
  'layout.browserProvider.status.ready': 'Click or type to take control',
  'layout.browserProvider.status.readyFocused': 'Type to control the view; click outside to leave',
  'layout.browserProvider.status.agentWorking': 'Agent is working',
  'layout.browserProvider.status.youControl': 'You have control',
  'layout.browserProvider.status.otherControls': 'Another device has control',
  'layout.browserProvider.handBack': 'Hand back to extension',
  'layout.browserProvider.retry': 'Try again',
  'layout.browserProvider.canvasAria': 'Live view of {name}',
  'layout.browserProvider.ended.service-stopped': 'The extension\'s service stopped.',
  'layout.browserProvider.ended.extension-unavailable': 'The extension is unavailable.',
  'layout.browserProvider.ended.host-shutdown': 'OpenChamber is shutting down.',
  ...
  'sessions.scheduledTasks.dialog.description': 'Server-side schedules create a new session and send a configured prompt.',
  ...
  'sessions.scheduledTasks.workspace.filters.active': 'Active',
  'sessions.scheduledTasks.workspace.filters.paused': 'Paused',
  'sessions.scheduledTasks.workspace.views.aria': 'Schedule views',
  ...
  'sessions.scheduledTasks.history.error.title': 'Run history could not load',
  'sessions.scheduledTasks.history.error.description': 'OpenChamber could not load the recorded runs.',
  'sessions.scheduledTasks.history.error.more': 'More runs could not load. Your loaded history is still available.',
  'sessions.scheduledTasks.history.retry': 'Retry',
  'sessions.scheduledTasks.history.empty.title': 'No runs yet',
  'sessions.scheduledTasks.history.empty.description': 'Scheduled and manual runs will appear here.',
  'sessions.scheduledTasks.history.trigger.scheduled': 'Scheduled',
  'sessions.scheduledTasks.history.trigger.manual': 'Manual',
  'sessions.scheduledTasks.history.meta.trigger': 'Trigger',
  'sessions.scheduledTasks.history.meta.started': 'Started',
  'sessions.scheduledTasks.history.meta.ended': 'Ended',
  'sessions.scheduledTasks.history.meta.duration': 'Duration',
  'sessions.scheduledTasks.history.ended.unavailable': '—',
  'sessions.scheduledTasks.history.duration.pending': 'In progress',
  'sessions.scheduledTasks.history.duration.lessThanOneSecond': '<1 sec',
  'sessions.scheduledTasks.history.duration.milliseconds': '{count} ms',
  'sessions.scheduledTasks.history.duration.seconds': '{count} sec',
  'sessions.scheduledTasks.history.duration.minutesSeconds': '{minutes} min {seconds} sec',
  ...
  'sessions.scheduledTasks.workspace.search.noResults': 'No schedules match your search.',
  'sessions.scheduledTasks.workspace.partialLoadWarning': 'Some projects could not load schedules. Loaded schedules remain available.',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': 'Select a schedule',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': 'Choose a schedule from the list or create a new one.',
  'sessions.scheduledTasks.workspace.confirm.discardChanges': 'Unsaved changes will be discarded. Continue?',
  'sessions.scheduledTasks.editor.panel.details': 'Details',
  'sessions.scheduledTasks.editor.panel.frequency': 'Frequency',
  ...
  'sessions.scheduledTasks.dialog.empty.selectProject': 'Select a project to manage schedules.',
  ...
  'sessions.scheduledTasks.editor.description': 'Configure a server-side schedule that creates a new session and sends a prompt.',
  'sessions.scheduledTasks.editor.taskName.label': 'Schedule name',
  ...
  'sessions.scheduledTasks.editor.enabled.aria': 'Enable schedule',
  'sessions.scheduledTasks.editor.enabled.label': 'Enabled',
  'sessions.scheduledTasks.editor.goal.label': 'Run as goal',
  'sessions.scheduledTasks.editor.goal.aria': 'Run this schedule as a goal the agent pursues to completion',
  ...
  'sessions.scheduledTasks.editor.validation.taskNameRequired': 'Schedule name is required',
  ...
  'sessions.sidebar.header.actions.sessionDisplayMode': 'Project expand/collapse actions',
  'sessions.sidebar.header.displayMode.label': 'Expand/collapse projects',
  ...
  'sessions.sidebar.project.loadingSessions': 'Loading sessions…',
  ...
  'sessions.sidebar.bulkActions.archiveUndoFailed': 'Failed to restore {count} sessions',
  'sessions.sidebar.undo': 'Undo',
  'sessions.sidebar.openSettings': 'Settings',
  ...
  'sessions.sidebar.session.menu.refreshTranscriptSuccess': 'Messages synced',
  'sessions.sidebar.session.menu.refreshTranscriptFailed': 'Failed to sync messages',
  ...
  'sessions.sidebar.session.actions.pinned': 'Pinned',
  'sessions.sidebar.session.status.permissionRequired': 'Permission required',
  'sessions.sidebar.session.status.questionRequired': 'Question required',
  ...
  'sessions.sidebar.group.showMore': 'More',
  ...
  'sessions.sidebar.group.showFewer': 'Fewer',
  ...
  'gitView.changes.deferredTitle': '{count} changed files',
  'gitView.changes.deferredStagedCount': 'Staged: {count}',
  'gitView.changes.deferredUnstagedCount': 'Unstaged: {count}',
  'gitView.changes.deferredHint': 'Large change sets are not rendered automatically to keep the app responsive.',
  'gitView.changes.deferredLoadAction': 'Load changes',
  ...
  'contextPanel.mode.context': 'Usage',
  ...
  'contextPanel.file.notice.turnDiffOutsideWorkspace': 'Turn diff is unavailable outside the project. Showing the current file instead.',
  ...
  'sidebarFilesTree.actions.collapseAllTitle': 'Collapse all',
  'sidebarFilesTree.actions.expandAllTitle': 'Expand all',
  ...
  'contextUsage.tooltip.usage': 'Usage: {percent}',
  ...
  'contextSidebar.empty.openSession': 'Open a session to inspect usage.',
  'contextSidebar.section.context': 'Usage',
  ...
  'contextSidebar.stats.sessionTps': 'Session TPS',
  ...
  'diffView.actions.openFilePreview': 'Open this file',
  ...
  'chat.history.loadOlderTimeout': 'Loading older messages timed out. Try again.',
  ...
  'header.services.openWithCurrent': 'Switch instance (current: {current})',
  'header.services.open': 'Switch instance',
  'header.services.tooltip.currentInstanceWithShortcuts': 'Switch instance: {current} ({toggle}; next tab {nextTab})',
  'header.services.tooltip.servicesWithShortcuts': 'Switch instance ({toggle}; next tab {nextTab})',
  'header.services.title': 'Switch instance',
  'header.services.viewAria': 'Switch instance',
  'header.services.closeAria': 'Close instance switcher',
  ...
  'header.actions.sessionMenu': 'Session actions',
  'header.actions.sessionMenuAria': 'Open session actions menu',
  'header.actions.sessionMenu.servicesWithInstance': 'Switch instance ({current})',
  'header.actions.sessionMenu.viewUsage': 'View usage',
  ...
  'directoryTree.section.pinnedInProgress': 'Pinned / In progress',
  ...
  'helpDialog.section.leaderChords': 'Leader key (Ctrl+X)',
  ...
  'helpDialog.item.previousSession': 'Previous Session',
  'helpDialog.item.nextSession': 'Next Session',
  ...
  'helpDialog.item.toggleRightSidebar': 'Toggle Review Panel',
  ...
  'helpDialog.item.closeContextPanelTab': 'Close Context Panel Tab',
  'helpDialog.item.toggleTerminal': 'Toggle Terminal',
  'helpDialog.item.newTerminalTab': 'New Terminal Tab (when terminal is focused)',
  'helpDialog.item.openNewTerminal': 'Open New Terminal',
  'helpDialog.item.previousTerminalTab': 'Previous Terminal Tab (when terminal is focused)',
  'helpDialog.item.nextTerminalTab': 'Next Terminal Tab (when terminal is focused)',
  'helpDialog.item.toggleBottomPanel': 'Toggle Bottom Panel',
  'helpDialog.item.toggleTerminalExpanded': 'Toggle Terminal Expanded',
  'helpDialog.item.cycleTheme': 'Cycle Theme (Light → Dark → System)',
  'helpDialog.item.zoomIn': 'Zoom In',
  'helpDialog.item.zoomOut': 'Zoom Out',
  ...
  'helpDialog.item.leaderOpenAgent': 'Open agent selector',
  'helpDialog.item.leaderNewSession': 'Create new session',
  'helpDialog.item.leaderCompact': 'Compact current session',
  'chat.leaderKey.pendingAria': 'Leader key active. Press a follow-up key.',
  'chat.leaderKey.action.model': 'Model',
  'chat.leaderKey.action.agent': 'Agent',
  'chat.leaderKey.action.newSession': 'New',
  'chat.leaderKey.action.compact': 'Compact',
  ...
  'helpDialog.proTips.recentSessions': 'The 9 most recent chats appear in Global search',
  ...
  'chat.fileAttachment.actions.expandImages': 'Show more images',
  'chat.fileAttachment.actions.collapseImages': 'Show fewer images',
  ...
  'chat.activity.compactionFailed': 'Compaction failed',
  'chat.activity.expandAria': 'Expand processing details',
  'chat.activity.collapseAria': 'Collapse processing details',
  'chat.activity.completed': 'Processed in {duration}',
  'chat.activity.completedStatus': 'Processed',
  'chat.activity.agentsWorking': '{count} agents working',
  'chat.activity.agentsInvolved': '{count} agents involved',
  'chat.activity.moreHidden': '+{count} more...',
  ...
  'chat.emptyState.establishingConversation': 'Establishing conversation',
  ...
  'chat.draftStarters.expand': 'Show more',
  'chat.draftStarters.collapse': 'Show less',
  ...
  'chat.assistantStatus.updatingTodos': 'Updating tasks',
  'chat.assistantStatus.readingTodos': 'Reading tasks',
  'chat.assistantStatus.learningSkill': 'Learning skill',
  'chat.assistantStatus.askingQuestion': 'Asking question',
  'chat.assistantStatus.executing': 'Executing',
  'chat.assistantStatus.renamingSession': 'Renaming session',
  'chat.assistantStatus.movingSession': 'Moving session',
  'chat.assistantStatus.usingBrowser': 'Using browser',
  'chat.assistantStatus.usingTool': 'Using {tool}',
  'chat.assistantStatus.working': 'Working',
  'chat.assistantStatus.processing': 'Processing',
  'chat.assistantStatus.preparing': 'Preparing',
  'chat.assistantStatus.warmingUp': 'Warming up',
  'chat.assistantStatus.gearsTurning': 'Gears turning',
  'chat.assistantStatus.computing': 'Computing',
  'chat.assistantStatus.calculating': 'Calculating',
  'chat.assistantStatus.analyzing': 'Analyzing',
  'chat.assistantStatus.wheelsSpinning': 'Wheels spinning',
  'chat.assistantStatus.calibrating': 'Calibrating',
  'chat.assistantStatus.synthesizing': 'Synthesizing',
  'chat.assistantStatus.connectingDots': 'Connecting dots',
  'chat.assistantStatus.inspectingLogic': 'Inspecting logic',
  ...
  'chat.assistantStatus.retryingAttempt': 'Retrying (attempt {attempt})',
  'chat.assistantStatus.retryingInAttempt': 'Retrying {duration} (attempt {attempt})',
  ...
  'chat.revertPopover.files': 'Files that will change',
  'chat.revert.toast.undo': 'Reverted to {preview}',
  'chat.revert.toast.redo': 'Redone',
  'chat.revert.toast.restored': 'Restored all messages',
  'chat.revert.toast.busy': 'Cannot revert while the session is busy',
  'chat.form.title': 'Form',
  'chat.form.reply': 'Submit',
  'chat.form.cancel': 'Cancel',
  'chat.retry.action.quota': 'Usage limit reached',
  'chat.retry.action.account': 'Account limit reached',
  'chat.retry.action.open': 'Open',
  ...
  'chat.commandAutocomplete.command.reloadDescription': 'Reload OpenCode configuration, providers, and plugins without restarting',
  'chat.commandAutocomplete.command.newDescription': 'Start a new session in the current project.',
  ...
  'chat.fileMentionAutocomplete.groups.skills': 'Skills',
  'chat.fileMentionAutocomplete.groups.agents': 'Agents',
  'chat.fileMentionAutocomplete.groups.sessions': 'Loaded sessions',
  'chat.fileMentionAutocomplete.groups.directories': 'Directories',
  'chat.fileMentionAutocomplete.groups.recentFiles': 'Recent files',
  'chat.fileMentionAutocomplete.groups.files': 'Files',
  'chat.fileMentionAutocomplete.sessionType': 'OpenCode session',
  'chat.fileMentionAutocomplete.untitledSession': 'Untitled session',
  ...
  'chat.queuedMessage.title': 'Queue',
  'chat.queuedMessage.edit': 'edit',
  'chat.queuedMessage.send': 'steer',
  'chat.queuedMessage.queuing': 'Queuing…',
  'chat.queuedMessage.queuingAria': 'Queuing message',
  'chat.queuedMessage.waitingForCompaction': 'Waiting for compaction',
  'chat.queuedMessage.waitingForCompactionAria': 'Waiting for compaction to finish',
  'chat.queuedMessage.sending': 'Steering…',
  'chat.queuedMessage.sendingAria': 'Steering message',
  ...
  'chat.textSelection.actions.addToSideChat': 'Add to side chat',
  'chat.textSelection.title.addToCurrentChat': 'Add to current chat',
  'chat.messageBody.aborted': 'Generation stopped',
  'chat.messageBody.actions.editing': 'Editing…',
  'chat.messageBody.actions.editStaged': 'Edit pending',
  'chat.messageBody.actions.cancelEdit': 'Cancel edit',
  ...
  'chat.messageBody.meta.tpsAria': 'Generation rate: {rate}',
  'chat.messageBody.meta.tpsTooltip': 'Generation speed (tokens/sec), excluding tool call time',
  ...
  'chat.forkTransition.preparing': 'Preparing the fork',
  'chat.forkTransition.copying': 'Copying the conversation (long sessions may take a while)',
  'chat.forkTransition.opening': 'Opening the new session',
  'chat.forkTransition.loading': 'Loading recent messages',
  ...
  'chat.chatInput.actions.attachPhotos': 'Attach photos',
  'chat.chatInput.actions.attachCancel': 'Cancel',
  ...
  'chat.chatInput.toast.reloadStarted': 'Reloading configuration…',
  'chat.chatInput.toast.reloadSucceeded': 'Configuration reloaded',
  'chat.chatInput.toast.reloadFailed': 'Failed to reload configuration',
  ...
  'chat.chatInput.draftPicker.newProject': 'New project',
  ...
  'chat.chatInput.branchSwitch.title': 'Switch to {branch}?',
  'chat.chatInput.branchSwitch.description': 'How should this branch be opened for the new conversation?',
  'chat.chatInput.branchSwitch.createWorktree': 'Create worktree',
  'chat.chatInput.branchSwitch.createWorktreeDescription': 'Keep the current directory as-is and work in an isolated worktree.',
  'chat.chatInput.branchSwitch.checkoutHere': 'Checkout here',
  'chat.chatInput.branchSwitch.checkoutHereDescription': 'Switch the current directory to this branch.',
  'chat.chatInput.branchSwitch.cancel': 'Cancel',
  ...
  'chat.toolOutputDialog.image.zoomInAria': 'Zoom in',
  'chat.toolOutputDialog.image.zoomOutAria': 'Zoom out',
  'chat.toolOutputDialog.image.resetZoomAria': 'Reset zoom',
  'chat.image.actions.sheetTitle': 'Image',
  'chat.image.actions.saveImage': 'Save image',
  'chat.image.actions.saveToPhotos': 'Save to Photos',
  'chat.image.actions.saving': 'Saving…',
  'chat.image.actions.saveSuccess': 'Image saved',
  'chat.image.actions.saveFailed': 'Could not save image',
  ...
  'chat.activity.outputLoading': 'Loading full output…',
  'chat.activity.outputLoadFailed': 'Could not load full output.',
  'chat.activity.outputRetry': 'Retry',
  'chat.fileAttachment.image.loading': 'Loading image…',
  ...
  'chat.permissionCard.replaceAll': 'Replace all occurrences',
  ...
  'chat.modelControls.costPerMillion': 'Cost',
  'chat.modelControls.costInput': 'In',
  'chat.modelControls.costOutput': 'Out',
  ...
  'chat.modelControls.keyboardHintSwitchAgentLabel': 'Switch agent',
  ...
  'chat.usedGroup.running': 'Running',
  'chat.usedGroup.used': 'Used',
  'chat.usedGroup.expandAria': 'Expand used tools',
  'chat.usedGroup.collapseAria': 'Collapse used tools',
  'chat.usedGroup.editSingle': '{count} edit',
  'chat.usedGroup.editPlural': '{count} edits',
  'chat.usedGroup.commandSingle': '{count} command',
  'chat.usedGroup.commandPlural': '{count} commands',
  'chat.usedGroup.otherSingle': '{count} call',
  'chat.usedGroup.otherPlural': '{count} calls',
  ...
  'chat.tools.display.read': 'Read File',
  'chat.tools.display.write': 'Write File',
  'chat.tools.display.edit': 'Edit File',
  'chat.tools.display.apply_patch': 'Apply Patch',
  'chat.tools.display.bash': 'Shell Command',
  'chat.tools.display.grep': 'Search Files',
  'chat.tools.display.glob': 'Find Files',
  'chat.tools.display.list': 'List Directory',
  'chat.tools.display.task': 'Agent Task',
  'chat.tools.display.webfetch': 'Fetch URL',
  'chat.tools.display.websearch': 'Web Search',
  'chat.tools.display.codesearch': 'Code Search',
  'chat.tools.display.todowrite': 'Update Todo List',
  'chat.tools.display.todoread': 'Read Todo List',
  'chat.tools.display.skill': 'Load Skill',
  'chat.tools.display.question': 'Question',
  'chat.tools.display.lsp': 'LSP',
  'chat.tools.display.structuredoutput': 'Structured Output',
  'chat.tools.display.execute': 'Execute',
  'chat.tools.display.session_rename': 'Rename Session',
  'chat.tools.display.session_move': 'Move Session',
  'chat.tools.display.browser': 'Browser',
  ...
  'chat.messageBody.subagent.completed': 'Completed',
  'chat.messageBody.subagent.error': 'Failed',
  'chat.messageBody.subagent.cancelled': 'Cancelled',
  'chat.messageBody.subagent.completedDescription': 'Background subagent completed',
  ...
  'chat.sessionBackground.moveRunning': 'Move to background',
  'chat.sessionBackground.moving': 'Moving…',
  'chat.sessionBackground.moveFailed': 'Could not move work to the background',
  'chat.sessionBackground.tasksRunning': '{count} background task(s) running',
  ...
  'commandPalette.error.sessions': 'Chat search could not load. Available results are still shown.',
  ...
  'commandPalette.item.newTerminalTab': 'New Terminal Tab',
  ...
  'desktopHostSwitcher.transition.title': 'Switching instance…',
  'desktopHostSwitcher.transition.description': 'Loading data from the selected instance.',
  ...
  'desktopHostSwitcher.sshError.openRemoteSettings': 'Open Remote instances',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.title': 'Remote host has no Node.js 22+',
  'desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance': 'Install Node.js 22 or 24 LTS on the remote machine (nvm, fnm, or the system package). A login shell that only exposes Node 18/20 is not enough unless a 22+ binary exists in a standard path.',
  'desktopHostSwitcher.sshError.packageManagerMissing.title': 'Remote host has no npm or bun',
  'desktopHostSwitcher.sshError.packageManagerMissing.guidance': 'Install npm (included with Node.js) or bun on the remote machine, then retry. OpenChamber needs one of them to install the Host CLI.',
  'desktopHostSwitcher.sshError.nativeBinding.title': 'Remote database module failed to build',
  'desktopHostSwitcher.sshError.nativeBinding.guidance': 'Install Node.js 22 or 24 LTS on the remote host. Odd versions such as Node 23 often have no prebuilt binary and need python3, gcc, and make. After an LTS runtime is available, retry the connection.',
  'desktopHostSwitcher.sshError.openchamberCliMissing.title': 'Remote OpenChamber CLI was not found',
  'desktopHostSwitcher.sshError.openchamberCliMissing.guidance': 'The install finished, but openchamber --version did not report a usable version. Check that ~/.bun/bin or the npm global bin is on PATH, then retry. You can also run openchamber --version over SSH.',
  'desktopHostSwitcher.sshError.openchamberRegistry.title': 'Could not download OpenChamber on the remote host',
  'desktopHostSwitcher.sshError.openchamberRegistry.guidance': 'The remote could not reach the npm registry or the configured mirror. Check network, proxy, and npm registry settings, then retry. You can also install @openchambery/web yourself with Node 22 or 24 and npm.',
  'desktopHostSwitcher.sshError.openchamberInstall.title': 'Could not install OpenChamber on the remote host',
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'bun or npm failed to install @openchambery/web. Open this host’s SSH logs for the package-manager output, then retry. You can also install @openchambery/web yourself with Node 22 or 24.',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.title': 'Remote OpenChamber CLI is too old for this desktop',
  'desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance': 'The remote CLI rejected a flag this desktop sent (for example --relay-host). Update @openchambery/web on the remote to a build that includes SSH relay host, then retry.',
  'desktopHostSwitcher.sshError.opencodeInstall.title': 'Could not install OpenCode CLI on the remote host',
  'desktopHostSwitcher.sshError.opencodeInstall.guidance': 'Check the remote network and package manager, then retry. You can also install the OpenCode CLI manually on the remote host.',
  'desktopHostSwitcher.sshError.serverStart.title': 'Remote OpenChamber server did not start',
  'desktopHostSwitcher.sshError.serverStart.guidance': 'SSH connected, but the Host process did not become reachable. Confirm the remote is on Node 22/24 and the chosen port is free, then retry.',
  'desktopHostSwitcher.sshError.sshAuth.title': 'SSH authentication failed',
  'desktopHostSwitcher.sshError.sshAuth.guidance': 'Check the SSH key, password, and destination in Settings → Remote instances. Bootstrap cannot finish until SSH login succeeds.',
  'desktopHostSwitcher.sshError.sshUnreachable.title': 'Could not reach the SSH host',
  'desktopHostSwitcher.sshError.sshUnreachable.guidance': 'Check the hostname, port, and network (connect VPN or a bastion first if required), then retry.',
  'desktopHostSwitcher.sshError.timeout.title': 'SSH connection timed out',
  'desktopHostSwitcher.sshError.timeout.guidance': 'The remote host did not finish bootstrap in time. Check the network and that Node 22 or 24 is installed, then retry.',
  'desktopHostSwitcher.sshError.unknown.title': 'Remote instance failed to start',
  'desktopHostSwitcher.sshError.unknown.guidance': 'Remote setup failed. Read the exact error below, or open Settings → Remote instances and check this host’s SSH logs.',
  ...
  'updateDialog.status.otaBundleReused': 'Using the previously downloaded update package. No download needed.',
  ...
  'updateDialog.actions.applyOtaNow': 'Update now',
  'updateDialog.actions.later': 'Later',
  ...
  'mobileUpdate.ota.toast.available.title': 'Update available',
  'mobileUpdate.ota.toast.available.description': 'Version {version} is ready to install.',
  'mobileUpdate.ota.toast.actions.update': 'Update',
  'mobileUpdate.ota.toast.actions.dismiss': 'Dismiss',
  ...
  'common.relative.minutesAgoCompact': '{count}m',
  ...
  'common.relative.monthsAgoCompact': '{count}mo',
  ...
  'header.workStatusPanel.toggleAria': 'Toggle work status',
  ...
  'chat.workStatus.section.contextSources': 'Context sources',
  ...
  'chat.workStatus.action.copyBranch': 'Copy branch name',
  ...
  'chat.workStatus.subagent.working': 'working',
  ...
  'chat.workStatus.subagent.workingCount': '{count} working',
  'chat.workStatus.subagent.doneCount': '{count} done',
  ...
  'chat.workStatus.sections.allHidden': 'All sections are hidden',
  'chat.workStatus.sections.showAll': 'Show all',
  'chat.workStatus.sections.dialogTitle': 'Work status sections',
  'chat.workStatus.sections.dialogDescription': 'Choose which sections the card shows. Drag to reorder.',
  'chat.workStatus.breakdown.skills': 'Skills',
  'chat.workStatus.breakdown.mcp': 'MCP servers',
  'chat.workStatus.telemetry.tokens': 'Tokens',
  'chat.workStatus.telemetry.duration': 'Duration',
  'chat.workStatus.telemetry.cost': 'Cost',
  'chat.workStatus.usage.refresh': 'Refresh quotas',
  'chat.workStatus.compact.onBranch': 'On {branch}',
  'chat.workStatus.compact.changes': 'Changes',
  'opencodeUpgrade.screen.title': 'OpenCode 2.0.15 required',
  'opencodeUpgrade.screen.outdatedTitle': 'Update OpenCode',
  'opencodeUpgrade.screen.local': 'OpenCode {version} is installed. This version of OpenChamber requires OpenCode v2.',
  'opencodeUpgrade.screen.outdatedLocal': 'OpenCode {version} is installed. This version of OpenChamber requires OpenCode {minimum} or newer.',
  'opencodeUpgrade.screen.external': 'The connected server is running OpenCode {version}. Install OpenCode v2 on that server, then check again.',
  'opencodeUpgrade.screen.outdatedExternal': 'The connected server is running OpenCode {version}. Update it to OpenCode {minimum} or newer, then check again.',
  'opencodeUpgrade.screen.bundled': 'OpenCode {version} is bundled with OpenChamber and is older than {minimum}. A managed copy can be installed without changing the bundled binary.',
  'opencodeUpgrade.screen.installDescription': 'OpenChamber will install OpenCode {minimum} or newer into its managed cache and restart. Your existing OpenCode files are not overwritten.',
  'opencodeUpgrade.screen.install': 'Install OpenCode {minimum}',
  'opencodeUpgrade.screen.update': 'Update to OpenCode {minimum}',
  'opencodeUpgrade.screen.installing': 'Installing OpenCode…',
  'opencodeUpgrade.screen.updating': 'Updating OpenCode…',
  'opencodeUpgrade.screen.reconnect': 'Check again',
  'opencodeUpgrade.screen.reconnecting': 'Checking…',
  'opencodeUpgrade.screen.failedTitle': 'OpenCode was not upgraded',
  'opencodeUpgrade.screen.failedGeneric': 'The install did not finish. OpenCode is still on the previous version.',
  'opencodeUpgrade.screen.guide': 'Installation guide',
  'opencodeUpgrade.screen.manualGuidance': 'Automatic install is unavailable for this runtime. Update OpenCode yourself, then check again.',
} as const;
