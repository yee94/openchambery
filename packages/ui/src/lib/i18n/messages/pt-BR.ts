...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.response.contentFilter': 'Resposta bloqueada pelo provedor',
  'chat.response.transport': 'Falha na conexão com o provedor',
  'chat.response.internal': 'Erro interno do provedor',
  'chat.response.invalidOutput': 'Resposta inválida do provedor',
  'chat.response.invalidRequest': 'O provedor rejeitou a solicitação',
  'chat.response.unsupportedOperation': 'Operação não suportada pelo provedor',
  'chat.response.noRoute': 'Modelo ou configuração do provedor indisponível',
  'chat.response.providerUnknown': 'Erro do provedor',
  'chat.response.timeout': 'A solicitação ao provedor excedeu o tempo limite',
  'chat.response.permissionRejected': 'Permissão negada',
  'chat.response.toolExecution': 'Falha na execução da ferramenta',
  'chat.response.compactionFailed': 'Falha na compactação do contexto',
  'chat.response.compactionUnavailable': 'Ainda não há conteúdo para compactar',
  'chat.response.compactionInterrupted': 'Compactação do contexto interrompida',
  'chat.response.compactionCancelled': 'Compactação do contexto cancelada',
  'chat.response.stopped': 'Interrompido pelo usuário',
  'chat.response.interrupted': 'Resposta interrompida',
  'chat.response.toolInterrupted': 'Execução da ferramenta interrompida',
  'chat.response.resumeExhausted': 'Recuperação automática interrompida após interrupções repetidas',
  'chat.response.retrying': 'Tentando novamente automaticamente',
  'chat.response.failed': 'Falha na execução',
  'chat.response.continuingAfterRestart': 'Continuando após reiniciar',
  'chat.queuedMessage.inheritsSessionSelection': 'Herda o modelo, o agente e a variante da sessão ao executar.',
  'chat.sessionRecovery.awaitingConfirmation': 'Serviço reiniciado. Aguardando confirmação do estado da tarefa.',
  'chat.btw.title': 'Side Chat',
  'chat.btw.failed': 'Falha ao gerar a resposta. Tente novamente.',
  'chat.btw.description': 'Pergunte sobre a conversa mantendo o histórico intacto.',
  'chat.btw.placeholder': 'Pergunte no Side Chat…',
  'chat.btw.removeQuoteAria': 'Remover citação',
  'chat.message.conversationQuotesLabel': 'Citado da conversa',
  'chat.btw.sessionRequired': 'Abra uma conversa existente para iniciar o Side Chat.',
  'chat.btw.plainTextRequired': 'Use texto simples. Suas referências permanecem no editor.',
  'chat.btw.pending': 'Preparando a resposta…',
  'chat.btw.cancelled': 'Resposta cancelada. Tente novamente para refazer a pergunta.',
  'chat.btw.resize': 'Redimensionar o painel do Side Chat',
 ...settingsDict,
  'chat.questionDelegate.countdown': 'O modelo decidirá em {seconds} s',
  'chat.questionDelegate.awaiting': 'Aguardando confirmação…',
  'chat.questionDelegate.pausing': 'Pausando a contagem regressiva…',
  'chat.questionDelegate.paused': 'Contagem regressiva pausada',
  'chat.questionDelegate.disabled': 'Contagem regressiva automática desativada',
  'chat.questionDelegate.refreshStatus': 'Atualizar estado',
  'chat.questionDelegate.submitting': 'Enviando resposta…',
  'chat.questionDelegate.uncertain': 'O resultado do envio é incerto. Aguardando confirmação.',
  'chat.questionDelegate.settled': 'Pergunta resolvida',
  'chat.questionDelegate.success': 'A resposta para continuar foi enviada. O modelo decidirá como prosseguir.',
  'chat.questionDelegate.stale': 'Exibindo o último estado conhecido; a atualização está em andamento.',
  'chat.questionDelegate.pauseFailed': 'Falha ao pausar. A contagem regressiva pode continuar ativa.',
  'chat.questionDelegate.delegateFailed': 'Falha ao delegar. Verifique o estado e tente novamente.',
  'chat.questionDelegate.loadFailed': 'Falha ao atualizar o estado da delegação.',
  'chat.questionDelegate.retry': 'Tentar novamente',
  'chat.questionDelegate.pause': 'Pausar contagem',
  'chat.questionDelegate.delegate': 'Delegar agora',
  "mobile.settings.switchInstance": "Trocar instância",
  "common.loading": "Carregando...",
  'assistants.contact.sessionMention.scope': 'Sessões recentes indexadas · Digite @título para referenciar',
  'assistants.contact.sessionMention.loadFailed': 'Não foi possível atualizar as sessões. Tente novamente para atualizar a lista.',
  ...
  "mobile.connect.manual.toggle": "Conexão manual",
  ...
  "mobile.instances.status.saved": "Salvo",
  ...
  "mobile.select.sheetAria": "Selecionar uma opção",
  ...
  "mobile.menu.newSession": "Novo chat",
  "mobile.chat.syncingMessages": "Sincronizando mensagens...",
  ...
  "mobile.sessions.mainWorkspace": "Área de trabalho principal",
  "mobile.sessions.section.pinned": "Fixados / Em andamento",
  "mobile.sessions.searchAria": "Pesquisar sessões",
  "mobile.sessions.section.otherProjects": "Trocar de projeto",
  "mobile.sessions.section.projects": "Projetos",
  "mobile.projects.menu.label": "Mais ações",
  "mobile.projects.menu.newChat": "Nova conversa",
  "mobile.projects.menu.newProject": "Novo projeto",
  "mobile.projects.menu.scanQr": "Ler QR code",
  "mobile.projects.menu.switchInstance": "Trocar instância",
  ...
  "mobile.sessions.startNewChat": "Novo chat",
  ...
  "mobile.projects.closeConfirmMessage": "Fechar “{title}”? Ele sairá da lista de projetos. As sessões permanecem no disco.",
  ...
  "mobile.sessions.stopSessionAria": "Parar {title}",
  "mobile.sessions.stopGroupAria": "Parar todas as sessões em execução em {label}",
  "mobile.sessions.stopSubsessionsAria": "Parar subsessões em execução de {title}",
  ...
  "mobile.sessions.sheet.title": "Conversas recentes",
  "mobile.sessions.sheet.resizeAria": "Redimensionar painel de sessões",
  "mobile.changes.sheet.resizeAria": "Redimensionar painel de alterações",
  ...
  "mobile.sessions.newSessionAria": "Iniciar um novo chat neste projeto",
  ...
  "mobile.files.html.fullscreenAria": "Abrir prévia em tela cheia",
  "mobile.files.html.exitFullscreenAria": "Sair da tela cheia",
  "mobile.files.html.viewSourceAria": "Ver código-fonte",
  "mobile.files.html.viewPreviewAria": "Ver prévia",
  ...
  "layout.browserProvider.noSurface": "{name} não tem visualização ao vivo.",
  "layout.browserProvider.status.connecting": "Conectando…",
  "layout.browserProvider.status.reconnecting": "Conexão perdida. Reconectando…",
  "layout.browserProvider.status.ready": "Clique ou digite para assumir o controle",
  "layout.browserProvider.status.readyFocused": "Digite para controlar a visualização; clique fora para sair",
  "layout.browserProvider.status.agentWorking": "O agente está trabalhando",
  "layout.browserProvider.status.youControl": "Você está no controle",
  "layout.browserProvider.status.otherControls": "Outro dispositivo está no controle",
  "layout.browserProvider.handBack": "Devolver à extensão",
  "layout.browserProvider.retry": "Tentar de novo",
  "layout.browserProvider.canvasAria": "Visualização ao vivo de {name}",
  "layout.browserProvider.ended.service-stopped": "O serviço da extensão parou.",
  "layout.browserProvider.ended.extension-unavailable": "A extensão está indisponível.",
  "layout.browserProvider.ended.host-shutdown": "O OpenChamber está encerrando.",
  ...
  "sessions.sidebar.header.actions.newSession": "Novo chat",
  ...
  "sessions.scheduledTasks.dialog.actions.create": "Criar",
  "sessions.scheduledTasks.dialog.actions.moreAria": "Mais ações para {taskName}",
  "sessions.scheduledTasks.dialog.actions.delete": "Excluir",
  "sessions.scheduledTasks.dialog.actions.pause": "Pausar",
  "sessions.scheduledTasks.dialog.actions.resume": "Retomar",
  "sessions.scheduledTasks.workspace.filters.all": "Todas",
  "sessions.scheduledTasks.workspace.filters.active": "Ativas",
  "sessions.scheduledTasks.workspace.filters.paused": "Pausadas",
  "sessions.scheduledTasks.workspace.views.aria": "Visualizações das tarefas agendadas",
  "sessions.scheduledTasks.workspace.views.tasks": "Tarefas",
  "sessions.scheduledTasks.workspace.views.history": "Histórico",
  "sessions.scheduledTasks.history.loading": "Carregando histórico de execuções…",
  "sessions.scheduledTasks.history.error.title": "Não foi possível carregar o histórico",
  "sessions.scheduledTasks.history.error.description": "O OpenChamber não conseguiu carregar as execuções registradas.",
  "sessions.scheduledTasks.history.error.more": "Não foi possível carregar mais execuções. O histórico carregado continua disponível.",
  "sessions.scheduledTasks.history.retry": "Tentar novamente",
  "sessions.scheduledTasks.history.empty.title": "Ainda não há execuções",
  "sessions.scheduledTasks.history.empty.description": "As execuções agendadas e manuais aparecerão aqui.",
  "sessions.scheduledTasks.history.trigger.scheduled": "Agendada",
  "sessions.scheduledTasks.history.trigger.manual": "Manual",
  "sessions.scheduledTasks.history.meta.trigger": "Gatilho",
  "sessions.scheduledTasks.history.meta.started": "Início",
  "sessions.scheduledTasks.history.meta.ended": "Fim",
  "sessions.scheduledTasks.history.meta.duration": "Duração",
  "sessions.scheduledTasks.history.ended.unavailable": "—",
  "sessions.scheduledTasks.history.duration.pending": "Em andamento",
  ...
  "sessions.scheduledTasks.history.loadingMore": "Carregando mais…",
  "sessions.scheduledTasks.history.loadMore": "Carregar mais",
  "sessions.scheduledTasks.workspace.search.placeholder": "Buscar tarefas…",
  "sessions.scheduledTasks.workspace.search.noResults": "Nenhuma tarefa corresponde à busca.",
  "sessions.scheduledTasks.workspace.partialLoadWarning": "Não foi possível carregar as tarefas agendadas de alguns projetos. As tarefas carregadas continuam disponíveis.",
  "sessions.scheduledTasks.workspace.editor.emptyTitle": "Selecione uma tarefa",
  "sessions.scheduledTasks.workspace.editor.emptyDescription": "Escolha uma tarefa na lista ou crie uma nova.",
  "sessions.scheduledTasks.workspace.confirm.discardChanges": "As alterações não salvas serão descartadas. Continuar?",
  "sessions.scheduledTasks.editor.panel.details": "Detalhes",
  "sessions.scheduledTasks.editor.panel.frequency": "Frequência",
  ...
  "sessions.sidebar.header.actions.sessionDisplayMode": "Ações de expandir/recolher projetos",
  "sessions.sidebar.header.displayMode.label": "Expandir/recolher projetos",
  ...
  "sessions.sidebar.bulkActions.archiveUndoFailed": "Não foi possível restaurar {count} sessões",
  "sessions.sidebar.undo": "Desfazer",
  "sessions.sidebar.openSettings": "Configurações",
  ...
  "sessions.sidebar.project.actions.syncSessions": "Sincronizar sessões",
  ...
  "sessions.sidebar.session.rename.smartTitle": "Gerar títulos automaticamente",
  "sessions.sidebar.session.menu.unpin": "Desfixar",
  "sessions.sidebar.session.menu.pin": "Fixar",
  "sessions.sidebar.session.pin.error": "Falha ao fixar a sessão",
  "sessions.sidebar.session.unpin.error": "Falha ao desafixar a sessão",
  ...
  "sessions.sidebar.session.menu.refreshTranscript": "Sincronizar mensagens",
  "sessions.sidebar.session.menu.refreshTranscriptSuccess": "Mensagens sincronizadas",
  "sessions.sidebar.session.menu.refreshTranscriptFailed": "Falha ao sincronizar mensagens",
  ...
  "sessions.sidebar.session.archive.undoFailed": "Não foi possível desfazer o arquivamento",
  ...
  "sessions.sidebar.group.showMore": "Mais",
  ...
  "gitView.changes.deferredTitle": "{count} arquivos alterados",
  "gitView.changes.deferredStagedCount": "Staged: {count}",
  "gitView.changes.deferredUnstagedCount": "Unstaged: {count}",
  "gitView.changes.deferredHint": "Grandes conjuntos de alterações não são renderizados automaticamente para manter o app responsivo.",
  "gitView.changes.deferredLoadAction": "Carregar alterações",
  ...
  "contextPanel.file.notice.turnDiffOutsideWorkspace": "O diff do turno não está disponível fora do projeto. Mostrando o conteúdo atual do arquivo.",
  ...
  "sidebarFilesTree.actions.collapseAllTitle": "Recolher tudo",
  "sidebarFilesTree.actions.expandAllTitle": "Expandir tudo",
  ...
  "contextSidebar.empty.openSession": "Abra uma sessão para inspecionar o uso.",
  ...
  "contextSidebar.stats.sessionTps": "TPS da sessão",
  ...
  "diffView.actions.openFilePreview": "Abrir este arquivo",
  ...
  'chat.history.loadingMore': 'Carregando mais…',
  'chat.history.loadOlderFailed': 'Não foi possível carregar as mensagens anteriores. Tente novamente.',
  'chat.history.loadOlderTimeout': 'O carregamento de mensagens anteriores expirou. Tente novamente.',
  ...
  'chat.history.retry': 'Tentar novamente',
  ...
  "header.services.openWithCurrent": "Trocar instância (atual: {current})",
  "header.services.open": "Trocar instância",
  "header.services.tooltip.currentInstanceWithShortcuts": "Trocar instância: {current} ({toggle}; próxima aba {nextTab})",
  "header.services.tooltip.servicesWithShortcuts": "Trocar instância ({toggle}; próxima aba {nextTab})",
  "header.services.title": "Trocar instância",
  "header.services.viewAria": "Trocar instância",
  "header.services.closeAria": "Fechar seletor de instância",
  ...
  "header.actions.sessionMenu": "Ações da sessão",
  "header.actions.sessionMenuAria": "Abrir menu de ações da sessão",
  "header.actions.sessionMenu.servicesWithInstance": "Trocar instância ({current})",
  ...
  "header.actions.toggleTerminalPanel": "Painel de terminal",
  ...
  "directoryTree.section.pinnedInProgress": "Fixados / Em andamento",
  ...
  "helpDialog.item.previousSession": "Sessão anterior",
  "helpDialog.item.nextSession": "Próxima sessão",
  ...
  "helpDialog.item.toggleRightSidebar": "Mostrar ou ocultar painel de revisão",
  ...
  "helpDialog.item.closeContextPanelTab": "Fechar aba do painel de contexto",
  "helpDialog.item.toggleTerminal": "Mostrar ou ocultar terminal",
  "helpDialog.item.newTerminalTab": "Nova aba do terminal (com o terminal em foco)",
  "helpDialog.item.openNewTerminal": "Abrir novo terminal",
  "helpDialog.item.previousTerminalTab": "Aba anterior do terminal (com o terminal em foco)",
  "helpDialog.item.nextTerminalTab": "Próxima aba do terminal (com o terminal em foco)",
  "helpDialog.item.toggleBottomPanel": "Mostrar ou ocultar o painel inferior",
  ...
  "helpDialog.item.zoomIn": "Aumentar zoom",
  "helpDialog.item.zoomOut": "Diminuir zoom",
  "helpDialog.item.zoomReset": "Redefinir zoom",
  "helpDialog.item.switchSession": "Alternar sessão",
  ...
  "helpDialog.item.leaderOpenModel": "Abrir seletor de modelo",
  "helpDialog.item.leaderOpenAgent": "Abrir seletor de agente",
  "helpDialog.item.leaderNewSession": "Criar nova sessão",
  "helpDialog.item.leaderCompact": "Compactar sessão atual",
  "chat.leaderKey.pendingAria": "Tecla líder ativa. Pressione uma tecla de sequência.",
  "chat.leaderKey.action.model": "Modelo",
  "chat.leaderKey.action.agent": "Agente",
  "chat.leaderKey.action.newSession": "Nova",
  ...
  "helpDialog.proTips.recentSessions": "Os nove chats mais recentes aparecem na busca global",
  ...
  "chat.fileAttachment.actions.expandImages": "Mostrar mais imagens",
  "chat.fileAttachment.actions.collapseImages": "Mostrar menos imagens",
  ...
  "chat.activity.title": "Detalhes do processamento",
  "chat.activity.active": "Processando",
  "chat.activity.compacting": "Compactando",
  "chat.activity.compactionCompleted": "Compactação concluída",
  "chat.activity.compactionFailed": "Falha na compactação",
  "chat.activity.expandAria": "Expandir detalhes do processamento",
  "chat.activity.collapseAria": "Recolher detalhes do processamento",
  ...
  "chat.activity.moreHidden": "+{count} mais...",
  ...
  "chat.emptyState.establishingConversation": "Estabelecendo conversa",
  ...
  "chat.draftStarters.remove": "Remover",
  "chat.draftStarters.expand": "Mostrar mais",
  ...
  "chat.statusRow.abortPrompt": "Pressione Esc novamente para interromper",
  "chat.assistantStatus.readingFile": "Lendo arquivo",
  "chat.assistantStatus.writingFile": "Gravando arquivo",
  "chat.assistantStatus.editingFile": "Editando arquivo",
  "chat.assistantStatus.compacting": "Compactando",
  "chat.assistantStatus.applyingPatch": "Aplicando patch",
  "chat.assistantStatus.runningCommand": "Executando comando",
  "chat.assistantStatus.searchingContent": "Pesquisando conteúdo",
  "chat.assistantStatus.findingFiles": "Localizando arquivos",
  "chat.assistantStatus.listingDirectory": "Listando diretório",
  "chat.assistantStatus.delegatingTask": "Delegando tarefa",
  "chat.assistantStatus.taskWorking": "{name} em andamento",
  "chat.assistantStatus.fetchingUrl": "Obtendo URL",
  "chat.assistantStatus.searchingWeb": "Pesquisando na web",
  "chat.assistantStatus.webCodeSearch": "Pesquisando código na web",
  "chat.assistantStatus.updatingTodos": "Atualizando tarefas",
  "chat.assistantStatus.readingTodos": "Lendo tarefas",
  "chat.assistantStatus.learningSkill": "Aprendendo habilidade",
  "chat.assistantStatus.askingQuestion": "Fazendo pergunta",
  "chat.assistantStatus.executing": "Executando código",
  "chat.assistantStatus.renamingSession": "Renomeando a sessão",
  "chat.assistantStatus.movingSession": "Movendo a sessão",
  "chat.assistantStatus.usingBrowser": "Usando o navegador",
  "chat.assistantStatus.usingTool": "Usando {tool}",
  "chat.assistantStatus.working": "Trabalhando",
  "chat.assistantStatus.processing": "Processando",
  "chat.assistantStatus.preparing": "Preparando",
  "chat.assistantStatus.warmingUp": "Aquecendo",
  "chat.assistantStatus.gearsTurning": "Em andamento",
  "chat.assistantStatus.computing": "Computando",
  "chat.assistantStatus.calculating": "Calculando",
  "chat.assistantStatus.analyzing": "Analisando",
  "chat.assistantStatus.wheelsSpinning": "Em andamento",
  "chat.assistantStatus.calibrating": "Calibrando",
  "chat.assistantStatus.synthesizing": "Sintetizando",
  "chat.assistantStatus.connectingDots": "Conectando informações",
  "chat.assistantStatus.inspectingLogic": "Inspecionando lógica",
  "chat.assistantStatus.weighingOptions": "Avaliando opções",
  "chat.assistantStatus.thinking": "Pensando",
  "chat.assistantStatus.composing": "Redigindo",
  "chat.assistantStatus.sendingMessage": "Enviando mensagem",
  "chat.assistantStatus.waitingForPermission": "Aguardando permissão",
  "chat.assistantStatus.retrying": "Tentando novamente",
  "chat.assistantStatus.retryingIn": "Tentando novamente {duration}",
  "chat.assistantStatus.retryingAttempt": "Tentando novamente (tentativa {attempt})",
  "chat.assistantStatus.retryingInAttempt": "Tentando novamente {duration} (tentativa {attempt})",
  ...
  "chat.revertPopover.files": "Arquivos que serão alterados",
  ...
  "chat.revert.toast.busy": "Não é possível reverter enquanto a sessão está ocupada",
  "chat.form.title": "Formulário",
  "chat.form.reply": "Enviar",
  "chat.form.cancel": "Cancelar",
  "chat.retry.action.quota": "Limite de uso atingido",
  "chat.retry.action.account": "Limite da conta atingido",
  ...
  "chat.commandAutocomplete.command.forkDescription": "Criar uma nova sessão a partir do estado atual da conversa",
  "chat.commandAutocomplete.command.timelineDescription": "Abrir a linha do tempo da conversa",
  "chat.commandAutocomplete.command.modelDescription": "Abrir o seletor de modelos",
  ...
  "chat.commandAutocomplete.command.reloadDescription": "Recarregar a configuração, os provedores e os plugins do OpenCode sem reiniciar",
  "chat.commandAutocomplete.command.newDescription": "Iniciar uma nova sessão no projeto atual.",
  ...
  "chat.fileMentionAutocomplete.groups.sessions": "Sessões carregadas",
  "chat.fileMentionAutocomplete.groups.directories": "Diretórios",
  "chat.fileMentionAutocomplete.groups.recentFiles": "Arquivos recentes",
  "chat.fileMentionAutocomplete.groups.files": "Arquivos",
  "chat.fileMentionAutocomplete.sessionType": "Sessão do OpenCode",
  "chat.fileMentionAutocomplete.untitledSession": "Sessão sem título",
  ...
  "chat.queuedMessage.title": "Fila",
  "chat.queuedMessage.edit": "editar",
  "chat.queuedMessage.send": "guiar",
  "chat.queuedMessage.queuing": "Enfileirando…",
  "chat.queuedMessage.queuingAria": "Enfileirando mensagem",
  "chat.queuedMessage.waitingForCompaction": "Aguardando a compactação",
  "chat.queuedMessage.waitingForCompactionAria": "Aguardando o fim da compactação",
  "chat.queuedMessage.sending": "Guiando…",
  "chat.queuedMessage.sendingAria": "Guiando a mensagem",
  ...
  "chat.textSelection.actions.addToSideChat": "Adicionar ao chat lateral",
  "chat.textSelection.title.addToCurrentChat": "Adicionar ao chat atual",
  "chat.messageBody.aborted": "Geração interrompida",
  "chat.messageBody.actions.editing": "Editando…",
  "chat.messageBody.actions.editStaged": "Edição pendente",
  "chat.messageBody.actions.cancelEdit": "Cancelar edição",
  ...
  "chat.messageBody.actions.openSourceSessionAria": "Abrir sessão original",
  "chat.messageBody.actions.openSourceSession": "Abrir sessão original",
  ...
  "chat.messageBody.meta.tpsAria": "Taxa de geração: {rate}",
  "chat.messageBody.meta.tpsTooltip": "Velocidade de geração (tokens/s), sem o tempo das ferramentas",
  ...
  "chat.forkTransition.preparing": "Preparando a bifurcação",
  "chat.forkTransition.copying": "Copiando a conversa (sessões longas podem demorar)",
  "chat.forkTransition.opening": "Abrindo a nova sessão",
  "chat.forkTransition.loading": "Carregando mensagens recentes",
  ...
  "chat.chatInput.actions.attachPhotos": "Anexar fotos",
  ...
  "chat.chatInput.actions.queuingMessageAria": "Enfileirando…",
  ...
  "chat.chatInput.placeholder.compactTap": "Toque para digitar",
  "chat.chatInput.placeholder.selectSession": "Selecione ou crie uma sessão para começar a conversar",
  "chat.chatInput.pastedTextReference": "Texto colado nº {index} · {count} caracteres",
  ...
  "chat.chatInput.toast.reloadStarted": "Recarregando a configuração…",
  "chat.chatInput.toast.reloadSucceeded": "Configuração recarregada",
  "chat.chatInput.toast.reloadFailed": "Não foi possível recarregar a configuração",
  ...
  "chat.chatInput.draftPicker.newProject": "Novo projeto",
  ...
  "chat.chatInput.branchSwitch.title": "Mudar para {branch}?",
  "chat.chatInput.branchSwitch.description": "Como abrir este branch na nova conversa?",
  "chat.chatInput.branchSwitch.createWorktree": "Criar worktree",
  "chat.chatInput.branchSwitch.createWorktreeDescription": "Mantém o diretório atual e trabalha em um worktree isolado.",
  "chat.chatInput.branchSwitch.checkoutHere": "Fazer checkout aqui",
  "chat.chatInput.branchSwitch.checkoutHereDescription": "Altera o diretório atual para este branch.",
  ...
  "chat.toolOutputDialog.image.zoomInAria": "Ampliar",
  "chat.toolOutputDialog.image.zoomOutAria": "Reduzir",
  "chat.toolOutputDialog.image.resetZoomAria": "Redefinir zoom",
  "chat.image.actions.sheetTitle": "Imagem",
  "chat.image.actions.saveImage": "Salvar imagem",
  "chat.image.actions.saveToPhotos": "Salvar nas Fotos",
  "chat.image.actions.saving": "Salvando…",
  "chat.image.actions.saveSuccess": "Imagem salva",
  "chat.image.actions.saveFailed": "Não foi possível salvar a imagem",
  ...
  "chat.activity.outputLoading": "Carregando a saída completa…",
  "chat.activity.outputLoadFailed": "Não foi possível carregar a saída completa.",
  "chat.activity.outputRetry": "Tentar novamente",
  "chat.fileAttachment.image.loading": "Carregando imagem…",
  ...
  "chat.permissionCard.replaceAll": "Substituir todas as ocorrências",
  "chat.permissionCard.responseFormat": "Formato da resposta:",
  "chat.permissionCard.allowOnce": "Permitir uma vez",
  "chat.permissionCard.alwaysAgree": "Permitir sempre",
  ...
  "chat.modelControls.costPerMillion": "Custo",
  "chat.modelControls.costInput": "Entrada",
  "chat.modelControls.costOutput": "Saída",
  ...
  "chat.modelControls.keyboardHintSwitchAgentLabel": "Alternar agente",
  ...
  "chat.contextGroup.expandAria": "Expandir ferramentas exploradas",
  "chat.contextGroup.collapseAria": "Recolher ferramentas exploradas",
  "chat.contextGroup.readSingle": "{count} leitura",
  "chat.contextGroup.readPlural": "{count} leituras",
  "chat.contextGroup.searchSingle": "{count} busca",
  "chat.contextGroup.searchPlural": "{count} buscas",
  "chat.contextGroup.listSingle": "{count} lista",
  "chat.contextGroup.listPlural": "{count} listas",
  "chat.usedGroup.running": "Em execução",
  "chat.usedGroup.used": "Usado",
  "chat.usedGroup.expandAria": "Expandir ferramentas usadas",
  "chat.usedGroup.collapseAria": "Recolher ferramentas usadas",
  "chat.usedGroup.editSingle": "{count} edição",
  "chat.usedGroup.editPlural": "{count} edições",
  "chat.usedGroup.commandSingle": "{count} comando",
  "chat.usedGroup.commandPlural": "{count} comandos",
  "chat.usedGroup.otherSingle": "{count} chamada",
  "chat.usedGroup.otherPlural": "{count} chamadas",
  "chat.skillGroup.expandAria": "Expandir skills carregadas",
  "chat.skillGroup.collapseAria": "Recolher skills carregadas",
  "chat.skillGroup.summaryOverflow": "{names} e mais {count}",
  "chat.tools.display.read": "Ler arquivo",
  "chat.tools.display.write": "Escrever arquivo",
  "chat.tools.display.edit": "Editar arquivo",
  "chat.tools.display.apply_patch": "Aplicar patch",
  "chat.tools.display.bash": "Comando do shell",
  "chat.tools.display.grep": "Buscar em arquivos",
  "chat.tools.display.glob": "Encontrar arquivos",
  "chat.tools.display.list": "Listar diretório",
  "chat.tools.display.task": "Tarefa do agente",
  "chat.tools.display.webfetch": "Buscar URL",
  "chat.tools.display.websearch": "Pesquisa na web",
  "chat.tools.display.codesearch": "Pesquisa de código",
  "chat.tools.display.todowrite": "Atualizar lista de tarefas",
  "chat.tools.display.todoread": "Ler lista de tarefas",
  "chat.tools.display.skill": "Carregar skill",
  "chat.tools.display.question": "Pergunta",
  "chat.tools.display.lsp": "LSP",
  "chat.tools.display.structuredoutput": "Saída estruturada",
  "chat.tools.display.execute": "Executar código",
  "chat.tools.display.session_rename": "Renomear sessão",
  "chat.tools.display.session_move": "Mover sessão",
  ...
  "chat.messageBody.subagent.completed": "Concluído",
  "chat.messageBody.subagent.error": "Falhou",
  "chat.messageBody.subagent.cancelled": "Cancelado",
  "chat.messageBody.subagent.completedDescription": "O subagente em segundo plano foi concluído",
  "chat.messageBody.subagent.errorDescription": "O subagente em segundo plano falhou",
  "chat.messageBody.subagent.cancelledDescription": "O subagente em segundo plano foi cancelado",
  "chat.messageBody.subagent.openSession": "Abrir sessão do subagente: {label}",
  "chat.sessionBackground.moveRunning": "Mover para segundo plano",
  "chat.sessionBackground.moving": "Movendo…",
  "chat.sessionBackground.moveFailed": "Não foi possível mover o trabalho para segundo plano",
  "chat.sessionBackground.tasksRunning": "{count} tarefa(s) em segundo plano",
  "chat.messageBody.shellCommand.title": "Resultado do shell",
  ...
  "commandPalette.title": "Busca global",
  "commandPalette.error.sessions": "Não foi possível carregar a busca de chats. Os resultados disponíveis continuam visíveis.",
  ...
  "commandPalette.item.newTerminalTab": "Nova aba do terminal",
  ...
  "desktopHostSwitcher.transition.title": "Alternando instância…",
  "desktopHostSwitcher.transition.description": "Carregando os dados da instância selecionada.",
  ...
  "desktopHostSwitcher.sshError.openRemoteSettings": "Abrir instâncias remotas",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.title": "O host remoto não tem Node.js 22+",
  "desktopHostSwitcher.sshError.nodeRuntimeMissing.guidance": "Instale o Node.js 22 ou 24 LTS na máquina remota (nvm, fnm ou o pacote do sistema). Um shell de login que só expõe Node 18/20 não basta, a menos que exista um binário 22+ em um caminho padrão.",
  "desktopHostSwitcher.sshError.packageManagerMissing.title": "O host remoto não tem npm nem bun",
  "desktopHostSwitcher.sshError.packageManagerMissing.guidance": "Instale o npm (incluído no Node.js) ou o bun na máquina remota e tente de novo. O OpenChamber precisa de um deles para instalar o CLI Host.",
  "desktopHostSwitcher.sshError.nativeBinding.title": "Falha ao compilar o módulo de banco de dados remoto",
  "desktopHostSwitcher.sshError.nativeBinding.guidance": "Instale o Node.js 22 ou 24 LTS no host remoto. Versões ímpares como o Node 23 costumam não ter binário pré-compilado e precisam de python3, gcc e make. Com um runtime LTS disponível, reconecte.",
  "desktopHostSwitcher.sshError.openchamberCliMissing.title": "Comando OpenChamber não encontrado no remoto",
  "desktopHostSwitcher.sshError.openchamberCliMissing.guidance": "A instalação terminou, mas o openchamber --version não devolveu uma versão utilizável. Confirme que ~/.bun/bin ou o bin global do npm está no PATH e tente de novo. Você também pode rodar openchamber --version por SSH.",
  "desktopHostSwitcher.sshError.openchamberRegistry.title": "Não foi possível baixar o OpenChamber no host remoto",
  "desktopHostSwitcher.sshError.openchamberRegistry.guidance": "O remoto não alcançou o registro npm nem o espelho configurado. Verifique rede, proxy e o registry do npm e tente de novo. Você também pode instalar @openchambery/web com Node 22 ou 24 e npm.",
  "desktopHostSwitcher.sshError.openchamberInstall.title": "Não foi possível instalar o OpenChamber no host remoto",
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "bun ou npm falhou ao instalar @openchambery/web. Veja a saída do gerenciador de pacotes nos logs SSH deste host e tente de novo. Você também pode instalar @openchambery/web com Node 22 ou 24.",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.title": "O CLI remoto do OpenChamber é antigo demais",
  "desktopHostSwitcher.sshError.openchamberCliIncompatible.guidance": "O CLI remoto recusou um flag enviado por este desktop (por exemplo --relay-host). Atualize o @openchambery/web no remoto para uma versão com SSH relay host e tente de novo.",
  "desktopHostSwitcher.sshError.opencodeInstall.title": "Não foi possível instalar o OpenCode CLI no host remoto",
  "desktopHostSwitcher.sshError.opencodeInstall.guidance": "Verifique a rede e o gerenciador de pacotes remotos e tente de novo. Você também pode instalar o OpenCode CLI manualmente.",
  "desktopHostSwitcher.sshError.serverStart.title": "O servidor OpenChamber remoto não iniciou",
  "desktopHostSwitcher.sshError.serverStart.guidance": "O SSH conectou, mas o processo Host não ficou acessível. Confirme que o remoto está no Node 22/24 e que a porta escolhida está livre e tente de novo.",
  "desktopHostSwitcher.sshError.sshAuth.title": "Falha na autenticação SSH",
  "desktopHostSwitcher.sshError.sshAuth.guidance": "Verifique a chave SSH, a senha e o destino em Configurações → Instâncias remotas. A inicialização não termina até o login SSH funcionar.",
  "desktopHostSwitcher.sshError.sshUnreachable.title": "Não foi possível alcançar o host SSH",
  "desktopHostSwitcher.sshError.sshUnreachable.guidance": "Verifique o nome do host, a porta e a rede (conecte primeiro a VPN ou um bastion se necessário) e tente de novo.",
  "desktopHostSwitcher.sshError.timeout.title": "A conexão SSH excedeu o tempo",
  "desktopHostSwitcher.sshError.timeout.guidance": "O host remoto não concluiu a inicialização a tempo. Verifique a rede e se o Node 22 ou 24 está instalado e tente de novo.",
  "desktopHostSwitcher.sshError.unknown.title": "A instância remota não pôde iniciar",
  "desktopHostSwitcher.sshError.unknown.guidance": "A inicialização remota falhou. Veja o erro exato abaixo, ou abra Configurações → Instâncias remotas e confira os logs SSH deste host.",
  ...
  "updateDialog.status.otaBundleReused": "O pacote de atualização baixado anteriormente foi usado. Não é preciso baixar novamente.",
  ...
  "updateDialog.actions.applyOtaNow": "Atualizar agora",
  "updateDialog.actions.later": "Mais tarde",
  ...
  "mobileUpdate.ota.toast.available.title": "Atualização disponível",
  "mobileUpdate.ota.toast.available.description": "A versão {version} está pronta para instalar.",
  "mobileUpdate.ota.toast.actions.update": "Atualizar",
  "mobileUpdate.ota.toast.actions.dismiss": "Dispensar",
  ...
  "common.relative.justNow": "Agora mesmo",
  "common.relative.minutesAgoShort": "há {count} min",
  "common.relative.hoursAgoShort": "há {count} h",
  "common.relative.daysAgoShort": "há {count} d",
  "common.relative.weeksAgoShort": "há {count} sem",
  "common.relative.yearsAgoShort": "há {count} a",
  "common.relative.minutesAgoCompact": "há {count} min",
  "common.relative.hoursAgoCompact": "há {count} h",
  "common.relative.daysAgoCompact": "há {count} d",
  "common.relative.weeksAgoCompact": "há {count} sem",
  "common.relative.monthsAgoCompact": "há {count} meses",
  "common.relative.yearsAgoCompact": "há {count} a",
  ...
  "header.workStatusPanel.toggleAria": "Alternar status do trabalho",
  ...
  "chat.workStatus.section.contextSources": "Fontes de contexto",
  ...
  "chat.workStatus.pr.checksFailed": "{count} com falha",
  "chat.workStatus.pr.checksPending": "{count} em andamento",
  ...
  "chat.workStatus.action.openGit": "Abrir painel Git",
  "chat.workStatus.action.copyBranch": "Copiar nome do branch",
  ...
  "chat.workStatus.subagent.working": "trabalhando",
  "chat.workStatus.subagent.needsPermission": "aguarda permissão",
  "chat.workStatus.subagent.askedQuestion": "fez uma pergunta",
  "chat.workStatus.subagent.done": "Concluído",
  "chat.workStatus.subagent.workingCount": "{count} trabalhando",
  "chat.workStatus.subagent.doneCount": "{count} concluídos",
  "chat.workStatus.mcp.toggle": "Alternar {name}",
  "chat.workStatus.mcp.needsAuth": "Entrar",
  "chat.workStatus.mcp.failed": "Falhou",
  "chat.workStatus.goal.open": "Gerenciar meta",
  "chat.workStatus.goal.pause": "Pausar",
  "chat.workStatus.goal.resume": "Retomar",
  "chat.workStatus.goal.updateFailed": "Não foi possível atualizar a meta",
  "chat.workStatus.sections.open": "Escolher seções",
  "chat.workStatus.sections.allHidden": "Todas as seções estão ocultas",
  "chat.workStatus.sections.showAll": "Mostrar todas",
  "chat.workStatus.sections.dialogTitle": "Seções do status do trabalho",
  "chat.workStatus.sections.dialogDescription": "Escolha as seções do cartão. Arraste para reordenar.",
  ...
  "chat.workStatus.telemetry.duration": "Duração",
  "chat.workStatus.telemetry.cost": "Custo",
  "chat.workStatus.usage.refresh": "Atualizar cotas",
  "chat.workStatus.compact.onBranch": "Em {branch}",
  "chat.workStatus.compact.changes": "Alterações",
  "opencodeUpgrade.screen.title": "OpenCode 2.0.15 é necessário",
  "opencodeUpgrade.screen.outdatedTitle": "Atualizar o OpenCode",
  "opencodeUpgrade.screen.local": "O OpenCode {version} está instalado. Esta versão do OpenChamber exige o OpenCode v2.",
  "opencodeUpgrade.screen.outdatedLocal": "O OpenCode {version} está instalado. Esta versão do OpenChamber exige o OpenCode {minimum} ou mais recente.",
  "opencodeUpgrade.screen.external": "O servidor conectado está executando o OpenCode {version}. Instale o OpenCode v2 nesse servidor e verifique novamente.",
  "opencodeUpgrade.screen.outdatedExternal": "O servidor conectado está executando o OpenCode {version}. Atualize-o para o OpenCode {minimum} ou mais recente e verifique novamente.",
  "opencodeUpgrade.screen.bundled": "O OpenCode {version} vem com o OpenChamber e é anterior a {minimum}. Uma cópia gerenciada pode ser instalada sem alterar o binário incluído.",
  "opencodeUpgrade.screen.installDescription": "O OpenChamber instalará o OpenCode {minimum} ou mais recente no cache gerenciado e reiniciará. Seus arquivos atuais do OpenCode não são substituídos.",
  "opencodeUpgrade.screen.install": "Instalar o OpenCode {minimum}",
  "opencodeUpgrade.screen.update": "Atualizar para o OpenCode {minimum}",
  "opencodeUpgrade.screen.installing": "Instalando o OpenCode…",
  "opencodeUpgrade.screen.updating": "Atualizando o OpenCode…",
  "opencodeUpgrade.screen.reconnect": "Verificar novamente",
  "opencodeUpgrade.screen.reconnecting": "Verificando…",
  "opencodeUpgrade.screen.failedTitle": "O OpenCode não foi atualizado",
  "opencodeUpgrade.screen.failedGeneric": "A instalação não terminou. O OpenCode continua na versão anterior.",
  "opencodeUpgrade.screen.guide": "Guia de instalação",
  "opencodeUpgrade.screen.manualGuidance": "A instalação automática não está disponível neste runtime. Atualize o OpenCode você mesmo e verifique novamente.",
};
