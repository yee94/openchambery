export const settingsDict = {
  ...
  'settings.globalConfig.toast.saved': 'Configuration saved.',
  ...
  'settings.providers.page.openCodeGo.consoleSignIn': 'Sign in with OpenCode Console',
  'settings.providers.page.openCodeGo.consoleConnected': 'OpenCode Console is connected. OpenCode Go can use these credentials.',
  'settings.providers.page.openCodeGo.consoleHint': 'OpenCode Go signs in through OpenCode Console. Service account keys below still work.',
  ...
  'settings.view.home.cards.agents.description': 'Prompts, permissions, and runtime limits',
  ...
  'settings.view.actions.reloadOpenCodeTooltip': 'Reload OpenCode runtime configuration without restarting the service.',
  ...
  'settings.openchamber.about.opencodeManagement.manual-global': 'global CLI — upgrade manually',
  'settings.openchamber.about.opencodeManagement.manual-external': 'external serve — manage outside the app',
  'settings.openchamber.about.opencodeManagement.bundled': 'bundled with the app',
  'settings.openchamber.about.opencodeManagement.in-app': 'managed by OpenChamber',
  'settings.openchamber.about.opencodeManagement.none': 'ownership unknown',
  ...
  'settings.agents.sidebar.badge.disabled': 'Disabled',
  ...
  'settings.agents.sidebar.renameDialog.description': 'Enter a new name for Agent "@{name}"',
  ...
  'settings.agents.page.section.runtime': 'Runtime',
  'settings.agents.page.field.steps': 'Step limit',
  'settings.agents.page.field.stepsHint': 'Empty means no limit. At the limit, the next request can only answer in text.',
  'settings.agents.page.field.hidden': 'Hidden',
  'settings.agents.page.field.hiddenHint': 'Hide this Agent from the primary switcher and from @ mentions. Task can still call it when permissions allow.',
  'settings.agents.page.field.disabled': 'Disabled',
  'settings.agents.page.field.disabledHint': 'Remove this Agent from the catalog. Turn it off and save to bring the Agent back.',
  'settings.agents.page.field.color': 'Color',
  'settings.agents.page.field.colorHint': 'Hex color, such as #FF6B6B.',
  'settings.agents.page.field.colorInvalid': 'Enter a hex color like #FF6B6B.',
  'settings.agents.page.field.clearColorAria': 'Clear color',
  'settings.agents.page.field.modelHint': 'Leave empty to keep the caller’s model. A variant is saved with the model.',
  'settings.agents.page.system.inheritHint': 'Empty keeps the built-in prompt. Text here replaces that prompt. Project instructions are still added after it.',
  'settings.agents.page.apply.hint': 'Applies on the next request and for new sessions. A session that is already running keeps its current model.',
  'settings.agents.page.legacy.convertible': 'Saving converts this Agent file to the current format.',
  'settings.agents.page.legacy.dropped': 'These fields will not be kept: {fields}. They do not change the next request.',
  'settings.agents.page.legacy.confirmDrop': 'Convert and drop those fields',
  'settings.agents.page.toast.savedNextRequest': 'Saved. The next request and new sessions use this Agent. A running session keeps its current model.',
  ...
  'settings.agents.page.field.scope': 'Scope',
  ...
  'settings.agents.page.mode.subagent': 'Sub Agent',
  ...
  'settings.agents.page.permissions.subagent': 'Sub Agent',
  'settings.agents.page.permissions.edit': 'Edit',
  'settings.agents.page.permissions.externalDirectory': 'External directory',
  'settings.agents.page.permissions.question': 'Question',
  'settings.agents.page.permissions.read': 'Read',
  'settings.agents.page.permissions.glob': 'Find files',
  'settings.agents.page.permissions.grep': 'Search',
  'settings.agents.page.permissions.skill': 'Skill',
  'settings.agents.page.permissions.webfetch': 'Fetch page',
  'settings.agents.page.permissions.websearch': 'Web search',
  'settings.agents.page.permissions.execute': 'Execute',
  'settings.agents.page.permissions.browser': 'Browser',
  ...
  'settings.permissions.saved.deleteFailed': 'Could not delete saved permission',
  'settings.permissions.saved.loadFailed': 'Could not load saved permissions',
  'settings.agents.page.permissions.lastMatchHint': 'Last matching rule wins',
  ...
  'settings.plugins.compatibility.v1Incompatible': 'Incompatible with OpenCode 2',
  'settings.plugins.compatibility.v1Incompatible.tooltip': 'V1 plugins cannot run on OpenCode 2. They are marked incompatible instead of failing silently.',
  'settings.plugins.registry.banner.v1Incompatible.title': 'Incompatible with OpenCode 2',
  'settings.plugins.registry.banner.v1Incompatible.description': 'This V1 plugin cannot load on OpenCode 2. Wait for the official plugin migration.',
  ...
  'settings.openchamber.defaults.summary.providerDescription': 'Uses the same connected OpenCode models as Assistants. Leave unselected to follow the OpenCode default model.',
  ...
  'settings.openchamber.defaults.summary.providerModelDefault': 'OpenCode default model',
  ...
  'settings.openchamber.defaults.summary.testConnection': 'Test connection',
  'settings.openchamber.defaults.summary.testingConnection': 'Testing…',
  'settings.openchamber.defaults.summary.testConnectionOk': 'Custom API connection succeeded',
  'settings.openchamber.defaults.summary.testError.incomplete': 'Enter a Base URL, model ID, and API token before saving or testing.',
  'settings.openchamber.defaults.summary.testError.token': 'The API token was rejected. Check the token and try again.',
  'settings.openchamber.defaults.summary.testError.model': 'The model ID was not found. Check the model ID and try again.',
  'settings.openchamber.defaults.summary.testError.baseUrl': 'Could not reach an OpenAI-compatible API at this Base URL.',
  ...
  'settings.notifications.page.events.scheduledTasksAria': 'Scheduled task runs',
  'settings.notifications.page.events.scheduledTasksLabel': 'Scheduled Tasks',
  'settings.notifications.page.events.assistantsAria': 'Assistant messages',
  'settings.notifications.page.events.assistantsLabel': 'Assistant Messages',
  'settings.notifications.page.events.goalsAria': 'Goal settlements',
  'settings.notifications.page.events.goalsLabel': 'Goal Settlements',
  ...
  'settings.openchamber.visual.field.followUpBehaviorDescription': 'Choose how Enter sends follow-ups while the agent responds. Native Queue inherits the session model, agent, and variant at execution. Host and Assistant queues keep the settings captured when queued.',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': 'Steer',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': 'Queue',
  'settings.page.assistants.title': 'Assistants',
  'assistants.title': 'Assistants',
  'assistants.unread.label': 'Unread messages: {count}',
  'assistants.unread.markAll': 'Mark all read',
  'assistants.unread.markAllFailed': 'Some assistants could not be marked as read. Try again.',
  ...
  'assistants.contact.card.session.status.cancelled': 'Cancelled',
  ...
  'assistants.contact.attachment.tooLarge': 'Choose a file up to 25 MiB.',
  'assistants.contact.attachment.download': 'Download file',
  'assistants.contact.attachment.loadFailed': 'Could not load this file.',
  'assistants.contact.history.gap': 'Some messages are still missing. Retry to load them.',
  ...
  'settings.openchamber.browserProvider.label': 'Browser provider',
  'settings.openchamber.browserProvider.aria': 'Choose which extension answers the agent\'s browser actions',
  'settings.openchamber.browserProvider.info': 'An installed extension that provides a browser can answer the agent\'s browser actions. The choice applies to the next action. Nothing is shown as connected until a provider is listed.',
  'settings.openchamber.browserProvider.placeholder': 'Choose a provider',
  'settings.openchamber.browserProvider.toast.selectFailed': 'Could not select that browser provider.',
} as const;
