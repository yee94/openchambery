export const settingsDict = {
  ...
  'settings.remoteInstances.sidebar.actions.mobileConnect': 'Phone connect',
  'settings.remoteInstances.sidebar.actions.mobileConnectAria': 'Create a phone pairing QR for {instance}',
  'settings.remoteInstances.sidebar.actions.mobileConnectDisabled': 'Connect this SSH instance before pairing a phone',
