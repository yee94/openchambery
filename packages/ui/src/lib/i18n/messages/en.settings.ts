export const settingsDict = {
  ...
  'settings.openchamber.defaults.summary.sessionTitlePromptDescription': 'Controls titles generated when a new session first becomes idle and after later idle periods of about 15 seconds.',
