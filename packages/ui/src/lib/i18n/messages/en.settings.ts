export const settingsDict = {
  ...
  'settings.remoteInstances.page.sync.description': 'Mirror your local OpenCode config (~/.config/opencode) and agent skills (~/.agents) to this remote so both sides match. Provider credentials (auth.json) are included only when credential sync is authorized for this instance in its settings. Symlinked folders are copied as real files.',
  ...
  'settings.remoteInstances.page.sync.scope.authRequiresGrant': 'Authorize credential sync in this instance’s settings before including auth.json.',
  ...
  'settings.remoteInstances.page.section.credentialSync': 'Credential sync',
  'settings.remoteInstances.page.credentialSync.description': 'Connecting to this remote does not authorize copying provider login tokens. Turn this on only when you trust the remote with your OpenCode auth.json.',
  'settings.remoteInstances.page.credentialSync.toggleLabel': 'Allow syncing provider credentials',
  'settings.remoteInstances.page.credentialSync.toggleDescription': 'When enabled, config sync may transfer ~/.local/share/opencode/auth.json to this remote.',
  'settings.remoteInstances.page.credentialSync.toggleAria': 'Allow syncing provider credentials to this remote',
  'settings.remoteInstances.page.credentialSync.confirmGrant': 'Allow this remote to receive provider credentials (auth.json)? Tokens will be copied over SSH when you sync.',
  'settings.remoteInstances.page.credentialSync.confirmRevoke': 'Stop allowing provider credential sync to this remote? Future syncs will skip auth.json.',
  'settings.remoteInstances.page.credentialSync.toast.granted': 'Credential sync authorized for this remote',
  'settings.remoteInstances.page.credentialSync.toast.grantFailed': 'Failed to authorize credential sync',
  'settings.remoteInstances.page.credentialSync.toast.revoked': 'Credential sync authorization removed',
  'settings.remoteInstances.page.credentialSync.toast.revokeFailed': 'Failed to revoke credential sync',
