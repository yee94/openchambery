...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    descriptionKey: 'settings.agents.page.field.modelHint',
    keywords: ['model', 'provider', 'variant'],
  },
  {
    id: 'agents.steps',
    page: 'agents',
    titleKey: 'settings.agents.page.field.steps',
    descriptionKey: 'settings.agents.page.field.stepsHint',
    keywords: ['steps', 'limit', 'tool'],
  },
  {
    id: 'agents.hidden',
    page: 'agents',
    titleKey: 'settings.agents.page.field.hidden',
    descriptionKey: 'settings.agents.page.field.hiddenHint',
    keywords: ['hidden', 'mention', 'switcher'],
  },
  {
    id: 'agents.disabled',
    page: 'agents',
    titleKey: 'settings.agents.page.field.disabled',
    descriptionKey: 'settings.agents.page.field.disabledHint',
    keywords: ['disabled', 'catalog'],
  },
  {
    id: 'agents.color',
    page: 'agents',
    titleKey: 'settings.agents.page.field.color',
    descriptionKey: 'settings.agents.page.field.colorHint',
    keywords: ['color', 'hex'],
  },
  {
