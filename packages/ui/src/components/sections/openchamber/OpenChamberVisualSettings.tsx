...
export const OpenChamberVisualSettings: React.FC<OpenChamberVisualSettingsProps> = ({ visibleSettings, mobile }) => {
    ...
    const showIosNativeUiSetting = canShowIosNativeUiSetting() && shouldShow('iosNativeUi');
    ...
    const hasBehaviorSettings = shouldShow('mermaidRendering')
        || shouldShow('questionAutoDelegate')
        ...
        <div className="oc-settings-section-stack">
                ...
                {hasBehaviorSettings && (
                    <div className="oc-settings-section-stack">
                            ...
                            {shouldShow('questionAutoDelegate') && <QuestionAutoDelegateSetting />}
