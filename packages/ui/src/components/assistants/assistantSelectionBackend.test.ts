...
const assistant: AssistantDTO = { id: 'assistant-a', revision: 1, enabled: true, name: 'Assistant', defaultPrompt: '', workspacePath: null, effectiveWorkspacePath: '/workspace', managedWorkspacePath: null, providerID: 'provider-a', modelID: 'model-a', agent: null, variant: null, mode: 'continuous', sessionID: null, sessionGeneration: 1, historySessionIDs: [], historySessionCount: 0, assignedSessionIDs: [], working: false, activeContactTurn: null, createdAt: null, updatedAt: 1, tombstoneAt: null };
