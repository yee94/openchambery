...
/** Test/inspect surface for host SessionMessage → {info, parts} projection. */
export const projectSessionMessageRecord = projectSessionMessage;
export const projectSessionMessageRecords = projectRecords;
