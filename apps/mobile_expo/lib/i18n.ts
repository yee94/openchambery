...
const messages: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'mobile.chat.draftBody': '草稿会话（sessionId 为空）。发送后才会创建正式会话。聊天正文仍为占位。',
    'mobile.chat.stubBody': '占位会话',
  },
  en: {
    ...
    'mobile.chat.draftBody': 'Draft session (sessionId empty). A real session is created on first send. Chat body stays stub.',
    'mobile.chat.stubBody': 'Stub session',
  },
};
