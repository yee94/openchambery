/** Sync SHA-256 hex for Hermes (no subtle.digest required). */
...
export const sha256Hex = (value: string): string => {
  ...
  // SHA-256 length is 64-bit big-endian; our inputs are short so high word stays 0.
